...
function t(n = {}, r = {}) {
  ...
  Object.keys(r)
    ...
    .forEach((i) => {
      n[i] === void 0
        ? (n[i] = r[i])
        : e(r[i]) && e(n[i]) && Object.keys(r[i]).length > 0 && t(n[i], r[i]);
    });
}
var n = {
  body: {},
        ...
        a !== void 0 &&
          ...
          (f(t[r]) && f(i[r])
            ? i[r].__swiper__
              ...
              : m(t[r], i[r])
            : !f(t[r]) && f(i[r])
            ? ((t[r] = {}), i[r].__swiper__ ? (t[r] = i[r]) : m(t[r], i[r]))
            : (t[r] = i[r]));
      }
    }
  }
...
function g({ swiper: e, targetPosition: t, side: n }) {
  ...
  let l = t > i ? `next` : `prev`,
    ...
    d = () => {
      ...
      if ((u(l, t) && (l = t), e.wrapperEl.scrollTo({ [n]: l }), u(l, t))) {
        (e.wrapperEl.style.overflow = `hidden`),
          (e.wrapperEl.style.scrollSnapType = ``),
          setTimeout(() => {
            (e.wrapperEl.style.overflow = ``), e.wrapperEl.scrollTo({ [n]: l });
          }),
          r.cancelAnimationFrame(e.cssModeFrameID);
        return;
      }
...
function C(e) {
  let t = a(),
    ...
    c = e.clientLeft || o.clientLeft || 0,
    l = e === t ? t.scrollY : e.scrollTop,
    u = e === t ? t.scrollX : e.scrollLeft;
  return { top: i.top + l - s, left: i.left + u - c };
}
function w(e, t) {
  let n = [];
...
function B({ swiper: e, on: t, emit: n }) {
  let r = a(),
    i = null,
    o = null,
    s = () => {
...
function re({ swiper: e, extendParams: t, on: n, emit: r }) {
  let i = [],
    o = a(),
    s = (t, n = {}) => {
      let a = new (o.MutationObserver || o.WebkitMutationObserver)((t) => {
...
function oe() {
  ...
  let T = n.grid && n.grid.rows > 1 && e.grid;
  T ? e.grid.initSlides(l) : e.grid && e.grid.unsetSlides();
  let D,
    O =
  ...
  for (let r = 0; r < u; r += 1) {
    ...
    let i = l[r];
    if (
      !(i && (T && e.grid.updateSlide(r, i, l), E(i, `display`) === `none`))
    ) {
      if (s && n.slidesPerView === `auto`)
        ...
        if (
          ...
          D = e.isHorizontal() ? A(i, `width`, !0) : A(i, `height`, !0);
        else {
          let e = t(r, `width`),
            n = t(r, `padding-left`),
            a = t(r, `padding-right`),
  ...
  if (
    ...
    T && e.grid.updateWrapperSize(D, d),
    !n.centeredSlides)
  ) {
    let t = [];
...
function ue(e = (this && this.translate) || 0) {
  ...
  for (let e = 0; e < r.length; e += 1) {
    ...
    h && (t.visibleSlides.push(c), t.visibleSlidesIndexes.push(e)),
      le(c, h, n.slideVisibleClass),
      le(c, m, n.slideFullyVisibleClass),
      (c.progress = i ? -u : u),
...
function fe() {
  ...
  c &&
    (o ||
      ((u = T(c, `.${n.slideClass}, swiper-slide`)[0]),
      n.loop && !u && (u = t[0]),
      (l = w(c, `.${n.slideClass}, swiper-slide`)[0]),
      n.loop)),
    t.forEach((e) => {
      V(e, e === c, n.slideActiveClass),
        V(e, e === u, n.slideNextClass),
        V(e, e === l, n.slidePrevClass);
    }),
    e.emitSlidesClasses();
}
var H = (e, t) => {
...
function me(e) {
  ...
  if ((c === void 0 && (c = pe(t)), r.indexOf(n) >= 0)) l = r.indexOf(n);
  else {
...
var ge = {
  ...
  updateActiveIndex: me,
  updateClickedSlide: he,
};
function _e(e = this.isHorizontal() ? `x` : `y`) {
  let t = this,
  ...
  if (
    ...
    if (t === 0) s[e ? `scrollLeft` : `scrollTop`] = -u;
      ...
      if (!a.support.smoothScroll)
        return (
          g({ swiper: a, targetPosition: -u, side: e ? `left` : `top` }), !0
        );
...
function we({ swiper: e, runCallbacks: t, direction: n, step: r }) {
...
function Te(e = !0, t) {
  ...
  r.cssMode ||
    ...
    we({ swiper: n, runCallbacks: e, direction: t, step: `Start` }));
}
function Ee(e = !0, t) {
  let n = this,
    { params: r } = n;
  (n.animating = !1),
    !r.cssMode &&
      (n.setTransition(0),
      we({ swiper: n, runCallbacks: e, direction: t, step: `End` }));
}
var De = { setTransition: Ce, transitionStart: Te, transitionEnd: Ee };
function Oe(e = 0, t, n = !0, r, i) {
  ...
  if (
    ...
    return !1;
  o !== (u || 0) && n && a.emit(`beforeSlideChangeStart`), a.updateProgress(v);
  let y;
  ...
  if (s.cssMode) {
    ...
    if (t === 0)
      ...
      if (!a.support.smoothScroll)
        return (
          g({ swiper: a, targetPosition: n, side: e ? `left` : `top` }), !0
        );
...
function Me(e, t = !0, n) {
  ...
  if (!r.destroyed)
    return (
      e === void 0 && (e = r.params.speed), r.slideTo(r.activeIndex, e, t, n)
    );
}
function Ne(e, t = !0, n, r = 0.5) {
  let i = this;
  if (i.destroyed) return;
...
function Le({
  ...
  if (N < S) {
    ...
    for (let e = 0; e < S - N; e += 1) {
      ...
      if (C) {
        let e = E - t - 1;
        for (let t = l.length - 1; t >= 0; --t) l[t].column === e && w.push(t);
      } else w.push(E - t - 1);
    }
  } else if (N + y > E - S) {
    (M = Math.max(N - (E - S * 2), b)), D && (M = Math.max(M, y - E + _ + 1));
    for (let e = 0; e < M; e += 1) {
      let t = e - Math.floor(e / E) * E;
      C
        ? l.forEach((e, n) => {
...
var ze = { loopCreate: Ie, loopFix: Le, loopDestroy: Re };
function Be(e) {
  let t = this;
  if (
...
var He = { setGrabCursor: Be, unsetGrabCursor: Ve };
function Ue(e, t = this) {
  function n(t) {
...
function Ge(e) {
  ...
  if (i.type === `touchstart`) {
    We(t, i, i.targetTouches[0].pageX);
    return;
  }
  ...
  if (o.noSwiping && (m ? Ue(p, u) : u.closest(p))) {
    t.allowClick = !0;
    return;
  }
  ...
  u.matches(a.focusableElements) &&
    ...
    n.activeElement &&
      ...
      n.activeElement !== u &&
      (i.pointerType === `mouse` ||
        (i.pointerType !== `mouse` && !u.matches(a.focusableElements))) &&
...
function Ke(e) {
  ...
  if (u.type === `touchmove`) {
    if (
      ((d = [...u.changedTouches].find((e) => e.identifier === i.touchId)),
  ...
  if (!n.allowTouchMove) {
    u.target.matches(i.focusableElements) || (n.allowClick = !1),
      i.isTouched &&
        (Object.assign(o, { startX: f, startY: p, currentX: f, currentY: p }),
        (i.touchStartTime = l()));
    return;
  }
...
function qe(e) {
  ...
  let { params: a, touches: o, rtlTranslate: s, slidesGrid: u, enabled: d } = t;
  ...
  for (
    ...
    u[e + t] === void 0
      ? (h || m >= u[e]) && ((g = e), (_ = u[u.length - 1] - u[u.length - 2]))
      : (h || (m >= u[e] && m < u[e + t])) && ((g = e), (_ = u[e + t] - u[e]));
  }
  let v = null,
    y = null;
  a.rewind &&
...
var $e = (e, t) => {
  ...
  !a ||
    typeof a == `string` ||
    (n[l](`touchstart`, e.onDocumentTouchStart, { passive: !1, capture: c }),
  ...
  q = class e {
    ...
    getSlideIndex(e) {
      let { slidesEl: t, params: n } = this,
        r = D(v(t, `.${n.slideClass}, swiper-slide`)[0]);
      return D(e) - r;
    }
    ...
    mount(e) {
      ...
      return (
        ...
        Object.assign(t, {
          ...
          mounted: !0,
          rtl: n.dir.toLowerCase() === `rtl` || E(n, `direction`) === `rtl`,
          rtlTranslate:
            t.params.direction === `horizontal` &&
            (n.dir.toLowerCase() === `rtl` || E(n, `direction`) === `rtl`),
          wrongRTL: E(i, `display`) === `-webkit-box`,
        }),
        !0
      );
    }
    ...
    destroy(e = !0, t = !0) {
      ...
      return n.params === void 0 || n.destroyed
        ...
        : (n.emit(`beforeDestroy`),
          ...
          e !== !1 &&
            (n.el && typeof n.el != `string` && (n.el.swiper = null), s(n)),
          (n.destroyed = !0),
          null);
    }
...
function ht({ swiper: e, extendParams: t, on: n, emit: i }) {
  ...
  function c(t, n) {
    ...
    return (
      r.renderSlide
        ? ((i = r.renderSlide.call(e, t, n)),
          typeof i == `string` && (N(s, i), (i = s.children[0])))
        : (i = e.isElement ? S(`swiper-slide`) : S(`div`, e.params.slideClass)),
  ...
  function l(t, n, r) {
    ...
    let {
        addSlidesBefore: d,
        addSlidesAfter: f,
        slidesPerViewAutoSlideSize: p,
      } = e.params.virtual,
      { from: m, to: h, slides: g, slidesGrid: _, offset: y } = e.virtual;
    e.params.cssMode || e.updateActiveIndex();
    let b = r === void 0 ? e.activeIndex || 0 : r,
      x;
    x = e.rtlTranslate ? `right` : e.isHorizontal() ? `left` : `top`;
    let S;
    if (s === `auto`)
      if (p) {
        let t = e.size;
        (t ||= e.isHorizontal()
          ...
          (S = Math.max(1, Math.ceil(t / p)));
      } else S = 1;
    else S = s;
    let C, w;
    o
      ? ((C = Math.floor(S / 2) + a + f), (w = Math.floor(S / 2) + a + d))
      : ((C = S + (a - 1) + f), (w = (l ? S : a) + d));
    let T = b - w,
      E = b + C;
    l || ((T = Math.max(T, 0)), (E = Math.min(E, g.length - 1)));
    let D = (e.slidesGrid[T] || 0) - (e.slidesGrid[0] || 0);
    l && b >= w
      ? ((T -= w), o || (D += e.slidesGrid[0]))
      : l && b < w && ((T = -w), o && (D += e.slidesGrid[0])),
    ...
    if (m === T && h === E && !t) {
      e.slidesGrid !== _ &&
        D !== y &&
        e.slides.forEach((t) => {
          t.style[x] = `${D - Math.abs(e.cssOverflowAdjustment())}px`;
        }),
        e.updateProgress(),
        i(`virtualUpdate`);
      return;
    ...
    if (e.params.virtual.renderExternal) {
      e.params.virtual.renderExternal.call(e, {
        ...
        slides: (function () {
          let e = [];
          for (let t = T; t <= E; t += 1) e.push(g[t]);
          return e;
        })(),
      }),
        e.params.virtual.renderExternalUpdate ? O() : i(`virtualUpdate`);
      return;
    }
    let k = [],
      A = [],
    ...
    let M = l ? -g.length : 0,
      N = l ? g.length * 2 : g.length;
    for (let e = M; e < N; e += 1)
      if (e >= T && e <= E) {
        let n = j(e);
        h === void 0 || t
          ? A.push(n)
          : (e > h && A.push(n), e < m && k.push(n));
      }
    if (
      (A.forEach((t) => {
        e.slidesEl.append(c(g[t], t));
      }),
      l)
    )
      for (let t = k.length - 1; t >= 0; --t) {
        let n = k[t];
        e.slidesEl.prepend(c(g[n], n));
      }
    else
      k.sort((e, t) => t - e),
        k.forEach((t) => {
          e.slidesEl.prepend(c(g[t], t));
        });
    v(e.slidesEl, `.swiper-slide, swiper-slide`).forEach((t) => {
      t.style[x] = `${D - Math.abs(e.cssOverflowAdjustment())}px`;
    }),
      O();
  }
      ...
      for (let r = t.length - 1; r >= 0; --r)
        e.params.virtual.cache &&
          ...
          Object.keys(e.virtual.cache).forEach((n) => {
            n > t &&
              ((e.virtual.cache[n - 1] = e.virtual.cache[n]),
              e.virtual.cache[n - 1].setAttribute(
  ...
  n(`beforeInit`, () => {
    ...
    if (e.passedParams.virtual.slides === void 0) {
      let n = [...e.slidesEl.children].filter((t) =>
...
function gt({ swiper: e, extendParams: t, on: n, emit: i }) {
  ...
  function c(t) {
    ...
    if (
      (!e.allowSlideNext &&
        ((e.isHorizontal() && f) || (e.isVertical() && m) || u)) ||
      (!e.allowSlidePrev &&
        ((e.isHorizontal() && d) || (e.isVertical() && p) || l))
    )
      return !1;
    if (
      ...
      !(
        ...
        (o.activeElement.isContentEditable ||
          (o.activeElement.nodeName &&
            (o.activeElement.nodeName.toLowerCase() === `input` ||
              o.activeElement.nodeName.toLowerCase() === `textarea`)))
      )
    ) {
      if (e.params.keyboard.onlyInViewport && (l || u || d || f || p || m)) {
        let t = !1;
        if (
          O(e.el, `.${e.params.slideClass}, swiper-slide`).length > 0 &&
          O(e.el, `.${e.params.slideActiveClass}`).length === 0
        )
          return;
        let r = e.el,
          i = r.clientWidth,
      ...
      e.isHorizontal()
        ? ((l || u || d || f) &&
          ...
          (((u || f) && !n) || ((l || d) && n)) && e.slideNext(),
          (((l || d) && !n) || ((u || f) && n)) && e.slidePrev())
        : ((l || u || p || m) &&
            (r.preventDefault ? r.preventDefault() : (r.returnValue = !1)),
          (u || m) && e.slideNext(),
          (l || p) && e.slidePrev()),
  ...
  function l() {
    e.keyboard.enabled ||
      (o.addEventListener(`keydown`, c), (e.keyboard.enabled = !0));
  }
  function u() {
    e.keyboard.enabled &&
      (o.removeEventListener(`keydown`, c), (e.keyboard.enabled = !1));
  }
  n(`init`, () => {
...
function _t({ swiper: e, extendParams: t, on: n, emit: r }) {
  let i = a();
  t({
    mousewheel: {
      enabled: !1,
  ...
  function f(e) {
    ...
    return (
      ...
      (r || i) &&
        e.deltaMode &&
        (e.deltaMode === 1 ? ((r *= 40), (i *= 40)) : ((r *= 800), (i *= 800))),
      r && !t && (t = r < 1 ? -1 : 1),
      i && !n && (n = i < 1 ? -1 : 1),
  ...
  function _(t) {
    ...
    if (a.forceToAxis)
      ...
      m = Math.abs(v.pixelX) > Math.abs(v.pixelY) ? -v.pixelX * _ : -v.pixelY;
    if (m === 0) return !0;
    a.invert && (m = -m);
    ...
    if (
      ...
      if (!i) {
        ...
        if (
          ...
          e.updateActiveIndex(),
          e.updateSlidesClasses(),
          ((!l && e.isBeginning) || (!f && e.isEnd)) && e.updateSlidesClasses(),
          e.params.loop &&
            e.loopFix({
          ...
          let n = d.length ? d[d.length - 1] : void 0,
            r = d[0];
          if (
            (d.push(t), n && (t.delta > n.delta || t.direction !== n.direction))
          )
            d.splice(0);
          else if (
            d.length >= 15 &&
  ...
  return (
    e.params.createElements &&
      Object.keys(r).forEach((i) => {
        if (!n[i] && n.auto === !0) {
          let a = v(e.el, `.${r[i]}`)[0];
          a || ((a = S(`div`, r[i])), (a.className = r[i]), e.el.append(a)),
            (n[i] = a),
            (t[i] = a);
        }
      }),
...
var vt = `<svg class="swiper-navigation-icon" width="11" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.38296 20.0762C0.111788 19.805 0.111788 19.3654 0.38296 19.0942L9.19758 10.2796L0.38296 1.46497C0.111788 1.19379 0.111788 0.754138 0.38296 0.482966C0.654131 0.211794 1.09379 0.211794 1.36496 0.482966L10.4341 9.55214C10.8359 9.9539 10.8359 10.6053 10.4341 11.007L1.36496 20.0762C1.09379 20.3474 0.654131 20.3474 0.38296 20.0762Z" fill="currentColor"/></svg>`;
function yt({ swiper: e, extendParams: t, on: n, emit: r }) {
  t({
    ...
    (e.navigation = { nextEl: null, prevEl: null, arrowSvg: vt });
  function i(t) {
    let n;
    return t &&
      typeof t == `string` &&
    ...
    let a = (n, r) => {
      if (n) {
        if (
          ...
          N(e, vt), n.appendChild(e.querySelector(`svg`)), e.remove();
        }
...
function bt({ swiper: e, extendParams: t, on: n, emit: r }) {
  ...
  function u(t) {
    let n = t.target.closest(Y(e.params.pagination.bulletClass));
    if (!n) return;
    t.preventDefault();
    let r = D(n) * e.params.slidesPerGroup;
    if (e.params.loop) {
  ...
  function d() {
    ...
    if (
      ...
      if (
        (n.dynamicBullets &&
          ((a = A(r[0], e.isHorizontal() ? `width` : `height`, !0)),
          i.forEach((t) => {
        ...
        if (
          ...
          for (let e = s; e <= d; e += 1)
            r[e] &&
              r[e].classList.add(...`${n.bulletActiveClass}-main`.split(` `));
          c(e, `prev`), c(t, `next`);
        }
      }
      if (n.dynamicBullets) {
    ...
    i.forEach((t, i) => {
      if (
        (n.type === `fraction` &&
          (t.querySelectorAll(Y(n.currentClass)).forEach((e) => {
            e.textContent = n.formatFractionCurrent(l + 1);
          }),
          t.querySelectorAll(Y(n.totalClass)).forEach((e) => {
  ...
  function f() {
    ...
    t.type === `fraction` &&
      ...
      i.forEach((n) => {
        t.type !== `custom` && N(n, a || ``),
          t.type === `bullets` &&
            e.pagination.bullets.push(...n.querySelectorAll(Y(t.bulletClass)));
      }),
    ...
    typeof t.el == `string` && e.isElement && (n = e.el.querySelector(t.el)),
      ...
      !(!n || n.length === 0) &&
        (e.params.uniqueNavElements &&
          ...
          n.length > 1 && (n = n.find((t) => O(t, `.swiper`)[0] === e.el))),
    ...
    n &&
      ...
      n.forEach((n) => {
        n.classList.remove(t.hiddenClass),
          ...
          t.clickable &&
            (n.classList.remove(...(t.clickableClass || ``).split(` `)),
    ...
    n(`click`, (t, n) => {
      ...
      if (
        ...
        if (
          ...
          return;
        a[0].classList.contains(e.params.pagination.hiddenClass) === !0
          ? r(`paginationShow`)
          : r(`paginationHide`),
...
function xt({ swiper: e, extendParams: t, on: n, emit: i }) {
  ...
  function _() {
    ...
    (n.style.width = ``),
      (n.style.height = ``),
      (p = e.isHorizontal() ? r.offsetWidth : r.offsetHeight),
      (m =
        e.size /
        (e.virtualSize +
      ...
      e.isHorizontal()
        ? (n.style.width = `${f}px`)
        : (n.style.height = `${f}px`),
      m >= 1 ? (r.style.display = `none`) : (r.style.display = ``),
  ...
  function O() {
    ...
    e.params.scrollbar = J(e, e.originalParams.scrollbar, e.params.scrollbar, {
      el: `swiper-scrollbar`,
    });
    ...
    let i;
    if (
      (typeof r.el == `string` && e.isElement && (i = e.el.querySelector(r.el)),
      !i && typeof r.el == `string`)
    ) {
      if (((i = a.querySelectorAll(r.el)), !i.length)) return;
    } else i ||= r.el;
    e.params.uniqueNavElements &&
      typeof r.el == `string` &&
      i.length > 1 &&
      n.querySelectorAll(r.el).length === 1 &&
      (i = n.querySelector(r.el)),
      i.length > 0 && (i = i[0]),
      i.classList.add(e.isHorizontal() ? r.horizontalClass : r.verticalClass);
    let s;
    i &&
      ((s = i.querySelector(Y(e.params.scrollbar.dragClass))),
      s || ((s = S(`div`, e.params.scrollbar.dragClass)), i.append(s))),
      Object.assign(t, { el: i, dragEl: s }),
      r.draggable && E(),
      i &&
        i.classList[e.enabled ? `remove` : `add`](
          ...o(e.params.scrollbar.lockClass)
        );
  }
  function k() {
    ...
    n &&
      n.classList.remove(
        ...o(e.isHorizontal() ? t.horizontalClass : t.verticalClass)
      ),
      D();
  }
  n(`changeDirection`, () => {
    ...
    n(`init`, () => {
      e.params.scrollbar.enabled === !1 ? M() : (O(), _(), h());
    }),
  ...
  let A = () => {
      e.el.classList.remove(...o(e.params.scrollbar.scrollbarDisabledClass)),
        e.scrollbar.el &&
          e.scrollbar.el.classList.remove(
            ...o(e.params.scrollbar.scrollbarDisabledClass)
          ),
        O(),
        _(),
        h();
    ...
    M = () => {
      e.el.classList.add(...o(e.params.scrollbar.scrollbarDisabledClass)),
        e.scrollbar.el &&
...
function St({ swiper: e, extendParams: t, on: n }) {
  ...
  let r = `[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]`,
    ...
    a = () => {
      let { el: t, slides: n, progress: a, snapGrid: o, isElement: s } = e,
        c = v(t, r);
      e.isElement && c.push(...v(e.hostEl, r)),
        c.forEach((e) => {
          i(e, a);
        }),
        n.forEach((t, n) => {
    ...
    o = (t = e.params.speed) => {
      ...
      e.isElement && a.push(...i.querySelectorAll(r)),
        a.forEach((e) => {
          let n =
            parseInt(e.getAttribute(`data-swiper-parallax-duration`), 10) || t;
...
function Ct({ swiper: e, extendParams: t, on: n, emit: r }) {
  let i = a();
  t({
    zoom: {
      enabled: !1,
  ...
  function b() {
    let t = e.params.zoom,
      n = m.imageWrapEl.getAttribute(`data-swiper-zoom`) || t.maxRatio;
    if (t.limitToOriginalSize && m.imageEl && m.imageEl.naturalWidth) {
  ...
  function x() {
    ...
    return [
      (p[0].pageX + (p[1].pageX - p[0].pageX) / 2 - e.x - i.scrollX) / o,
      (p[0].pageY + (p[1].pageY - p[0].pageY) / 2 - e.y - i.scrollY) / o,
    ];
  }
  function S() {
  ...
  function T(t) {
    ...
    return !!(
      t.target.matches(n) ||
      [...e.hostEl.querySelectorAll(n)].filter((e) => e.contains(t.target))
        .length > 0
    );
  }
  function E(t) {
    if ((t.pointerType === `mouse` && p.splice(0, p.length), !w(t))) return;
    let n = e.params.zoom;
    if (((u = !1), (f = !1), p.push(t), !(p.length < 2))) {
      if (((u = !0), (m.scaleStart = y()), !m.slideEl)) {
        (m.slideEl = t.target.closest(`.${e.params.slideClass}, swiper-slide`)),
          (m.slideEl ||= e.slides[e.activeIndex]);
        ...
        if (
          ...
          (m.imageEl = r),
          r
            ? (m.imageWrapEl = O(m.imageEl, `.${n.containerClass}`)[0])
  ...
  function D(t) {
    ...
    i >= 0 && (p[i] = t),
      !(p.length < 2) &&
        ...
        (m.scaleMove = y()),
        m.imageEl &&
          ((r.scale = (m.scaleMove / m.scaleStart) * o),
          r.scale > m.maxRatio &&
            (r.scale = m.maxRatio - 1 + (r.scale - m.maxRatio + 1) ** 0.5),
          r.scale < n.minRatio &&
            (r.scale = n.minRatio + 1 - (n.minRatio - r.scale + 1) ** 0.5),
          (m.imageEl.style.transform = `translate3d(0,0,0) scale(${r.scale})`)));
  }
  function k(t) {
    if (!w(t) || (t.pointerType === `mouse` && t.type === `pointerout`)) return;
    let n = e.params.zoom,
      r = e.zoom,
      i = p.findIndex((e) => e.pointerId === t.pointerId);
    i >= 0 && p.splice(i, 1),
      !(!u || !f) &&
        ...
        (f = !1),
        m.imageEl &&
          ((r.scale = Math.max(Math.min(r.scale, m.maxRatio), n.minRatio)),
          (m.imageEl.style.transitionDuration = `${e.params.speed}ms`),
          (m.imageEl.style.transform = `translate3d(0,0,0) scale(${r.scale})`),
          (o = r.scale),
          (s = !1),
          r.scale > 1 && m.slideEl
            ? m.slideEl.classList.add(`${n.zoomedSlideClass}`)
            : r.scale <= 1 &&
              m.slideEl &&
              m.slideEl.classList.remove(`${n.zoomedSlideClass}`),
          r.scale === 1 &&
  ...
  function N(t) {
    ...
    n.android && t.cancelable && t.preventDefault(), (h.isTouched = !0);
    let r = p.length > 0 ? p[0] : t;
  ...
  function P(t) {
    ...
    if (
      ...
      (h.maxY = -h.minY),
      (h.touchesCurrent.x = p.length > 0 ? p[0].pageX : t.pageX),
      (h.touchesCurrent.y = p.length > 0 ? p[0].pageY : t.pageY),
      Math.max(
    ...
    t.cancelable && t.preventDefault(),
      ...
      M(),
      (h.isMoved = !0);
    let c = (r.scale - o) / (m.maxRatio - e.params.zoom.minRatio),
      { originX: l, originY: u } = m;
    (h.currentX =
      h.touchesCurrent.x - h.touchesStart.x + h.startX + c * (h.width - l * 2)),
      (h.currentY =
        h.touchesCurrent.y -
        h.touchesStart.y +
        h.startY +
      ...
      (g.prevTime ||= Date.now()),
      (g.x =
        (h.touchesCurrent.x - g.prevPositionX) / (Date.now() - g.prevTime) / 2),
      (g.y =
        (h.touchesCurrent.y - g.prevPositionY) / (Date.now() - g.prevTime) / 2),
  ...
  function ee() {
    let t = e.zoom;
    if (((p.length = 0), !m.imageEl)) return;
    ...
    let n = 300,
      ...
      o = g.y * r,
      s = h.currentY + o;
    g.x !== 0 && (n = Math.abs((a - h.currentX) / g.x)),
      g.y !== 0 && (r = Math.abs((s - h.currentY) / g.y));
    let c = Math.max(n, r);
    (h.currentX = a), (h.currentY = s);
    let l = h.width * t.scale,
      u = h.height * t.scale;
    (h.minX = Math.min(m.slideWidth / 2 - l / 2, 0)),
      (h.maxX = -h.minX),
      (h.minY = Math.min(m.slideHeight / 2 - u / 2, 0)),
      (h.maxY = -h.minY),
      (h.currentX = Math.max(Math.min(h.currentX, h.maxX), h.minX)),
      (h.currentY = Math.max(Math.min(h.currentY, h.maxY), h.minY)),
      (m.imageWrapEl.style.transitionDuration = `${c}ms`),
      (m.imageWrapEl.style.transform = `translate3d(${h.currentX}px, ${h.currentY}px,0)`);
  }
  function F() {
    let t = e.zoom;
    m.slideEl &&
      e.activeIndex !== e.slides.indexOf(m.slideEl) &&
      (m.imageEl && (m.imageEl.style.transform = `translate3d(0,0,0) scale(1)`),
      m.imageWrapEl && (m.imageWrapEl.style.transform = `translate3d(0,0,0)`),
      m.slideEl.classList.remove(`${e.params.zoom.zoomedSlideClass}`),
      (t.scale = 1),
      (o = 1),
      (m.slideEl = void 0),
      (m.imageEl = void 0),
  ...
  function I(e) {
    if (o <= 1 || !m.imageWrapEl || !w(e) || !T(e)) return;
    let t = i.getComputedStyle(m.imageWrapEl).transform,
      n = new i.DOMMatrix(t);
    if (!c) {
      (c = !0),
        (l.x = e.clientX),
    ...
    let r = (e.clientX - l.x) * -3,
      a = (e.clientY - l.y) * -3,
      s = h.width * o,
      u = h.height * o,
      d = m.slideWidth,
      f = m.slideHeight,
      p = Math.min(d / 2 - s / 2, 0),
      g = -p,
      _ = Math.min(f / 2 - u / 2, 0),
      v = -_,
      y = Math.max(Math.min(h.startX + r, g), p),
      b = Math.max(Math.min(h.startY + a, v), _);
    (m.imageWrapEl.style.transitionDuration = `0ms`),
      (m.imageWrapEl.style.transform = `translate3d(${y}px, ${b}px, 0)`),
      (l.x = e.clientX),
      (l.y = e.clientY),
      (h.startX = y),
      (h.startY = b),
  ...
  function te(t) {
      ...
      t &&
        ...
        m.slideEl ||
          (e.params.virtual && e.params.virtual.enabled && e.virtual
            ? (m.slideEl = v(e.slidesEl, `.${e.params.slideActiveClass}`)[0])
            : (m.slideEl = e.slides[e.activeIndex]));
      let n = m.slideEl.querySelector(`.${r.containerClass}`);
      (n &&= n.querySelectorAll(
        `picture, img, svg, canvas, .swiper-zoom-target`
      )[0]),
        (m.imageEl = n),
        n
          ? (m.imageWrapEl = O(m.imageEl, `.${r.containerClass}`)[0])
          : (m.imageWrapEl = void 0);
    }
    ...
    let a, s, c, l, u, d, f, p, g, _, y, x, S, w, T, E, D, k;
    h.touchesStart.x === void 0 && t
      ? ((a = t.pageX), (s = t.pageY))
      : ((a = h.touchesStart.x), (s = h.touchesStart.y));
    let A = o,
      j = typeof t == `number` ? t : null;
    o === 1 &&
      j &&
      ((a = void 0),
      (s = void 0),
    ...
    (n.scale = j || M),
      ...
      t && !(o === 1 && j)
        ? ((D = m.slideEl.offsetWidth),
          ...
          (c = C(m.slideEl).left + i.scrollX),
          (l = C(m.slideEl).top + i.scrollY),
          (u = c + D / 2 - a),
          (d = l + k / 2 - s),
          (g = m.imageEl.offsetWidth || m.imageEl.clientWidth),
          (_ = m.imageEl.offsetHeight || m.imageEl.clientHeight),
          (y = g * n.scale),
          (x = _ * n.scale),
          (S = Math.min(D / 2 - y / 2, 0)),
          (w = Math.min(k / 2 - x / 2, 0)),
          (T = -S),
          (E = -w),
          A > 0 &&
          j &&
          typeof h.currentX == `number` &&
          typeof h.currentY == `number`
            ? ((f = (h.currentX * n.scale) / A),
              (p = (h.currentY * n.scale) / A))
            : ((f = u * n.scale), (p = d * n.scale)),
          f < S && (f = S),
          f > T && (f = T),
          p < w && (p = w),
          p > E && (p = E))
        : ((f = 0), (p = 0)),
      j && n.scale === 1 && ((m.originX = 0), (m.originY = 0)),
      (h.currentX = f),
      (h.currentY = p),
      (m.imageWrapEl.style.transitionDuration = `300ms`),
      (m.imageWrapEl.style.transform = `translate3d(${f}px, ${p}px,0)`),
      (m.imageEl.style.transitionDuration = `300ms`),
      (m.imageEl.style.transform = `translate3d(0,0,0) scale(${n.scale})`);
  }
  function L() {
    let t = e.zoom,
      n = e.params.zoom;
    ...
    !m.imageEl ||
      ...
      e.params.zoom.panOnMouseMove &&
        ((l = { x: 0, y: 0 }),
        c && ((c = !1), (h.startX = 0), (h.startY = 0))));
  }
  function R(t) {
    let n = e.zoom;
    n.scale && n.scale !== 1 ? L() : te(t);
  }
  function ne() {
    return {
  ...
  function z() {
    ...
    if (t.enabled) return;
    t.enabled = !0;
    let { passiveListener: n, activeListenerWithCapture: r } = ne();
    e.wrapperEl.addEventListener(`pointerdown`, E, n),
      e.wrapperEl.addEventListener(`pointermove`, D, r),
      [`pointerup`, `pointercancel`, `pointerout`].forEach((t) => {
        e.wrapperEl.addEventListener(t, k, n);
      }),
      e.wrapperEl.addEventListener(`pointermove`, P, r);
  }
  function B() {
    let t = e.zoom;
    if (!t.enabled) return;
    t.enabled = !1;
    let { passiveListener: n, activeListenerWithCapture: r } = ne();
    e.wrapperEl.removeEventListener(`pointerdown`, E, n),
      e.wrapperEl.removeEventListener(`pointermove`, D, r),
      [`pointerup`, `pointercancel`, `pointerout`].forEach((t) => {
        e.wrapperEl.removeEventListener(t, k, n);
      }),
      e.wrapperEl.removeEventListener(`pointermove`, P, r);
  }
  n(`init`, () => {
    ...
    Object.assign(e.zoom, { enable: z, disable: B, in: te, out: L, toggle: R });
}
  ...
  function a(t, n) {
    ...
    function c(t) {
      ...
      e.params.controller.by === `slide` &&
        (i(t), (o = -e.controller.spline.interpolate(-n))),
...
function Tt({ swiper: e, extendParams: t, on: n }) {
  t({
    a11y: {
      enabled: !0,
  ...
  function b(t) {
    ...
    if (
      !(
        e.pagination &&
        e.pagination.el &&
        (r === e.pagination.el || e.pagination.el.contains(t.target)) &&
        !t.target.matches(Y(e.params.pagination.bulletClass))
      )
    ) {
      if (e.navigation && e.navigation.prevEl && e.navigation.nextEl) {
        let t = j(e.navigation.prevEl);
        j(e.navigation.nextEl).includes(r) &&
          ((e.isEnd && !e.params.loop) || e.slideNext(),
          e.isEnd ? c(n.lastSlideMessage) : c(n.nextSlideMessage)),
          t.includes(r) &&
            ((e.isBeginning && !e.params.loop) || e.slidePrev(),
            e.isBeginning ? c(n.firstSlideMessage) : c(n.prevSlideMessage));
      }
      e.pagination &&
        r.matches(Y(e.params.pagination.bulletClass)) &&
        r.click();
    }
  }
  function x() {
    ...
    let { nextEl: t, prevEl: n } = e.navigation;
    n && (e.isBeginning ? (v(n), d(n)) : (y(n), u(n))),
      t && (e.isEnd ? (v(t), d(t)) : (y(t), u(t)));
  }
  function C() {
      ...
      e.pagination.bullets.forEach((n) => {
        e.params.pagination.clickable &&
          ...
          e.params.pagination.renderBullet ||
            ...
            h(
              n,
              t.paginationBulletMessage.replace(/\{\{index\}\}/, D(n) + 1)
            ))),
          n.matches(Y(e.params.pagination.bulletActiveClass))
  ...
  let E = (e, t, n) => {
      u(e),
        e.tagName !== `BUTTON` &&
          (f(e, `button`), e.addEventListener(`keydown`, b)),
        h(e, n),
        m(e, t);
    },
    O = (t) => {
      o && o !== t.target && !o.contains(t.target) && (a = !0),
        (e.a11y.clicked = !0);
    },
    k = () => {
      (a = !1),
    ...
    M = (t) => {
      ...
      o = n;
      let r = e.slides.indexOf(n) === e.activeIndex,
        i =
    ...
    P = () => {
      let t = e.params.a11y;
      t.itemRoleDescriptionMessage && p(e.slides, t.itemRoleDescriptionMessage),
        t.slideRole && f(e.slides, t.slideRole);
    ...
    ee = () => {
      ...
      t.containerRoleDescriptionMessage &&
        p(n, t.containerRoleDescriptionMessage),
        t.containerMessage && h(n, t.containerMessage),
        t.containerRole && f(n, t.containerRole);
      let a = e.wrapperEl,
        o = t.id || a.getAttribute(`id`) || `swiper-wrapper-${l(16)}`;
      g(a, o),
        t.wrapperLiveRegion &&
          _(
            a,
        ...
        P();
      let { nextEl: s, prevEl: c } = e.navigation ? e.navigation : {};
      (s = j(s)),
        (c = j(c)),
        s && s.forEach((e) => E(e, o, t.nextSlideMessage)),
        c && c.forEach((e) => E(e, o, t.prevSlideMessage)),
        w() &&
          j(e.pagination.el).forEach((e) => {
            e.addEventListener(`keydown`, b);
          }),
        r().addEventListener(`visibilitychange`, A),
  ...
  function F() {
    ...
    (t = j(t)),
      (n = j(n)),
      t && t.forEach((e) => e.removeEventListener(`keydown`, b)),
      n && n.forEach((e) => e.removeEventListener(`keydown`, b)),
      w() &&
        j(e.pagination.el).forEach((e) => {
          e.removeEventListener(`keydown`, b);
        }),
      r().removeEventListener(`visibilitychange`, A),
      e.el &&
        typeof e.el != `string` &&
  ...
  n(`beforeInit`, () => {
    (i = S(`span`, e.params.a11y.notificationClass)),
...
function Et({ swiper: e, extendParams: t, on: n }) {
  t({
    history: {
      enabled: !1,
      root: ``,
  ...
  let r = !1,
    ...
    c = (t, n) => {
      ...
      let s;
      s = e.params.url ? new URL(e.params.url) : i.location;
      let c = o(
        (e.virtual && e.params.virtual.enabled
      ...
      if (e.params.history.root.length > 0) {
        ...
        n[n.length - 1] === `/` && (n = n.slice(0, n.length - 1)),
          (c = `${n}/${t ? `${t}/` : ``}${c}`);
      } else s.pathname.includes(t) || (c = `${t ? `${t}/` : ``}${c}`);
      e.params.history.keepQuery && (c += s.search);
      let l = i.history.state;
      (l && l.value === c) ||
    ...
    u = () => {
      (i = s(e.params.url)), l(e.params.speed, i.value, !1);
    },
    d = () => {
      let t = a();
      if (e.params.history) {
...
function Dt({ swiper: e, extendParams: t, emit: n, on: i }) {
  let o = !1,
    s = r(),
    c = a();
  t({
  ...
  let l = () => {
    ...
    u = () => {
      ...
      c.history.replaceState
        ? (c.history.replaceState(null, null, `#${r}` || ``), n(`hashSet`))
    ...
    d = () => {
      ...
      e.params.hashNavigation.watchState && c.addEventListener(`hashchange`, l);
    },
    f = () => {
      e.params.hashNavigation.watchState &&
        c.removeEventListener(`hashchange`, l);
    };
  i(`init`, () => {
...
function Ot({ swiper: e, extendParams: t, on: n, emit: i, params: a }) {
  ...
  function y(t) {
    !e ||
      ...
      (t.target === e.wrapperEl &&
        ...
        !(v || (t.detail && t.detail.bySwiperTouchMove)) && E()));
  }
  let b = () => {
    ...
    S = (t) => {
      ...
      let n = t === void 0 ? e.params.autoplay.delay : t;
      (c = e.params.autoplay.delay), (l = e.params.autoplay.delay);
      let r = x();
      !Number.isNaN(r) && r > 0 && t === void 0 && ((n = r), (c = r), (l = r)),
        (u = n);
      let a = e.params.speed,
        f = () => {
          !e ||
            e.destroyed ||
    ...
    T = (t, n) => {
      ...
      if (((e.autoplay.paused = !0), n)) {
        g && (u = e.params.autoplay.delay), (g = !1), r();
        return;
      }
    ...
    D = () => {
      if (e.destroyed || !e.autoplay.running) return;
      let t = r();
      t.visibilityState === `hidden` && ((_ = !0), T(!0)),
        t.visibilityState === `visible` && E();
    },
    O = (t) => {
      t.pointerType === `mouse` &&
        ((_ = !0), (v = !0), !(e.animating || e.autoplay.paused) && T(!0));
    },
    k = (t) => {
      t.pointerType === `mouse` && ((v = !1), e.autoplay.paused && E());
    },
    A = () => {
...
function kt({ swiper: e, extendParams: t, on: n }) {
  ...
  function c(t) {
    ...
    if (
      ...
      for (let t = 0; t < i; t += 1)
        v(n.slidesEl, `[data-swiper-slide-index="${e.realIndex + t}"]`).forEach(
          (e) => {
            e.classList.add(a);
          }
        );
      ...
      for (let t = 0; t < i; t += 1)
        n.slides[e.realIndex + t] && n.slides[e.realIndex + t].classList.add(a);
    ...
    if (e.realIndex !== n.realIndex || s) {
      ...
      if (n.params.loop) {
        ...
        (a = n.slides.indexOf(t)),
          (c = e.activeIndex > e.previousIndex ? `next` : `prev`);
      } else (a = e.realIndex), (c = a > e.previousIndex ? `next` : `prev`);
      s && (a += c === `next` ? o : -1 * o),
        n.visibleSlidesIndexes &&
          n.visibleSlidesIndexes.indexOf(a) < 0 &&
          (n.params.centeredSlides
            ? (a =
                a > i ? a - Math.floor(r / 2) + 1 : a + Math.floor(r / 2) - 1)
            : a > i && n.params.slidesPerGroup,
    ...
    if (!(!t || !t.swiper))
      if (typeof t.swiper == `string` || t.swiper instanceof HTMLElement) {
        let n = r(),
          ...
          a = () => {
            e.destroyed || i() || requestAnimationFrame(a);
          };
...
function At({ swiper: e, extendParams: t, emit: n, once: r }) {
  t({
    freeMode: {
      enabled: !1,
      momentum: !0,
    ...
    if (i.freeMode.momentum) {
      if (c.velocities.length > 1) {
        ...
        (e.velocity = r / a),
          ...
          (a > 150 || l() - t.time > 300) && (e.velocity = 0);
      } else e.velocity = 0;
      ...
      let f = !1,
        p,
        m = Math.abs(e.velocity) * 20 * i.freeMode.momentumBounceRatio,
        h;
      if (d < e.maxTranslate())
        i.freeMode.momentumBounce
          ? (d + e.maxTranslate() < -m && (d = e.maxTranslate() - m),
            (p = e.maxTranslate()),
            (f = !0),
        ...
        i.freeMode.momentumBounce
          ? (d - e.minTranslate() > m && (d = e.minTranslate() + m),
            (p = e.minTranslate()),
            (f = !0),
            (c.allowMomentumBounce = !0))
          : (d = e.minTranslate()),
        ...
        (d =
          Math.abs(s[t] - d) < Math.abs(s[t - 1] - d) ||
      ...
      if (
        ...
        if (
          ...
          let n = Math.abs((o ? -d : d) - e.translate),
  ...
  Object.assign(e, {
    freeMode: { onTouchStart: i, onTouchMove: a, onTouchEnd: o },
  });
}
function jt({ swiper: e, extendParams: t, on: n }) {
...
function Mt(e) {
  ...
  let i = (e) => {
    if (typeof e == `string`) {
      ...
      N(t, e), r.append(t.children[0]), N(t, ``);
    } else r.append(e);
  };
...
function Nt(e) {
  ...
  let a = r + 1,
    o = (e) => {
      if (typeof e == `string`) {
        let t = document.createElement(`div`);
        N(t, e), i.prepend(t.children[0]), N(t, ``);
      } else i.prepend(e);
    };
  if (typeof e == `object` && `length` in e) {
...
function Pt(e, t) {
  ...
  n.recalcSlides(),
    ...
    r.loop ? n.slideTo(c + n.loopedSlides, 0, !1) : n.slideTo(c, 0, !1);
}
function Ft(e) {
  let t = this,
  ...
  if (typeof e == `object` && `length` in e) {
    for (let n = 0; n < e.length; n += 1)
      (o = e[n]), t.slides[o] && t.slides[o].remove(), o < a && --a;
    a = Math.max(a, 0);
  } else
    (o = e),
...
function Lt({ swiper: e }) {
  Object.assign(e, {
    appendSlide: Mt.bind(e),
    prependSlide: Nt.bind(e),
    addSlide: Pt.bind(e),
    removeSlide: Ft.bind(e),
    removeAllSlides: It.bind(e),
  });
}
function X(e) {
  let {
...
function Q({ swiper: e, duration: t, transformElements: n, allSlides: r }) {
  let { activeIndex: i } = e,
    a = (t) =>
      t.parentElement
        ? t.parentElement
        : e.slides.find((e) => e.shadowRoot && e.shadowRoot === t.parentNode);
...
function Rt({ swiper: e, extendParams: t, on: n }) {
    ...
    X({
      ...
      setTransition: (t) => {
        ...
        n.forEach((e) => {
          ...
          Q({ swiper: e, duration: t, transformElements: n, allSlides: !0 });
      },
      overwriteParams: () => ({
        slidesPerView: 1,
        slidesPerGroup: 1,
    ...
    setTranslate: () => {
      ...
      d.shadow &&
        (f
          ? ((h = e.wrapperEl.querySelector(`.swiper-cube-shadow`)),
            h || ((h = S(`div`, `swiper-cube-shadow`)), e.wrapperEl.append(h)),
            (h.style.height = `${a}px`))
          : ((h = t.querySelector(`.swiper-cube-shadow`)),
            h || ((h = S(`div`, `swiper-cube-shadow`)), t.append(h))));
      for (let e = 0; e < i.length; e += 1) {
        ...
        n % 4 == 0
          ...
          s && (h = -h),
          f || ((g = h), (h = 0));
        let v = `rotateX(${u(f ? 0 : -a)}deg) rotateY(${u(
          f ? a : 0
        )}deg) translate3d(${h}px, ${g}px, ${_}px)`;
        l <= 1 &&
          l > -1 &&
          ((m = n * 90 + l * 90), s && (m = -n * 90 - l * 90)),
          (t.style.transform = v),
          d.slideShadows && r(t, l, f);
      }
      if (
        ...
        if (f)
          h.style.transform = `translate3d(0px, ${a / 2 + d.shadowOffset}px, ${
            -a / 2
          }px) rotateX(89.99deg) rotateZ(0deg) scale(${d.shadowScale})`;
        else {
          let e = Math.abs(m) - Math.floor(Math.abs(m) / 90) * 90,
            ...
            r = d.shadowScale / t,
            i = d.shadowOffset;
          h.style.transform = `scale3d(${n}, 1, ${r}) translate3d(0px, ${
            o / 2 + i
          }px, ${-o / 2 / r}px) rotateX(-89.99deg)`;
        }
      let g = (l.isSafari || l.isWebView) && l.needPerspectiveFix ? -c / 2 : 0;
      (n.style.transform = `translate3d(0px,0,${g}px) rotateX(${u(
        e.isHorizontal() ? 0 : m
      )}deg) rotateY(${u(e.isHorizontal() ? -m : 0)}deg)`),
...
function $(e, t, n) {
  ...
  return a || ((a = S(`div`, r.split(` `))), i.append(a)), a;
}
function Bt({ swiper: e, extendParams: t, on: n }) {
  ...
  let r = (t, n) => {
    ...
    (r ||= $(`flip`, t, e.isHorizontal() ? `left` : `top`)),
      (i ||= $(`flip`, t, e.isHorizontal() ? `right` : `bottom`)),
  ...
  X({
    ...
    setTranslate: () => {
      ...
      for (let o = 0; o < t.length; o += 1) {
        ...
        e.params.flipEffect.limitRotation &&
          (c = Math.max(Math.min(s.progress, 1), -1));
        ...
        e.isHorizontal()
          ...
          i.slideShadows && r(s, c);
        let m = `translate3d(${f}px, ${p}px, 0px) rotateX(${a(
            d
          )}deg) rotateY(${a(u)}deg)`,
          h = Z(i, s);
        h.style.transform = m;
    ...
    setTransition: (t) => {
      ...
      n.forEach((e) => {
        ...
        Q({ swiper: e, duration: t, transformElements: n });
    },
    recreateShadows: () => {
      e.params.flipEffect,
        e.slides.forEach((t) => {
...
function Vt({ swiper: e, extendParams: t, on: n }) {
  t({
    coverflowEffect: {
      rotate: 50,
      stretch: 0,
      ...
      setTranslate: () => {
        ...
        for (let e = 0, t = r.length; e < t; e += 1) {
          let t = r[e],
            ...
            f =
              typeof a.modifier == `function` ? a.modifier(s) : s * a.modifier,
            p = o ? l * f : 0,
            m = o ? 0 : l * f,
            h = -u * Math.abs(f),
            g = a.stretch;
          ...
          let b = `translate3d(${v}px,${_}px,${h}px)  rotateX(${d(
              m
            )}deg) rotateY(${d(p)}deg) scale(${y})`,
            x = Z(a, t);
          if (
            ((x.style.transform = b),
            (t.style.zIndex = -Math.abs(Math.round(f)) + 1),
            a.slideShadows)
          ) {
            let e = o
                ? t.querySelector(`.swiper-slide-shadow-left`)
              ...
              n = o
                ? t.querySelector(`.swiper-slide-shadow-right`)
                : t.querySelector(`.swiper-slide-shadow-bottom`);
            (e ||= $(`coverflow`, t, o ? `left` : `top`)),
              (n ||= $(`coverflow`, t, o ? `right` : `bottom`)),
...
function Ht({ swiper: e, extendParams: t, on: n }) {
  t({
    creativeEffect: {
      limitProgress: 1,
      shadowPerProgress: !1,
  ...
  X({
    ...
    setTranslate: () => {
      ...
      for (let n = 0; n < t.length; n += 1) {
        ...
        let _ = p.join(`, `),
          v = `rotateX(${c(m[0])}deg) rotateY(${c(m[1])}deg) rotateZ(${c(
            m[2]
          )}deg)`,
          y =
            d < 0
              ? `scale(${1 + (1 - g.scale) * d * o})`
              : `scale(${1 - (1 - g.scale) * d * o})`,
          b = d < 0 ? 1 + (1 - g.opacity) * d * o : 1 - (1 - g.opacity) * d * o,
          x = `translate3d(${_}) ${v} ${y}`;
        if ((h && g.shadow) || !h) {
          let e = i.querySelector(`.swiper-slide-shadow`);
          if ((!e && g.shadow && (e = $(`creative`, i)), e)) {
        ...
        for (let c = 0; c < t.length; c += 1) {
          ...
          if (b || x) {
            ...
            (_ += -28 * d * t),
              ...
              (v += 96 * t),
              (m = `${
                (i.rotate || e.isHorizontal() ? -25 : 0) * t * Math.abs(d)
              }%`);
          }
          if (
            ((p =
              d < 0
                ? `calc(${p}px ${r ? `-` : `+`} (${v * Math.abs(d)}%))`
                : d > 0
                ? `calc(${p}px ${r ? `-` : `+`} (-${v * Math.abs(d)}%))`
                : `${p}px`),
            !e.isHorizontal())
