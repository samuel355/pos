    ...
    return (
      ...
      (e.prototype.initListeners = function () {
        ...
        if (
          ...
          if (window.ResizeObserver) {
            var r = !1;
            (this.resizeObserver = new (n.ResizeObserver || ResizeObserver)(
              function () {
                r &&
      ...
      (e.prototype.recalculate = function () {
        if (
          ...
          (this.elStyles = N(this.el).getComputedStyle(this.el)),
          ...
          (this.contentWrapperEl.style.height = t ? `auto` : `100%`),
            (this.placeholderEl.style.width = n ? `${e || s}px` : `auto`),
            (this.placeholderEl.style.height = `${o}px`);
          var c = this.contentWrapperEl.offsetHeight;
          (this.axis.x.isOverflowing = e !== 0 && s > e),
            (this.axis.y.isOverflowing = o > c),
            (this.axis.x.isOverflowing =
              i === `hidden` ? !1 : this.axis.x.isOverflowing),
          ...
          (this.axis.x.isOverflowing = this.axis.x.isOverflowing && s > r - u),
            (this.axis.y.isOverflowing =
              this.axis.y.isOverflowing && o > c - l),
...
var xr = {
    ...
    getDataAttributes(e) {
      ...
      for (let r of n) {
        let n = r.replace(/^bs/, ``);
        (n = n.charAt(0).toLowerCase() + n.slice(1)), (t[n] = yr(e.dataset[r]));
      }
      return t;
    },
...
var Br = `swipe`,
  ...
  Fi = class e extends Z {
    ...
    _addEventListeners() {
      this._config.keyboard && X.on(this._element, fi, (e) => this._keydown(e)),
    ...
    _addTouchEventListeners() {
      ...
      this._swipeHelper = new $r(this._element, {
...
function ss(e, t, n) {
  ...
  for (let e of i) {
    ...
    let r = [].concat(...e.attributes),
      i = [].concat(t[`*`] || [], t[n] || []);
    for (let t of r) os(t, i) || e.removeAttribute(t.nodeName);
  }
  return r.body.innerHTML;
}
var cs = `TemplateFactory`,
  ls = {
    allowList: rs,
    content: {},
    extraClass: ``,
  ...
  fs = class extends Sr {
    ...
    _checkContent(e) {
      for (let [t, n] of Object.entries(e))
        super._typeCheckConfig({ selector: t, entry: n }, ds);
    }
    _setContent(e, t, n) {
      let r = Q.findOne(n, e);
      if (r) {
    ...
    _maybeSanitize(e) {
      return this._config.sanitize
        ? ss(e, this._config.allowList, this._config.sanitizeFn)
        : e;
    }
  ...
  ps = `tooltip`,
  ms = new Set([`sanitize`, `allowList`, `sanitizeFn`]),
  hs = `fade`,
  gs = `modal`,
  _s = `show`,
  vs = `.tooltip-inner`,
  ...
  Rs = class e extends Z {
    ...
    dispose() {
      clearTimeout(this._timeout),
        X.off(this._element.closest(ys), bs, this._hideModalHandler),
    ...
    show() {
      ...
      let e = X.trigger(this._element, this.constructor.eventName(Ds)),
        t = (
      ...
      if (
        (this._element.ownerDocument.documentElement.contains(this.tip) ||
          (r.append(n),
          X.trigger(this._element, this.constructor.eventName(ks))),
          ...
          this._queueCallback(
            () => {
              this._isWithActiveTrigger() ||
                ...
                X.trigger(this._element, this.constructor.eventName(Es)));
            },
            this.tip,
            this._isAnimated()
          );
    ...
    _createTipElement(e) {
      ...
      if (!t) return null;
      t.classList.remove(hs, _s),
        t.classList.add(`bs-${this.constructor.NAME}-auto`);
      let n = Vn(this.constructor.NAME).toString();
      return (
        t.setAttribute(`id`, n), this._isAnimated() && t.classList.add(hs), t
      );
    }
    setContent(e) {
      (this._newContent = e),
    ...
    _createPopper(e) {
      let t =
        Fs[Y(this._config.placement, [this, e, this._element]).toUpperCase()];
    ...
    _setListeners() {
        ...
        if (t === `click`)
          X.on(
            ...
            (e) => {
              ...
              (t._activeTrigger[Cs] = !(t._isShown() && t._activeTrigger[Cs])),
                t.toggle();
            }
          );
        else if (t !== ws) {
          ...
          X.on(this._element, e, this._config.selector, (e) => {
            let t = this._initializeOnDelegatedTarget(e);
            (t._activeTrigger[e.type === `focusin` ? Ss : xs] = !0), t._enter();
          }),
            X.on(this._element, n, this._config.selector, (e) => {
              let t = this._initializeOnDelegatedTarget(e);
              (t._activeTrigger[e.type === `focusout` ? Ss : xs] =
      ...
      (this._hideModalHandler = () => {
        ...
        X.on(this._element.closest(ys), bs, this._hideModalHandler);
    }
    _fixTitle() {
    ...
    _getConfig(e) {
      ...
      for (let e of Object.keys(t)) ms.has(e) && delete t[e];
      return (
...
var zs = `popover`,
  ...
  Us = { ...Rs.DefaultType, content: `(null|string|element|function)` },
  Ws = class e extends Rs {
    static get Default() {
      return Hs;
    }
    static get DefaultType() {
...
var Gs = `scrollspy`,
  ...
  tc = `.nav, .list-group`,
  nc = `.nav-link`,
  rc = `${nc}, .nav-item > ${nc}, .list-group-item`,
  ic = `.dropdown`,
  ac = `.dropdown-toggle`,
  oc = {
    offset: null,
  ...
  cc = class e extends Z {
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        (X.off(this._config.target, Ys),
        X.on(this._config.target, Ys, ec, (e) => {
    ...
    _initializeTargetsAndObservables() {
      ...
      let e = Q.find(ec, this._config.target);
      for (let t of e) {
    ...
    _process(e) {
      this._activeTarget !== e &&
        ...
        X.trigger(this._element, Js, { relatedTarget: e }));
    }
    _activateParents(e) {
      if (e.classList.contains(Zs)) {
        Q.findOne(ac, e.closest(ic)).classList.add(Qs);
        return;
      }
      for (let t of Q.parents(e, tc))
        for (let e of Q.prev(t, rc)) e.classList.add(Qs);
    }
    _clearActiveClass(e) {
      e.classList.remove(Qs);
      let t = Q.find(`${ec}.${Qs}`, e);
      for (let e of t) e.classList.remove(Qs);
    }
    static jQueryInterface(t) {
      return this.each(function () {
        let n = e.getOrCreateInstance(this, t);
...
X.on(window, Xs, () => {
  for (let e of Q.find($s)) cc.getOrCreateInstance(e);
}),
  J(cc);
var lc = `tab`,
  uc = `.bs.tab`,
  ...
  Mc = `.nav-item, .list-group-item`,
  Nc = `.nav-link${Ac}, .list-group-item${Ac}, [role="tab"]${Ac}`,
  Pc = `[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]`,
  Fc = `${Nc}, ${Pc}`,
  Ic = `.${wc}[data-bs-toggle="tab"], .${wc}[data-bs-toggle="pill"], .${wc}[data-bs-toggle="list"]`,
  Lc = class e extends Z {
    constructor(e) {
      super(e),
        (this._parent = this._element.closest(jc)),
        this._parent &&
          (this._setInitialAttributes(this._parent, this._getChildren()),
          X.on(this._element, gc, (e) => this._keydown(e)));
    }
    static get NAME() {
      return lc;
    }
    show() {
      ...
      let t = this._getActiveElem(),
        n = t ? X.trigger(t, dc, { relatedTarget: e }) : null;
      X.trigger(e, pc, { relatedTarget: t }).defaultPrevented ||
        ...
        this._queueCallback(
          () => {
            ...
            e.removeAttribute(`tabindex`),
              ...
              X.trigger(e, mc, { relatedTarget: t });
          },
          e,
        ...
        this._queueCallback(
          () => {
            ...
            e.setAttribute(`aria-selected`, !1),
              ...
              X.trigger(e, fc, { relatedTarget: t });
          },
          e,
          e.classList.contains(Tc)
        ));
    ...
    _keydown(t) {
      if (![vc, yc, bc, xc, Sc, Cc].includes(t.key)) return;
      t.stopPropagation(), t.preventDefault();
      let n = this._getChildren().filter((e) => !Kn(e)),
        r;
      if ([Sc, Cc].includes(t.key)) r = n[t.key === Sc ? 0 : n.length - 1];
      else {
        let e = [yc, xc].includes(t.key);
        r = er(n, t.target, e, !0);
      }
      r && (r.focus({ preventScroll: !0 }), e.getOrCreateInstance(r).show());
    }
    _getChildren() {
      return Q.find(Fc, this._parent);
    }
    _getActiveElem() {
    ...
    _toggleDropDown(e, t) {
      ...
      if (!n.classList.contains(Dc)) return;
      let r = (e, r) => {
        let i = Q.findOne(e, n);
        i && i.classList.toggle(r, t);
      };
      r(Oc, wc), r(kc, Ec), n.setAttribute(`aria-expanded`, t);
    }
    _setAttributeIfNotExists(e, t, n) {
      e.hasAttribute(t) || e.setAttribute(t, n);
    }
    _elemIsActive(e) {
      return e.classList.contains(wc);
    }
    _getInnerElement(e) {
      return e.matches(Fc) ? e : Q.findOne(Fc, e);
    }
    _getOuterElement(e) {
...
X.on(document, hc, Pc, function (e) {
  [`A`, `AREA`].includes(this.tagName) && e.preventDefault(),
    !Kn(this) && Lc.getOrCreateInstance(this).show();
}),
  X.on(window, _c, () => {
    for (let e of Q.find(Ic)) Lc.getOrCreateInstance(e);
  }),
  J(Lc);
var Rc = `toast`,
  zc = `.bs.toast`,
  ...
  el = class e extends Z {
    ...
    show() {
      X.trigger(this._element, Kc).defaultPrevented ||
        (this._clearTimeout(),
        this._config.animation && this._element.classList.add(Jc),
        this._element.classList.remove(Yc),
        Yn(this._element),
        this._element.classList.add(Xc, Zc),
        this._queueCallback(
          () => {
            this._element.classList.remove(Zc),
              X.trigger(this._element, qc),
    ...
    hide() {
      !this.isShown() ||
        X.trigger(this._element, Wc).defaultPrevented ||
        (this._element.classList.add(Zc),
        this._queueCallback(
          () => {
            this._element.classList.add(Yc),
              this._element.classList.remove(Zc, Xc),
              X.trigger(this._element, Gc);
          },
          this._element,
          this._config.animation
        ));
    ...
    dispose() {
      this._clearTimeout(),
        this.isShown() && this._element.classList.remove(Xc),
        super.dispose();
    }
    isShown() {
    ...
    _setListeners() {
      X.on(this._element, Bc, (e) => this._onInteraction(e, !0)),
        X.on(this._element, Vc, (e) => this._onInteraction(e, !1)),
        X.on(this._element, Hc, (e) => this._onInteraction(e, !0)),
        X.on(this._element, Uc, (e) => this._onInteraction(e, !1));
    }
    _clearTimeout() {
...
var tl = {
  ...
  sl = (e) =>
    e.replace(
      /(\w)(\w*)(_|-|\s*)/g,
      (e, t, n) => t.toUpperCase() + n.toLowerCase()
    ),
  cl = (e, { nameAttr: t, icons: n, attrs: r }) => {
    ...
    let o = il(e),
      s = { ...tl, "data-lucide": i, ...r, ...o },
      c = ol([`lucide`, `lucide-${i}`, o, r]);
    c && Object.assign(s, { class: c });
    let l = rl(a, s);
    return e.parentNode?.replaceChild(l, e);
  },
  ll = [
  ...
  Tf = [[`path`, { d: `m7 7 10 10-5 5V2l5 5L7 17` }]],
  Ef = [
    [
      `path`,
      {
  ...
  gh = [[`path`, { d: `m15 18-6-6 6-6` }]],
  _h = [[`path`, { d: `m9 18 6-6-6-6` }]],
  vh = [[`path`, { d: `m18 15-6-6-6 6` }]],
  yh = [
  ...
  x_ = [[`path`, { d: `M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z` }]],
  S_ = [
  ...
  Ty = [[`path`, { d: `M12 2C8 2 4 8 4 14a8 8 0 0 0 16 0c0-6-4-12-8-12` }]],
  Ey = [
    [`circle`, { cx: `12`, cy: `12`, r: `1` }],
  ...
  ex = [[`path`, { d: `M2 16s9-15 20-4C11 23 2 8 2 8` }]],
  tx = [
    [
      `path`,
      {
  ...
  iS = [[`path`, { d: `M5 16V9h14V2H5l14 14h-7m-7 0 7 7v-7m-7 0h7` }]],
  aS = [
    [`circle`, { cx: `12`, cy: `12`, r: `10` }],
    [`path`, { d: `M16 16s-1.5-2-4-2-4 2-4 2` }],
  ...
  WT = [[`path`, { d: `M21 12a9 9 0 1 1-6.219-8.56` }]],
  GT = [
  ...
  YD = [[`path`, { d: `m8 3 4 8 5-5 5 15H2L8 3z` }]],
  XD = [
    [`path`, { d: `M12 6v.343` }],
  ...
  xO = [[`polygon`, { points: `12 2 19 21 12 17 5 21 12 2` }]],
  SO = [
  ...
  wO = [[`polygon`, { points: `3 11 22 2 13 21 11 13 3 11` }]],
  TO = [
  ...
  fj = [[`rect`, { width: `20`, height: `12`, x: `2`, y: `6`, rx: `2` }]],
  pj = [[`rect`, { width: `12`, height: `20`, x: `6`, y: `2`, rx: `2` }]],
  mj = [
    [
      `path`,
      {
  ...
  ZN = [[`path`, { d: `M22 17v1c0 .5-.5 1-1 1H3c-.5 0-1-.5-1-1v-1` }]],
  QN = [
    [`path`, { d: `M12 18v4` }],
    [
      `path`,
  ...
  SF = [[`rect`, { width: `18`, height: `18`, x: `3`, y: `3`, rx: `2` }]],
  CF = [
    [
      `path`,
      {
  ...
  GI = [[`path`, { d: `M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z` }]],
  KI = [
    [`path`, { d: `M17 14V2` }],
    [
      `path`,
  ...
  KL = [[`path`, { d: `M21 2H3v16h5v4l4-4h5l4-4V2zm-10 9V7m5 4V7` }]],
  qL = [
    [
      `path`,
      {
  ...
  oR = [[`path`, { d: `M15 7h2a5 5 0 0 1 0 10h-2m-6 0H7A5 5 0 0 1 7 7h2` }]],
  sR = [
    [
      `path`,
      {
  ...
  Gz = s({
    ...
    AlertTriangle: () => NL,
    AlignCenter: () => jI,
    AlignCenterHorizontal: () => Cl,
    AlignCenterVertical: () => wl,
    AlignEndHorizontal: () => Tl,
    AlignEndVertical: () => El,
    AlignHorizontalDistributeCenter: () => Dl,
    AlignHorizontalDistributeEnd: () => Ol,
    AlignHorizontalDistributeStart: () => Al,
    AlignHorizontalJustifyCenter: () => kl,
    AlignHorizontalJustifyEnd: () => jl,
    AlignHorizontalJustifyStart: () => Nl,
    AlignHorizontalSpaceAround: () => Ml,
    AlignHorizontalSpaceBetween: () => Pl,
    AlignJustify: () => NI,
    AlignLeft: () => PI,
    AlignRight: () => MI,
    AlignStartHorizontal: () => Fl,
    AlignStartVertical: () => Il,
    AlignVerticalDistributeCenter: () => Ll,
    AlignVerticalDistributeEnd: () => Rl,
    AlignVerticalDistributeStart: () => zl,
    AlignVerticalJustifyCenter: () => Bl,
    AlignVerticalJustifyEnd: () => Vl,
    AlignVerticalJustifyStart: () => Hl,
    AlignVerticalSpaceAround: () => Ul,
    AlignVerticalSpaceBetween: () => Wl,
    Ambulance: () => Gl,
    Ampersand: () => Kl,
    Ampersands: () => ql,
    Amphora: () => Jl,
    ...
    ArrowDownAz: () => vu,
    ArrowDownCircle: () => Nh,
    ArrowDownFromLine: () => yu,
    ArrowDownLeft: () => bu,
    ArrowDownLeftFromCircle: () => Fh,
    ArrowDownLeftFromSquare: () => _P,
    ArrowDownLeftSquare: () => pP,
    ArrowDownNarrowWide: () => xu,
    ArrowDownRight: () => Su,
    ArrowDownRightFromCircle: () => Ih,
    ArrowDownRightFromSquare: () => vP,
    ArrowDownRightSquare: () => mP,
    ArrowDownSquare: () => hP,
    ArrowDownToDot: () => Cu,
    ArrowDownToLine: () => wu,
    ArrowDownUp: () => Tu,
    ...
    ArrowLeft: () => Mu,
    ArrowLeftCircle: () => Ph,
    ArrowLeftFromLine: () => ku,
    ArrowLeftRight: () => Au,
    ArrowLeftSquare: () => gP,
    ArrowLeftToLine: () => ju,
    ArrowRight: () => Iu,
    ArrowRightCircle: () => zh,
    ArrowRightFromLine: () => Nu,
    ArrowRightLeft: () => Pu,
    ArrowRightSquare: () => xP,
    ArrowRightToLine: () => Fu,
    ArrowUp: () => Yu,
    ...
    ArrowUpFromLine: () => Hu,
    ArrowUpLeft: () => Uu,
    ArrowUpLeftFromCircle: () => Lh,
    ArrowUpLeftFromSquare: () => yP,
    ArrowUpLeftSquare: () => SP,
    ArrowUpNarrowWide: () => Wu,
    ArrowUpRight: () => Gu,
    ArrowUpRightFromCircle: () => Rh,
    ArrowUpRightFromSquare: () => bP,
    ArrowUpRightSquare: () => CP,
    ArrowUpSquare: () => wP,
    ArrowUpToLine: () => Ku,
    ArrowUpWideNarrow: () => qu,
    ArrowUpZA: () => Ju,
    ArrowUpZa: () => Ju,
    ArrowsUpFromLine: () => Xu,
    Asterisk: () => Zu,
    ...
    BadgePercent: () => gd,
    BadgePlus: () => _d,
    BadgePoundSterling: () => vd,
    BadgeQuestionMark: () => yd,
    BadgeRussianRuble: () => bd,
    BadgeSwissFranc: () => xd,
    BadgeTurkishLira: () => Sd,
    BadgeX: () => Cd,
    BaggageClaim: () => Td,
    ...
    BarChart4: () => Vm,
    BarChartBig: () => Bm,
    BarChartHorizontal: () => Rm,
    BarChartHorizontalBig: () => Pm,
    Barcode: () => Nd,
    Barrel: () => Pd,
    Baseline: () => Fd,
    Bath: () => Id,
    ...
    BellPlus: () => rf,
    BellRing: () => af,
    BetweenHorizonalEnd: () => sf,
    BetweenHorizonalStart: () => cf,
    BetweenHorizontalEnd: () => sf,
    BetweenHorizontalStart: () => cf,
    BetweenVerticalEnd: () => lf,
    BetweenVerticalStart: () => uf,
    BicepsFlexed: () => df,
    Bike: () => ff,
    Binary: () => mf,
    Binoculars: () => pf,
    ...
    Blocks: () => xf,
    Bluetooth: () => Tf,
    BluetoothConnected: () => Sf,
    BluetoothOff: () => Cf,
    BluetoothSearching: () => wf,
    Bold: () => Ef,
    Bolt: () => Df,
    Bomb: () => Of,
    Bone: () => kf,
    ...
    BrickWallShield: () => xp,
    Briefcase: () => Ep,
    BriefcaseBusiness: () => Cp,
    BriefcaseConveyorBelt: () => wp,
    BriefcaseMedical: () => Tp,
    BringToFront: () => Dp,
    Brush: () => kp,
    BrushCleaning: () => Op,
    ...
    ChartBar: () => Rm,
    ChartBarBig: () => Pm,
    ChartBarDecreasing: () => Fm,
    ChartBarIncreasing: () => Im,
    ChartBarStacked: () => Lm,
    ChartCandlestick: () => zm,
    ChartColumn: () => Wm,
    ChartColumnBig: () => Bm,
    ChartColumnDecreasing: () => Hm,
    ChartColumnIncreasing: () => Vm,
    ChartColumnStacked: () => Um,
    ChartGantt: () => Gm,
    ChartLine: () => Km,
    ChartNetwork: () => qm,
    ChartNoAxesColumn: () => Xm,
    ChartNoAxesColumnDecreasing: () => Jm,
    ChartNoAxesColumnIncreasing: () => Ym,
    ChartNoAxesCombined: () => Zm,
    ChartNoAxesGantt: () => Qm,
    ChartPie: () => $m,
    ChartScatter: () => eh,
    ChartSpline: () => th,
    ...
    ChessRook: () => fh,
    ChevronDown: () => ph,
    ChevronDownCircle: () => Uh,
    ChevronDownSquare: () => AP,
    ChevronFirst: () => mh,
    ChevronLast: () => hh,
    ChevronLeft: () => gh,
    ChevronLeftCircle: () => Wh,
    ChevronLeftSquare: () => jP,
    ChevronRight: () => _h,
    ChevronRightCircle: () => Gh,
    ChevronRightSquare: () => MP,
    ChevronUp: () => vh,
    ChevronUpCircle: () => Kh,
    ChevronUpSquare: () => NP,
    ChevronsDown: () => bh,
    ChevronsDownUp: () => yh,
    ChevronsLeft: () => Ch,
    ChevronsLeftRight: () => Sh,
    ChevronsLeftRightEllipsis: () => xh,
    ChevronsRight: () => Th,
    ChevronsRightLeft: () => wh,
    ChevronsUp: () => Dh,
    ChevronsUpDown: () => Eh,
    Chrome: () => Oh,
    Chromium: () => Oh,
    ...
    CircleArrowDown: () => Nh,
    CircleArrowLeft: () => Ph,
    CircleArrowOutDownLeft: () => Fh,
    CircleArrowOutDownRight: () => Ih,
    CircleArrowOutUpLeft: () => Lh,
    CircleArrowOutUpRight: () => Rh,
    CircleArrowRight: () => zh,
    CircleArrowUp: () => Bh,
    CircleCheck: () => Hh,
    CircleCheckBig: () => Vh,
    CircleChevronDown: () => Uh,
    CircleChevronLeft: () => Wh,
    CircleChevronRight: () => Gh,
    CircleChevronUp: () => Kh,
    CircleDashed: () => qh,
    CircleDivide: () => Jh,
    CircleDollarSign: () => Yh,
    ...
    CirclePlay: () => lg,
    CirclePlus: () => ug,
    CirclePoundSterling: () => dg,
    CirclePower: () => fg,
    CircleQuestionMark: () => pg,
    CircleSlash: () => hg,
    CircleSlash2: () => mg,
    CircleSlashed: () => mg,
    CircleSmall: () => gg,
    ...
    DatabaseBackup: () => Tv,
    DatabaseZap: () => Ev,
    DecimalsArrowLeft: () => Ov,
    DecimalsArrowRight: () => kv,
    Delete: () => Av,
    Dessert: () => jv,
    Diameter: () => Mv,
    Diamond: () => Iv,
    ...
    FunnelPlus: () => cS,
    FunnelX: () => lS,
    GalleryHorizontal: () => fS,
    GalleryHorizontalEnd: () => dS,
    GalleryThumbnails: () => pS,
    GalleryVertical: () => hS,
    GalleryVerticalEnd: () => mS,
    Gamepad: () => vS,
    Gamepad2: () => gS,
    GamepadDirectional: () => _S,
    GanttChart: () => Qm,
    GanttChartSquare: () => OP,
    Gauge: () => yS,
    GaugeCircle: () => ng,
    ...
    GitBranchPlus: () => ES,
    GitCommit: () => OS,
    GitCommitHorizontal: () => OS,
    GitCommitVertical: () => kS,
    GitCompare: () => jS,
    GitCompareArrows: () => AS,
    GitFork: () => MS,
    GitGraph: () => NS,
    GitMerge: () => PS,
    GitPullRequest: () => VS,
    GitPullRequestArrow: () => FS,
    GitPullRequestClosed: () => IS,
    GitPullRequestCreate: () => RS,
    GitPullRequestCreateArrow: () => LS,
    GitPullRequestDraft: () => zS,
    Github: () => US,
    Gitlab: () => BS,
    GlassWater: () => HS,
    Glasses: () => WS,
    ...
    ListCheck: () => CT,
    ListChecks: () => wT,
    ListChevronsDownUp: () => TT,
    ListChevronsUpDown: () => ET,
    ListCollapse: () => DT,
    ListEnd: () => OT,
    ListFilter: () => AT,
    ListFilterPlus: () => kT,
    ListIndentDecrease: () => jT,
    ListIndentIncrease: () => MT,
    ListMinus: () => NT,
    ListMusic: () => PT,
    ListOrdered: () => FT,
    ListPlus: () => IT,
    ...
    MapPin: () => kE,
    MapPinCheck: () => yE,
    MapPinCheckInside: () => vE,
    MapPinHouse: () => bE,
    MapPinMinus: () => SE,
    MapPinMinusInside: () => xE,
    MapPinOff: () => CE,
    MapPinPen: () => wE,
    MapPinPlus: () => DE,
    MapPinPlusInside: () => TE,
    ...
    Merge: () => WE,
    MessageCircle: () => tD,
    MessageCircleCode: () => GE,
    MessageCircleDashed: () => KE,
    MessageCircleHeart: () => qE,
    MessageCircleMore: () => JE,
    MessageCircleOff: () => YE,
    MessageCirclePlus: () => XE,
    MessageCircleQuestion: () => ZE,
    MessageCircleQuestionMark: () => ZE,
    MessageCircleReply: () => QE,
    MessageCircleWarning: () => $E,
    MessageCircleX: () => eD,
    MessageSquare: () => _D,
    MessageSquareCode: () => nD,
    MessageSquareDashed: () => rD,
    MessageSquareDiff: () => iD,
    MessageSquareDot: () => aD,
    MessageSquareHeart: () => oD,
    MessageSquareLock: () => sD,
    MessageSquareMore: () => cD,
    MessageSquareOff: () => lD,
    MessageSquarePlus: () => uD,
    MessageSquareQuote: () => dD,
    MessageSquareReply: () => fD,
    MessageSquareShare: () => pD,
    MessageSquareText: () => mD,
    MessageSquareWarning: () => hD,
    MessageSquareX: () => gD,
    MessagesSquare: () => vD,
    Mic: () => xD,
    Mic2: () => bD,
    ...
    MousePointer2Off: () => ZD,
    MousePointerBan: () => $D,
    MousePointerClick: () => eO,
    MousePointerSquareDashed: () => LP,
    Move: () => gO,
    Move3D: () => aO,
    Move3d: () => aO,
    MoveDiagonal: () => rO,
    ...
    Paintbrush: () => rk,
    Paintbrush2: () => nk,
    PaintbrushVertical: () => nk,
    Palette: () => ik,
    Palmtree: () => EL,
    Panda: () => ak,
    PanelBottom: () => ck,
    PanelBottomClose: () => ok,
    PanelBottomDashed: () => sk,
    PanelBottomInactive: () => sk,
    PanelBottomOpen: () => lk,
    PanelLeft: () => mk,
    PanelLeftClose: () => uk,
    PanelLeftDashed: () => dk,
    PanelLeftInactive: () => dk,
    PanelLeftOpen: () => fk,
    PanelLeftRightDashed: () => pk,
    PanelRight: () => yk,
    PanelRightClose: () => hk,
    PanelRightDashed: () => _k,
    PanelRightInactive: () => _k,
    PanelRightOpen: () => gk,
    PanelTop: () => Ck,
    PanelTopBottomDashed: () => vk,
    PanelTopClose: () => bk,
    PanelTopDashed: () => xk,
    PanelTopInactive: () => xk,
    PanelTopOpen: () => Sk,
    ...
    ReceiptCent: () => $A,
    ReceiptEuro: () => ej,
    ReceiptIndianRupee: () => tj,
    ReceiptJapaneseYen: () => nj,
    ReceiptPoundSterling: () => rj,
    ReceiptRussianRuble: () => ij,
    ReceiptSwissFranc: () => aj,
    ReceiptText: () => oj,
    ReceiptTurkishLira: () => sj,
    RectangleCircle: () => lj,
    RectangleEllipsis: () => uj,
    RectangleGoggles: () => dj,
    RectangleHorizontal: () => fj,
    RectangleVertical: () => pj,
    Recycle: () => mj,
    Redo: () => _j,
    Redo2: () => hj,
    RedoDot: () => gj,
    ...
    SendHorizontal: () => FM,
    SendToBack: () => IM,
    SeparatorHorizontal: () => RM,
    SeparatorVertical: () => zM,
    Server: () => UM,
    ServerCog: () => BM,
    ServerCrash: () => VM,
    ServerOff: () => HM,
    ...
    Slice: () => LN,
    Sliders: () => zN,
    SlidersHorizontal: () => RN,
    SlidersVertical: () => zN,
    Smartphone: () => HN,
    SmartphoneCharging: () => BN,
    SmartphoneNfc: () => VN,
    Smile: () => WN,
    SmilePlus: () => UN,
    Snail: () => GN,
    Snowflake: () => KN,
    SoapDispenserDroplet: () => qN,
    Sofa: () => JN,
    SolarPanel: () => YN,
    SortAsc: () => Wu,
    SortDesc: () => Du,
    ...
    SplinePointer: () => aP,
    Split: () => cP,
    SplitSquareHorizontal: () => fF,
    SplitSquareVertical: () => pF,
    Spool: () => sP,
    Spotlight: () => lP,
    SprayCan: () => uP,
    Sprout: () => dP,
    ...
    SquareActivity: () => fP,
    SquareArrowDown: () => hP,
    SquareArrowDownLeft: () => pP,
    SquareArrowDownRight: () => mP,
    SquareArrowLeft: () => gP,
    SquareArrowOutDownLeft: () => _P,
    SquareArrowOutDownRight: () => vP,
    SquareArrowOutUpLeft: () => yP,
    SquareArrowOutUpRight: () => bP,
    SquareArrowRight: () => xP,
    SquareArrowUp: () => wP,
    SquareArrowUpLeft: () => SP,
    SquareArrowUpRight: () => CP,
    SquareAsterisk: () => TP,
    SquareBottomDashedScissors: () => EP,
    SquareChartGantt: () => OP,
    SquareCheck: () => kP,
    SquareCheckBig: () => DP,
    SquareChevronDown: () => AP,
    SquareChevronLeft: () => jP,
    SquareChevronRight: () => MP,
    SquareChevronUp: () => NP,
    SquareCode: () => PP,
    SquareDashed: () => BP,
    SquareDashedBottom: () => RP,
    SquareDashedBottomCode: () => FP,
    SquareDashedKanban: () => IP,
    SquareDashedMousePointer: () => LP,
    SquareDashedTopSolid: () => zP,
    SquareDivide: () => VP,
    SquareDot: () => HP,
    SquareEqual: () => WP,
    SquareFunction: () => UP,
    ...
    SquareSigma: () => uF,
    SquareSlash: () => dF,
    SquareSplitHorizontal: () => fF,
    SquareSplitVertical: () => pF,
    SquareSquare: () => mF,
    SquareStack: () => hF,
    SquareStar: () => gF,
    SquareStop: () => _F,
...
lucide.createIcons({icons});\``);
    ...
    if (
      (Array.from(r.querySelectorAll(`[${t}]`)).forEach((r) =>
        cl(r, { nameAttr: t, icons: e, attrs: n })
      ),
      i &&
      ...
      t.length > 0 &&
        ...
        Array.from(t).forEach((t) =>
          cl(t, { nameAttr: `icon-name`, icons: e, attrs: n })
        ));
    }
  };
(window.bootstrap = Nn),
...
document.addEventListener(`DOMContentLoaded`, Jz), Jz();
export { l as a, s as i, Gz as n, o as r, Kz as t };
