import { r as e } from "./admin.bundle-CBXoUBAg.js";
var t = e((e, t) => {
    (function (n, r) {
      ...
      var t = function (e) {
        ...
        n = function (e) {
          var t =
            ...
            l = function (e, t, n) {
              ...
              p[e] && p[e](t), i.push({ type: e, data: t });
            },
            u = function (e) {
              var t,
                n = [...arguments].slice(1);
              return f[e] ? (t = f)[e].apply(t, n) : null;
            },
            d = {
              getState: o,
              processActionQueue: s,
              processDispatchQueue: c,
              dispatch: l,
              query: u,
            },
            f = {};
          t.forEach(function (e) {
            f = Object.assign({}, e(r), {}, f);
          });
          var p = {};
          return (
            n.forEach(function (e) {
              p = Object.assign({}, e(l, u, r), {}, p);
            }),
            d
          );
        },
        ...
        u = function (e, t) {
          ...
          return (
            t && (l(e) ? o(r, `class`, t) : (r.className = t)),
            i(n, function (e, t) {
              o(r, e, t);
            }),
            r
        ...
        f = function (e, t) {
          return function (e, n) {
            return n === void 0 ? t.push(e) : t.splice(n, 0, e), e;
          };
        },
        p = function (e, t) {
          return function (n) {
        ...
        _ = function (e, t, n, r) {
          ...
          return (
            t
              ...
              .forEach(function (e) {
                v(c.inner, Object.assign({}, e.inner)),
                  v(c.outer, Object.assign({}, e.outer));
              }),
            y(c.inner),
            (c.outer.bottom += c.element.marginBottom),
            (c.outer.right += c.element.marginRight),
            y(c.outer),
            c
          );
        },
              ...
              target: {
                set: function (e) {
                  if (
                    ...
                    (d = !0), (u = 0), f.onupdate(l), f.oncomplete(l);
                    return;
                  }
                  d = !1;
                },
            ...
            var e =
              ...
              m = a({
                ...
                target: {
                  ...
                  set: function (e) {
                    if (p === null) {
                      (p = e), m.onupdate(e), m.oncomplete(e);
                      return;
                    }
                    e < p ? ((p = 1), (f = !0)) : ((f = !1), (p = e)),
                      (d = !1),
        ...
        T = function (e, t, n) {
          var r = e[t] && typeof e[t][n] == `object` ? e[t][n] : e[t] || e,
            i = typeof r == `string` ? r : r.type,
            a = typeof r == `object` ? Object.assign({}, r) : {};
          return w[i] ? w[i](a) : null;
        },
        E = function (e, t, n) {
          var r =
          ...
          (t = Array.isArray(t) ? t : [t]),
            t.forEach(function (t) {
              e.forEach(function (e) {
                ...
                typeof e == `object` &&
                  ((i = e.key), (a = e.getter || a), (o = e.setter || o)),
                  !(t[i] && !r) && (t[i] = { get: a, set: o });
              });
            });
        },
        D = function (e) {
        ...
        ee = function (e) {
          ...
          var c = function () {
            ...
            u = function () {
              return a.rect ? _(a.rect, a.childViews, c(), l()) : null;
            };
          return (
            (r.rect = { get: u }),
            (i.rect = { get: u }),
            t.forEach(function (e) {
              n[e] = o[e] === void 0 ? N[e] : o[e];
            }),
            {
              write: function () {
                if (P(s, n))
                  return (
                    te(a.element, n), Object.assign(s, Object.assign({}, n)), !0
                  );
              },
              destroy: function () {},
            }
        ...
        te = function (e, t) {
          var n = t.opacity,
            ...
            g = ``;
          (M(d) || M(f)) &&
            (g += `transform-origin: ` + (d || 0) + `px ` + (f || 0) + `px;`),
            M(r) && (h += `perspective(` + r + `px) `),
            (M(i) || M(a)) &&
              (h += `translate3d(` + (i || 0) + `px, ` + (a || 0) + `px, 0) `),
            (M(o) || M(s)) &&
              (h +=
                `scale3d(` + (M(o) ? o : 1) + `, ` + (M(s) ? s : 1) + `, 1) `),
            M(u) && (h += `rotateZ(` + u + `rad) `),
            M(c) && (h += `rotateX(` + c + `rad) `),
            M(l) && (h += `rotateY(` + l + `rad) `),
            h.length && (g += `transform:` + h + `;`),
            M(n) &&
              ((g += `opacity:` + n + `;`),
              n === 0 && (g += `visibility:hidden;`),
              n < 1 && (g += `pointer-events:none;`)),
            M(m) && (g += `height:` + m + `px;`),
            M(p) && (g += `width:` + p + `px;`);
          var _ = e.elementCurrentStyle || ``;
          (g.length !== _.length || g !== _) &&
            ((e.style.cssText = g), (e.elementCurrentStyle = g));
        },
        ne = { styles: ee, listeners: A, animations: D, apis: j },
        F = function () {
          var e =
              arguments.length > 0 && arguments[0] !== void 0
                ? arguments[0]
        ...
        I = function () {
          var e =
            ...
            v = e.create,
            y = v === void 0 ? function () {} : v,
            b = e.destroy,
            x = b === void 0 ? function () {} : b,
            S = e.filterFrameActionsForChild,
            C =
              S === void 0
                ? function (e, t) {
                    return t;
            ...
            var t =
              ...
              ie = function () {
                (m = null),
                  ...
                  (j && c.width && c.height) || F(c, r, o);
                var e = { root: z, props: t, rect: c };
              ...
              ae = function (e, n, r) {
                ...
                return (
                  ...
                  b
                    ...
                    .forEach(function (t) {
                      t._write(e, C(t, n), r) || (i = !1);
                    }),
                  b.forEach(function (t, a) {
                    t.element.parentNode ||
                      (z.appendChild(t.element, a),
                      t._read(),
                      t._write(e, C(t, n), r),
                      (i = !1));
                  }),
                  (v = i),
                  D({ props: t, root: z, actions: n, timestamp: e }),
                  i
                );
              },
              oe = function () {
              ...
              se = Object.assign({}, R, {
                ...
                appendChildView: f(r, b),
                removeChildView: p(r, b),
        ...
        de = function (e) {
          return b(e) ? e : B(e) ? ce(e).replace(/[a-z]+/gi, ``) : 0;
        },
        fe = function (e) {
          return parseInt(de(e), 10);
        },
        pe = function (e) {
          return parseFloat(de(e));
        },
        me = function (e) {
          return b(e) && isFinite(e) && Math.floor(e) === e;
        },
        he = function (e) {
          var t =
            arguments.length > 1 && arguments[1] !== void 0
          ...
          var n = ce(e).trim();
          return /MB$/i.test(n)
            ? ((n = n.replace(/MB$i/, ``).trim()), fe(n) * t * t)
            : /KB/i.test(n)
            ? ((n = n.replace(/KB$i/, ``).trim()), fe(n) * t)
            : fe(n);
        },
        ge = function (e) {
        ...
        ye = function (e) {
          ...
          return (
            ...
            i(ve, function (n) {
              t[n] = be(n, e[n], ve[n], t.timeout, t.headers);
            }),
            (t.process = e.process || B(e) || e.url ? t.process : null),
        ...
        be = function (e, t, n, r, i) {
          ...
          if (B(t)) return (a.url = t), a;
          if ((Object.assign(a, t), B(a.headers))) {
            var o = a.headers.split(/:(.+)/);
            a.headers = { header: o[0], value: o[1] };
          }
          return (a.withCredentials = ue(a.withCredentials)), a;
        },
        xe = function (e) {
          return ye(e);
        },
          ...
          return (
            i(t, function (t) {
              n[t] = {
                ...
                set: function (n) {
                  e.dispatch(`SET_` + je(t, `_`).toUpperCase(), { value: n });
                },
              };
            }),
            n
        ...
        Pe = function (e) {
          return function (t) {
            ...
            return (
              i(e, function (e) {
                n[`GET_` + je(e, `_`).toUpperCase()] = function (n) {
                  return t.options[e];
                };
              }),
              n
        ...
        U = { API: 1, DROP: 2, BROWSE: 3, PASTE: 4, NONE: 5 },
        Fe = function () {
      ...
      function Re(e) {
        ...
        function r(e, r) {
          return new Promise(function (a, o) {
            var s = { key: e, arg: r, resolve: a, reject: o, next: null };
        ...
        function a(e, r) {
          ...
          (t = t.next), t ? i(t.key, t.arg) : (n = null);
        }
        (this._invoke = r),
      ...
      typeof Symbol == `function` &&
        ...
        (Re.prototype[Symbol.asyncIterator] = function () {
          return this;
        }),
      ...
      function qe(e) {
        ...
        return (
          (qe = function (e) {
            ...
            function n() {
              return Ge(e, arguments, He(this).constructor);
            }
            return (
              ...
              : function (e, t, n, r) {
                  ...
                  if (i) {
                    if (((a = Object.getOwnPropertyDescriptor(i, t)), a.set))
                      return a.set.call(r, n), !0;
                    if (!a.writable) return !1;
                  }
                  if (((a = Object.getOwnPropertyDescriptor(r, t)), a)) {
                    if (!a.writable) return !1;
                    (a.value = n), Object.defineProperty(r, t, a);
                  } else ze(r, t, n);
                  return !0;
                }),
          Qe(e, t, n, r)
        ...
        var e = {
          ...
          addElementPlacement: function (e, t, n) {
            ...
            if (!n && r.indexOf(e.key) !== -1)
              throw TypeError(`Duplicated element (` + e.key + `)`);
            r.push(e.key);
          },
          ...
          decorateConstructor: function (e, t) {
            for (var n = [], r = t.length - 1; r >= 0; r--) {
              ...
              if (
                (a.finisher !== void 0 && n.push(a.finisher),
                a.elements !== void 0)
              ) {
                e = a.elements;
                for (var o = 0; o < e.length - 1; o++)
                  for (var s = o + 1; s < e.length; s++)
                    if (
                      ...
                      throw TypeError(`Duplicated element (` + e[o].key + `)`);
              }
            }
          ...
          fromElementDescriptor: function (e) {
            ...
            return (
              ...
              e.kind === `field` && (t.initializer = e.initializer),
              t
            );
          },
            ...
            for (var n = 0; n < t.length; n++) {
              ...
              if (r !== void 0) {
                if (typeof r != `function`)
                  throw TypeError(`Finishers must return a constructor.`);
                e = r;
              }
            }
            return e;
          ...
          disallowProperty: function (e, t, n) {
            if (e[t] !== void 0)
              throw TypeError(n + ` can't have a .` + t + ` property.`);
          },
        };
        return e;
      }
      ...
      function ut(e, t) {
        ...
        if (n !== void 0 && typeof n != `function`)
          throw TypeError(`Expected '` + t + `' to be a function`);
        return n;
      }
      function dt(e, t) {
        dt = function (e, t) {
            ...
            if (typeof t == `string`) {
              ...
              return r[Symbol.replace].call(this, e, function () {
                ...
                return (
                  ...
                  typeof e[e.length - 1] != `object` && e.push(o(e, a)),
                  t.apply(this, e)
                );
              });
            } else return r[Symbol.replace].call(this, e, t);
          });
        function o(e, t) {
          var n = i.get(t);
      ...
      var ft = function (e, t) {
          ...
          var e = [],
            ...
            n = function (t, n, r) {
              e.filter(function (e) {
                ...
                .forEach(function (e) {
                  return pt(function () {
                    return e.apply(void 0, et(n));
                  }, r);
                });
            };
          return {
            fireSync: function (e) {
              n(e, [...arguments].slice(1), !0);
            },
            fire: function (e) {
              n(e, [...arguments].slice(1), !1);
            },
            on: function (t, n) {
              e.push({ event: t, cb: n });
            },
        ...
        K = { INPUT: 1, LIMBO: 2, LOCAL: 3 },
        vt = function (e) {
          return /[^0-9]+/.exec(e);
        },
        yt = function () {
          return vt((1.1).toLocaleString())[0];
        },
        bt = function () {
          var e = yt(),
            t = (1e3).toLocaleString();
          return t === `1000` ? (e === `.` ? `,` : `.`) : vt(t)[0];
        },
        q = {
          BOOLEAN: `boolean`,
          INT: `int`,
        ...
        Dt = function (e) {
          i(e, function (e, t) {
            Ot[e] && (Ot[e][0] = H(t, Ot[e][0], Ot[e][1]));
          });
        },
        Ot = {
          id: [null, q.STRING],
          name: [`filepond`, q.STRING],
          disabled: [!1, q.BOOLEAN],
          className: [null, q.STRING],
          required: [!1, q.BOOLEAN],
          captureMethod: [null, q.STRING],
          allowSyncAcceptAttribute: [!0, q.BOOLEAN],
          allowDrop: [!0, q.BOOLEAN],
          allowBrowse: [!0, q.BOOLEAN],
          allowPaste: [!0, q.BOOLEAN],
          allowMultiple: [!1, q.BOOLEAN],
          allowReplace: [!0, q.BOOLEAN],
          allowRevert: [!0, q.BOOLEAN],
          allowRemove: [!0, q.BOOLEAN],
          allowProcess: [!0, q.BOOLEAN],
          allowReorder: [!1, q.BOOLEAN],
          allowDirectoriesOnly: [!1, q.BOOLEAN],
          storeAsFile: [!1, q.BOOLEAN],
          forceRevert: [!1, q.BOOLEAN],
          maxFiles: [null, q.INT],
          checkValidity: [!1, q.BOOLEAN],
          itemInsertLocationFreedom: [!0, q.BOOLEAN],
          itemInsertLocation: [`before`, q.STRING],
          itemInsertInterval: [75, q.INT],
          dropOnPage: [!1, q.BOOLEAN],
          dropOnElement: [!0, q.BOOLEAN],
          dropValidation: [!1, q.BOOLEAN],
          ignoredFiles: [[`.ds_store`, `thumbs.db`, `desktop.ini`], q.ARRAY],
          instantUpload: [!0, q.BOOLEAN],
          maxParallelUploads: [2, q.INT],
          allowMinimumUploadDuration: [!0, q.BOOLEAN],
          chunkUploads: [!1, q.BOOLEAN],
          chunkForce: [!1, q.BOOLEAN],
          chunkSize: [5e6, q.INT],
          chunkRetryDelays: [[500, 1e3, 3e3], q.ARRAY],
          server: [null, q.SERVER_API],
          fileSizeBase: [1e3, q.INT],
          labelFileSizeBytes: [`bytes`, q.STRING],
          labelFileSizeKilobytes: [`KB`, q.STRING],
          labelFileSizeMegabytes: [`MB`, q.STRING],
          labelFileSizeGigabytes: [`GB`, q.STRING],
          labelDecimalSeparator: [yt(), q.STRING],
          labelThousandsSeparator: [bt(), q.STRING],
          labelIdle: [
            `Drag & Drop your files or <span class="filepond--label-action">Browse</span>`,
            q.STRING,
          ],
          labelInvalidField: [`Field contains invalid files`, q.STRING],
          labelFileWaitingForSize: [`Waiting for size`, q.STRING],
          labelFileSizeNotAvailable: [`Size not available`, q.STRING],
          labelFileCountSingular: [`file in list`, q.STRING],
          labelFileCountPlural: [`files in list`, q.STRING],
          labelFileLoading: [`Loading`, q.STRING],
          labelFileAdded: [`Added`, q.STRING],
          labelFileLoadError: [`Error during load`, q.STRING],
          labelFileRemoved: [`Removed`, q.STRING],
          labelFileRemoveError: [`Error during remove`, q.STRING],
          labelFileProcessing: [`Uploading`, q.STRING],
          labelFileProcessingComplete: [`Upload complete`, q.STRING],
          labelFileProcessingAborted: [`Upload cancelled`, q.STRING],
          labelFileProcessingError: [`Error during upload`, q.STRING],
          labelFileProcessingRevertError: [`Error during revert`, q.STRING],
          labelTapToCancel: [`tap to cancel`, q.STRING],
          labelTapToRetry: [`tap to retry`, q.STRING],
          labelTapToUndo: [`tap to undo`, q.STRING],
          labelButtonRemoveItem: [`Remove`, q.STRING],
          labelButtonAbortItemLoad: [`Abort`, q.STRING],
          labelButtonRetryItemLoad: [`Retry`, q.STRING],
          labelButtonAbortItemProcessing: [`Cancel`, q.STRING],
          labelButtonUndoItemProcessing: [`Undo`, q.STRING],
          labelButtonRetryItemProcessing: [`Retry`, q.STRING],
          labelButtonProcessItem: [`Upload`, q.STRING],
          iconRemove: [
          ...
          oninit: [null, q.FUNCTION],
          onwarning: [null, q.FUNCTION],
          onerror: [null, q.FUNCTION],
          onactivatefile: [null, q.FUNCTION],
          oninitfile: [null, q.FUNCTION],
          onaddfilestart: [null, q.FUNCTION],
          onaddfileprogress: [null, q.FUNCTION],
          onaddfile: [null, q.FUNCTION],
          onprocessfilestart: [null, q.FUNCTION],
          onprocessfileprogress: [null, q.FUNCTION],
          onprocessfileabort: [null, q.FUNCTION],
          onprocessfilerevert: [null, q.FUNCTION],
          onprocessfile: [null, q.FUNCTION],
          onprocessfiles: [null, q.FUNCTION],
          onremovefile: [null, q.FUNCTION],
          onpreparefile: [null, q.FUNCTION],
          onupdatefiles: [null, q.FUNCTION],
          onreorderfiles: [null, q.FUNCTION],
          beforeDropFile: [null, q.FUNCTION],
          beforeAddFile: [null, q.FUNCTION],
          beforeRemoveFile: [null, q.FUNCTION],
          beforePrepareFile: [null, q.FUNCTION],
          stylePanelLayout: [null, q.STRING],
          stylePanelAspectRatio: [null, q.STRING],
          styleItemPanelAspectRatio: [null, q.STRING],
          styleButtonRemoveItemPosition: [`left`, q.STRING],
          styleButtonProcessItemPosition: [`right`, q.STRING],
          styleLoadIndicatorPosition: [`right`, q.STRING],
          styleProgressIndicatorPosition: [`right`, q.STRING],
          styleButtonRemoveItemAlign: [!1, q.BOOLEAN],
          files: [[], q.ARRAY],
          credits: [[`https://pqina.nl/`, `Powered by PQINA`], q.ARRAY],
        },
        kt = function (e, t) {
          return R(t)
            ? e[0] || null
        ...
        Mt = { EMPTY: 0, IDLE: 1, ERROR: 2, BUSY: 3, READY: 4 },
        Nt = null,
        Pt = function () {
          if (Nt === null)
            try {
        ...
        Ft = [G.LOAD_ERROR, G.PROCESSING_ERROR, G.PROCESSING_REVERT_ERROR],
        It = [G.LOADING, G.PROCESSING, G.PROCESSING_QUEUED, G.INIT],
        Lt = [G.PROCESSING_COMPLETE],
        Rt = function (e) {
          return Ft.includes(e.status);
        },
        zt = function (e) {
        ...
        Vt = function (e) {
          return (
            V(e.options.server) &&
            (V(e.options.server.process) || ge(e.options.server.process))
          );
        },
        Ht = function (e) {
          return {
        ...
        nn = function (e, t) {
          for (
            var n = new ArrayBuffer(e.length), r = new Uint8Array(n), i = 0;
            i < e.length;
            i++
          )
            r[i] = e.charCodeAt(i);
...
`),
                ...
                (t.request = e(
                  ...
                  function (e) {
                    (t.duration = Date.now() - t.timestamp),
                      (t.complete = !0),
                      e instanceof Blob && (e = $t(e, e.name || Jt(n))),
                  ...
                  function (e, n, r) {
                    ...
                    (t.progress = n / r), o.fire(`progress`, t.progress);
                  },
                  function () {
                    o.fire(`abort`);
                  },
                  function (e) {
                    var n = fn(typeof e == `string` ? e : e.headers);
                    o.fire(`meta`, {
                      size: t.size || n.size,
                      filename: n.name,
                      source: n.source,
        ...
        hn = function (e, t, n) {
          ...
          return (
            ...
            (o.ontimeout = function () {
              return r.ontimeout(o);
            }),
            o.open(n.method, t, !0),
            me(n.timeout) && (o.timeout = n.timeout),
        ...
        yn = function () {
          ...
          return function (i, a, o, s, c, l) {
            ...
            return (
              (u.onload = function (e) {
                ...
                a(
                  J(
                    `load`,
                    e.status,
                    t.method === `HEAD` ? null : $t(n(e.response), o),
                    r
                  )
                );
              }),
              ...
              (u.onheaders = function (e) {
                l(J(`headers`, e.status, null, e.getAllResponseHeaders()));
              }),
              (u.ontimeout = gn(o)),
              (u.onprogress = s),
              (u.onabort = c),
        ...
        Y = { QUEUED: 0, COMPLETE: 1, PROCESSING: 2, ERROR: 3, WAITING: 4 },
        bn = function (e, t, n, r, i, a, o, s, c, l, u) {
          for (
            var d = [],
              f = u.chunkTransferId,
              p = u.chunkServer,
              m = u.chunkSize,
              h = u.chunkRetryDelays,
              ...
              b = function (a) {
                var s = new FormData();
                V(i) && s.append(n, JSON.stringify(i));
                var c =
                  ...
                  l = Object.assign({}, t, { headers: c }),
                  u = hn(_(s), vn(e, t.url), l);
                (u.onload = function (e) {
                  return a(v(e, l.method));
                }),
                  (u.onerror = function (e) {
                    return o(
                      J(
              ...
              S = Math.floor(r.size / m),
              C = 0;
            C <= S;
            C++
          ) {
            var w = C * m,
              T = r.slice(w, w + m, `application/offset+octet-stream`);
            d[C] = {
              index: C,
              size: T.size,
              offset: w,
          ...
          var E = function () {
            ...
            D = function (e) {
              return e.status === Y.QUEUED || e.status === Y.ERROR;
            },
            O = function (t) {
              if (!g.aborted) {
                if (((t ||= d.find(D)), !t)) {
                  d.every(function (e) {
                    return e.status === Y.COMPLETE;
                  }) && E();
                  return;
                }
                (t.status = Y.PROCESSING), (t.progress = null);
                var n =
                    p.ondata ||
                    function (e) {
                      return e;
                ...
                (u.onload = function (e) {
                  a(e, t.index, d.length),
                    (t.status = Y.COMPLETE),
                    (t.request = null),
                    j();
                }),
                  (u.onprogress = function (e, n, r) {
                    (t.progress = e ? n : null), A();
                  }),
                  (u.onerror = function (e) {
                    (t.status = Y.ERROR),
                      (t.request = null),
                  ...
                  (u.ontimeout = function (e) {
                    (t.status = Y.ERROR), (t.request = null), k(t) || gn(o)(e);
                  }),
                  (u.onabort = function () {
                    (t.status = Y.QUEUED), (t.request = null), c();
                  });
              }
            },
            k = function (e) {
              return e.retries.length === 0
                ? !1
                : ((e.status = Y.WAITING),
            ...
            A = function () {
              var e = d.reduce(function (e, t) {
                return e === null || t.progress === null
                  ? null
                  : e + t.progress;
              }, 0);
              if (e === null) return s(!1, 0, 0);
              s(
                !0,
                e,
              ...
              ? x(function (e) {
                  g.aborted ||
                    (d
                      ...
                      .forEach(function (e) {
                        (e.status = Y.COMPLETE), (e.progress = e.size);
                      }),
                    j());
                })
              : b(function (e) {
                  g.aborted || (l(e), (g.serverId = e), j());
                }),
            {
              abort: function () {
                (g.aborted = !0), M();
        ...
        xn = function (e, t, n, r) {
          return function (i, a, o, s, c, l, u) {
            if (i) {
              var d = r.chunkUploads,
                f = d && i.size > r.chunkSize,
                p = d && (f || r.chunkForce);
              if (i instanceof Blob && p)
                return bn(e, t, n, i, a, o, s, c, l, u, r);
              var m =
                  t.ondata ||
                  function (e) {
                    return e;
                ...
                _ =
                  typeof t.headers == `function`
                    ? t.headers(i, a) || {}
                    : Object.assign({}, t.headers),
                v = Object.assign({}, t, { headers: _ }),
                y = new FormData();
              V(a) && y.append(n, JSON.stringify(a)),
        ...
        Sn = function () {
          ...
          return typeof t == `function`
            ? function () {
                var e = [...arguments];
                return t.apply(void 0, [n].concat(e, [r]));
              }
            : !t || !B(t.url)
            ? null
            : xn(e, t, n, r);
        ...
        Cn = function () {
          ...
          return function (i, a, o) {
            var s = hn(i, e + t.url, t);
            return (
              (s.onload = function (e) {
                a(
                  J(`load`, e.status, n(e.response), e.getAllResponseHeaders())
                );
              }),
          ...
          return (
            t > 0 &&
              (function o() {
                ...
                s + c > t && (c = s + c - t);
                var l = s / t;
                if (l >= 1 || document.hidden) {
                  e(1);
                  return;
                }
                e(l), (i = setTimeout(o, c));
              })(),
            {
              clear: function () {
                clearTimeout(i);
            ...
            i = function (t, i) {
              ...
              l.fire(`start`),
                ...
                (n.request = e(
                  ...
                  function () {
                    n.perceivedPerformanceUpdater.clear(),
                      l.fire(`abort`, n.response ? n.response.body : null);
                  },
                  function (e) {
                    l.fire(`transfer`, e);
                  }
          ...
          var e =
            ...
            l = function (e) {
              if (!(i.released || i.frozen)) {
                ...
                S.fire.apply(S, [e].concat(t));
              }
            },
            u = function () {
              return Yt(i.file.name);
            },
            d = function () {
              return i.file.type;
            },
            ...
            m = function (t, n, r) {
              if (((i.source = t), S.fireSync(`init`), i.file)) {
                ...
                n.on(`meta`, function (t) {
                  (i.file.size = t.size),
                    ...
                    t.source &&
                      ...
                      (i.status = G.PROCESSING_COMPLETE)),
                    l(`load-meta`);
                }),
                n.on(`progress`, function (e) {
                  c(G.LOADING), l(`load-progress`, e);
                }),
                n.on(`error`, function (e) {
                  c(G.LOAD_ERROR), l(`load-request-error`, e);
                }),
                n.on(`abort`, function () {
                  c(G.INIT), l(`load-abort`);
                }),
                n.on(`load`, function (t) {
                  i.activeLoader = null;
                  var n = function (t) {
                      (i.file = kn(t) ? t : i.file),
                        e === K.LIMBO && i.serverFileReference
                          ? c(G.PROCESSING_COMPLETE)
                          : c(G.IDLE),
                        l(`load`);
                    },
                    a = function (e) {
            ...
            _ = function e(t, n) {
              ...
              if ((c(G.PROCESSING), (o = null), !(i.file instanceof Blob))) {
                S.on(`load`, function () {
                  e(t, n);
                });
                return;
              ...
              var r = function (e) {
                ...
                a = console.error;
              n(i.file, r, a), (i.activeProcessor = t);
            },
            v = function () {
              (i.processingAborted = !1), c(G.PROCESSING_QUEUED);
            },
            y = function () {
            ...
            x = function (e, t, n) {
              ...
              r.forEach(function (e) {
                ...
                JSON.stringify(o[a]) !== JSON.stringify(t) &&
                  ((o[a] = t),
                  l(`metadata-update`, { key: i, value: s[i], silent: n }));
            },
            S = Object.assign(
              {
                id: {
        ...
        Pn = function (e, t, n, r, i, a) {
          var o = hn(null, e, { method: `GET`, responseType: `blob` });
          return (
            (o.onload = function (n) {
              var r = n.getAllResponseHeaders(),
                i = fn(r).name || Jt(e);
              t(J(`load`, n.status, $t(n.response, i), r));
            }),
            (o.onerror = function (e) {
              n(J(`error`, e.status, e.statusText, e.getAllResponseHeaders()));
            }),
            (o.onheaders = function (e) {
              a(J(`headers`, e.status, null, e.getAllResponseHeaders()));
            }),
            (o.ontimeout = gn(n)),
            (o.onprogress = r),
            (o.onabort = i),
        ...
        In = function (e) {
          return (
            ...
            Fn(location.href) !== Fn(e)
          );
        },
        Ln = function (e) {
          return function () {
            return ge(e) ? e.apply(void 0, arguments) : e;
          };
        },
        Rn = function (e) {
          return !kn(e.file);
        ...
        zn = function (e, t) {
          clearTimeout(t.listUpdateTimeout),
            (t.listUpdateTimeout = setTimeout(function () {
              e(`DID_UPDATE_ITEMS`, { items: jt(t.items) });
            }, 0));
        },
        Bn = function (e) {
          var t = [...arguments].slice(1);
        ...
        X = function (e, t) {
          return function () {
            var n =
              ...
              c = Ye(n, [`query`, `success`, `failure`]),
              l = kt(e.items, r);
            if (!l) {
              s({ error: J(`error`, 0, `Item not found`), file: null });
              return;
            }
            t(l, a, s, c || {});
          };
          ...
          return {
              ...
              o.silent ||
                ...
                (n.itemUpdateTimeout = setTimeout(function () {
                  ...
                  var s = function () {
                    ...
                    c = function (e) {
                      r.revert(
                        Cn(n.options.server.url, n.options.server.revert),
                        t(`GET_FORCE_REVERT`)
                      )
                        .then(e ? s : function () {})
                        .catch(function () {});
                  ...
                  if (r.status === G.PROCESSING_COMPLETE)
                    return c(n.options.instantUpload);
                  if (r.status === G.PROCESSING)
                    return l(n.options.instantUpload);
                  n.options.instantUpload && s();
                }, 0)));
            },
            MOVE_ITEM: function (e) {
              var t = e.query,
                ...
                i = kt(n.items, t);
              if (i) {
                var a = n.items.indexOf(i);
                (r = Wt(r, 0, n.items.length - 1)),
                  a !== r && n.items.splice(r, 0, n.items.splice(a, 1)[0]);
              }
            },
            SORT: function (r) {
              var i = r.compare;
              Vn(n, i), e(`DID_SORT_ITEMS`, { items: t(`GET_ACTIVE_ITEMS`) });
            },
            ADD_ITEMS: function (n) {
              var r = n.items,
                i = n.index,
                a = n.interactionMethod,
                o = n.success,
                s = o === void 0 ? function () {} : o,
                c = n.failure,
                l = c === void 0 ? function () {} : c,
                u = i;
              if (i === -1 || i === void 0) {
                var d = t(`GET_ITEM_INSERT_LOCATION`),
                  f = t(`GET_TOTAL_ITEMS`);
                u = d === `before` ? 0 : f;
              }
              var p = t(`GET_IGNORED_FILES`),
                m = r
                  .filter(function (e) {
                    return kn(e) ? !p.includes(e.name.toLowerCase()) : !R(e);
                  })
                  .map(function (t) {
                    return new Promise(function (n, r) {
                      e(`ADD_ITEM`, {
            ...
            ADD_ITEM: function (r) {
              var i = r.source,
                ...
                p = f === void 0 ? {} : f;
              if (R(i)) {
                d({ error: J(`error`, 0, `No source`), file: null });
                return;
              }
              if (
                !(
                  kn(i) && n.options.ignoredFiles.includes(i.name.toLowerCase())
                )
              ) {
                if (!Ut(n)) {
                  if (
                    ...
                    var m = J(`warning`, 0, `Max files`);
                    e(`DID_THROW_MAX_FILES`, { source: i, error: m }),
                      d({ error: m, file: null });
                    return;
                  }
                  var h = jt(n.items)[0];
                ...
                var _ =
                    p.type === `local`
                      ...
                      ? K.LIMBO
                      : K.INPUT,
                  v = jn(_, _ === K.INPUT ? null : i, p.file);
                Object.keys(p.metadata || {}).forEach(function (e) {
                  v.setMetadata(e, p.metadata[e]);
                }),
                  Ct(`DID_CREATE_ITEM`, v, { query: t, dispatch: e });
                var y = t(`GET_ITEM_INSERT_LOCATION`);
                n.options.itemInsertLocationFreedom ||
                  (o = y === `before` ? -1 : n.items.length),
                  Kt(n.items, v, o),
                  ge(y) && i && Vn(n, y);
                var b = v.id;
                v.on(`init`, function () {
                  e(`DID_INIT_ITEM`, { id: b });
                }),
                  v.on(`load-init`, function () {
                    e(`DID_START_ITEM_LOAD`, { id: b });
                  }),
                  v.on(`load-meta`, function () {
                    e(`DID_UPDATE_ITEM_META`, { id: b });
                  }),
                  v.on(`load-progress`, function (t) {
                    e(`DID_UPDATE_ITEM_LOAD_PROGRESS`, { id: b, progress: t });
                  }),
                  v.on(`load-request-error`, function (t) {
                    var r = Ln(n.options.labelFileLoadError)(t);
                  ...
                  v.on(`load-file-error`, function (t) {
                    e(`DID_THROW_ITEM_INVALID`, {
                      ...
                      d({ error: t.status, file: W(v) });
                  }),
                  v.on(`load-abort`, function () {
                    e(`REMOVE_ITEM`, { query: b });
                  }),
                  v.on(`load-skip`, function () {
                    v.on(`metadata-update`, function (t) {
                      kn(v.file) &&
                        e(`DID_UPDATE_ITEM_METADATA`, { id: b, change: t });
                    }),
                  ...
                  v.on(`load`, function () {
                          ...
                          if (r) {
                            e(
                              `REQUEST_PREPARE_OUTPUT`,
                              {
                                ...
                                item: v,
                                success: function (t) {
                                  e(`DID_PREPARE_OUTPUT`, { id: b, file: t }),
                                    o();
                                },
                              },
                              !0
                    ...
                    St(`DID_LOAD_ITEM`, v, { query: t, dispatch: e })
                      .then(function () {
                        Bn(t(`GET_BEFORE_ADD_FILE`), W(v)).then(r);
                      })
                      .catch(function (t) {
                  ...
                  v.on(`process-start`, function () {
                    e(`DID_START_ITEM_PROCESSING`, { id: b });
                  }),
                  ...
                  v.on(`process-error`, function (t) {
                    e(`DID_THROW_ITEM_PROCESSING_ERROR`, {
                      ...
                      error: t,
                      status: {
                        main: Ln(n.options.labelFileProcessingError)(t),
                  ...
                  v.on(`process-revert-error`, function (t) {
                    e(`DID_THROW_ITEM_PROCESSING_REVERT_ERROR`, {
                      ...
                      error: t,
                      status: {
                        main: Ln(n.options.labelFileProcessingRevertError)(t),
                        sub: n.options.labelTapToRetry,
                      },
                    });
                  }),
                  v.on(`process-complete`, function (t) {
                    e(`DID_COMPLETE_ITEM_PROCESSING`, {
                      ...
                      e(`DID_DEFINE_VALUE`, { id: b, value: t });
                  }),
                  v.on(`process-abort`, function () {
                    e(`DID_ABORT_ITEM_PROCESSING`, { id: b });
                  }),
                  v.on(`process-revert`, function () {
                    e(`DID_REVERT_ITEM_PROCESSING`, { id: b }),
                      e(`DID_DEFINE_VALUE`, { id: b, value: null });
                  }),
                  e(`DID_ADD_ITEM`, { id: b, index: o, interactionMethod: s }),
                  zn(e, n);
                var x = n.options.server || {},
                  S = x.url,
                  C = x.load,
                  w = x.restore,
                  T = x.fetch;
                v.load(
                  ...
                  function (e, n, r) {
                    St(`LOAD_FILE`, e, { query: t }).then(n).catch(r);
                  }
                );
              }
            },
            REQUEST_PREPARE_OUTPUT: function (e) {
              ...
              if (n.archived) return a(o);
              St(`PREPARE_OUTPUT`, n.file, { query: t, item: n }).then(
                function (e) {
                  St(`COMPLETE_PREPARE_OUTPUT`, e, { query: t, item: n }).then(
                    function (e) {
                      if (n.archived) return a(o);
                      r(e);
                    }
            ...
            COMPLETE_LOAD_ITEM: function (r) {
              var i = r.item,
                ...
                o = a.success,
                s = a.source,
                c = t(`GET_ITEM_INSERT_LOCATION`);
              if (
                (ge(c) && s && Vn(n, c),
                e(`DID_LOAD_ITEM`, {
                  id: i.id,
                  error: null,
                  serverFileReference: i.origin === K.INPUT ? null : s,
                }),
                o(W(i)),
                i.origin === K.LOCAL)
              ) {
            ...
            RETRY_ITEM_LOAD: X(n, function (e) {
              e.retryLoad();
            }),
            REQUEST_ITEM_PREPARE: X(n, function (t, n, r) {
              e(
                `REQUEST_PREPARE_OUTPUT`,
                {
                  query: t.id,
            ...
            REQUEST_ITEM_PROCESSING: X(n, function (r, i, a) {
              if (!(r.status === G.IDLE || r.status === G.PROCESSING_ERROR)) {
                var o = function () {
                  ...
                  s = function () {
                    return document.hidden ? o() : setTimeout(o, 32);
                  };
                r.status === G.PROCESSING_COMPLETE ||
                r.status === G.PROCESSING_REVERT_ERROR
                  ? r
                      .revert(
                        Cn(n.options.server.url, n.options.server.revert),
                        t(`GET_FORCE_REVERT`)
                      ...
                      .then(s)
                      .catch(function () {})
                  : r.status === G.PROCESSING && r.abortProcessing().then(s);
                return;
              }
              r.status !== G.PROCESSING_QUEUED &&
                (r.requestProcessing(),
                e(`DID_REQUEST_ITEM_PROCESSING`, { id: r.id }),
                e(`PROCESS_ITEM`, { query: r, success: i, failure: a }, !0));
            }),
            PROCESS_ITEM: X(n, function (r, i, a) {
              var o = t(`GET_MAX_PARALLEL_UPLOADS`);
              if (t(`GET_ITEMS_BY_STATUS`, G.PROCESSING).length === o) {
                n.processingQueue.push({ id: r.id, success: i, failure: a });
                return;
              }
              if (r.status !== G.PROCESSING) {
                var s = function t() {
                  ...
                  if (r) {
                    ...
                    e(`PROCESS_ITEM`, { query: i, success: a, failure: o }, !0);
                  }
                };
                r.onOnce(`process-complete`, function () {
                  i(W(r)), s();
                  var a = n.options.server;
                  if (
                    n.options.instantUpload &&
                    r.origin === K.LOCAL &&
                    ge(a.remove)
                    ...
                    var o = function () {};
                    (r.origin = K.LIMBO),
                      n.options.server.remove(r.source, o, o);
                  }
                  ...
                  r.onOnce(`process-error`, function (e) {
                    a({ error: e, file: W(r) }), s();
                  });
                var c = n.options;
                r.process(
                  En(
                    Sn(c.server.url, c.server.process, c.name, {
                  ...
                  function (n, i, a) {
                    St(`PREPARE_OUTPUT`, n, { query: t, item: r })
                      .then(function (t) {
            ...
            RETRY_ITEM_PROCESSING: X(n, function (t) {
              e(`REQUEST_ITEM_PROCESSING`, { query: t });
            }),
            REQUEST_REMOVE_ITEM: X(n, function (n) {
              Bn(t(`GET_BEFORE_REMOVE_FILE`), W(n)).then(function (t) {
                t && e(`REMOVE_ITEM`, { query: n });
              });
            }),
            RELEASE_ITEM: X(n, function (e) {
              e.release();
            }),
            REMOVE_ITEM: X(n, function (r, i, a, o) {
              var s = function () {
                  var t = r.id;
                  Nn(n.items, t).archive(),
                    e(`DID_REMOVE_ITEM`, { error: null, id: t, item: r }),
                    zn(e, n),
                    i(W(r));
                },
                c = n.options.server;
              r.origin === K.LOCAL && c && ge(c.remove) && o.remove !== !1
                  ...
                  c.remove(
                    ...
                    function (t) {
                      e(`DID_THROW_ITEM_REMOVE_ERROR`, {
                        id: r.id,
                        error: J(`error`, 0, t, null),
                        status: {
                          main: Ln(n.options.labelFileRemoveError)(t),
                          sub: n.options.labelTapToRetry,
                        },
                      });
                    }
                  ))
                : (((o.revert && r.origin !== K.LOCAL && r.serverId !== null) ||
            ...
            ABORT_ITEM_LOAD: X(n, function (e) {
              e.abortLoad();
            }),
            ABORT_ITEM_PROCESSING: X(n, function (t) {
              if (t.serverId) {
            ...
            REQUEST_REVERT_ITEM_PROCESSING: X(n, function (r) {
              ...
              if (!a) return i(!0);
              var o = a(W(r));
              if (o == null) return i(!0);
              if (typeof o == `boolean`) return i(o);
              typeof o.then == `function` && o.then(i);
            }),
            REVERT_ITEM_PROCESSING: X(n, function (r) {
              r.revert(
                Cn(n.options.server.url, n.options.server.revert),
                t(`GET_FORCE_REVERT`)
              )
                .then(function () {
                  (n.options.instantUpload || Rn(r)) &&
            ...
            SET_OPTIONS: function (t) {
              ...
              []
                ...
                .forEach(function (t) {
                  e(`SET_` + je(t, `_`).toUpperCase(), { value: n[t] });
                });
            },
          };
        },
        ...
        qn = function (e, t, n, r, i, a) {
          var o = Kn(e, t, n, i),
            s = Kn(e, t, n, r);
          return [`M`, o.x, o.y, `A`, n, n, 0, a, 0, s.x, s.y].join(` `);
        },
        Jn = function (e, t, n, r, i) {
          ...
          return (
            i > r && i - r <= 0.5 && (a = 0),
            r > i && r - i >= 0.5 && (a = 0),
            qn(e, t, n, Math.min(0.9999, r) * 360, Math.min(0.9999, i) * 360, a)
          );
        },
        Yn = I({
          tag: `div`,
          ...
          write: function (e) {
            ...
            if (n.opacity !== 0) {
              ...
              var r = parseInt(o(t.ref.path, `stroke-width`), 10),
                i = t.rect.element.width * 0.5,
                a = 0,
                s = 0;
              n.spin ? ((a = 0), (s = 0.5)) : ((a = 0), (s = n.progress));
              var c = Jn(i, i, i - r, a, s);
              o(t.ref.path, `d`, c),
                o(
                  t.ref.path,
                  `stroke-opacity`,
        ...
        Xn = I({
          ...
          write: function (e) {
            var t = e.root,
              n = e.props,
              r = n.isDisabled,
              i = t.query(`GET_DISABLED`) || n.opacity === 0;
            i && !r
              ? ((n.isDisabled = !0), o(t.element, `disabled`, `disabled`))
              : !i &&
                r &&
        ...
        $n = function (e) {
          ...
          (i.className = `filepond--file-info-sub`),
            t.appendChild(i),
            (t.ref.fileSize = i),
            Z(i, t.query(`GET_LABEL_FILE_WAITING_FOR_SIZE`)),
            Z(r, Wn(t.query(`GET_ITEM_NAME`, n.id)));
        },
        er = function (e) {
          var t = e.root,
            n = e.props;
          Z(
            ...
            Z(t.ref.fileName, Wn(t.query(`GET_ITEM_NAME`, n.id)));
        },
        tr = function (e) {
          var t = e.root,
            n = e.props;
          if (me(t.query(`GET_ITEM_SIZE`, n.id))) {
            er({ root: t, props: n });
            return;
          }
          Z(t.ref.fileSize, t.query(`GET_LABEL_FILE_SIZE_NOT_AVAILABLE`));
        },
        nr = I({
          name: `file-info`,
          ignoreRect: !0,
        ...
        ir = function (e) {
          ...
          (r.className = `filepond--file-status-sub`),
            t.appendChild(r),
            (t.ref.sub = r),
            ar({ root: t, action: { progress: null } });
        },
        ar = function (e) {
          var t = e.root,
            n = e.action,
            r =
              n.progress === null
                ...
                : t.query(`GET_LABEL_FILE_LOADING`) +
                  ...
                  rr(n.progress) +
                  `%`;
          Z(t.ref.main, r), Z(t.ref.sub, t.query(`GET_LABEL_TAP_TO_CANCEL`));
        },
        or = function (e) {
          var t = e.root,
            n = e.action,
        ...
        sr = function (e) {
          var t = e.root;
          Z(t.ref.main, t.query(`GET_LABEL_FILE_PROCESSING`)),
            Z(t.ref.sub, t.query(`GET_LABEL_TAP_TO_CANCEL`));
        },
        cr = function (e) {
          var t = e.root;
          Z(t.ref.main, t.query(`GET_LABEL_FILE_PROCESSING_ABORTED`)),
            Z(t.ref.sub, t.query(`GET_LABEL_TAP_TO_RETRY`));
        },
        lr = function (e) {
          var t = e.root;
          Z(t.ref.main, t.query(`GET_LABEL_FILE_PROCESSING_COMPLETE`)),
            Z(t.ref.sub, t.query(`GET_LABEL_TAP_TO_UNDO`));
        },
        ur = function (e) {
          var t = e.root;
          Z(t.ref.main, ``), Z(t.ref.sub, ``);
        },
        dr = function (e) {
          var t = e.root,
            n = e.action;
          Z(t.ref.main, n.status.main), Z(t.ref.sub, n.status.sub);
        },
        fr = I({
          name: `file-status`,
          ignoreRect: !0,
          ...
          write: L({
            ...
            DID_REQUEST_ITEM_PROCESSING: sr,
            DID_ABORT_ITEM_PROCESSING: cr,
            DID_COMPLETE_ITEM_PROCESSING: lr,
            DID_UPDATE_ITEM_PROCESS_PROGRESS: or,
            DID_UPDATE_ITEM_LOAD_PROGRESS: ar,
            DID_THROW_ITEM_LOAD_ERROR: dr,
            DID_THROW_ITEM_INVALID: dr,
            DID_THROW_ITEM_PROCESSING_ERROR: dr,
            DID_THROW_ITEM_PROCESSING_REVERT_ERROR: dr,
            DID_THROW_ITEM_REMOVE_ERROR: dr,
          }),
          didCreateView: function (e) {
            Ct(`CREATE_VIEW`, Object.assign({}, e, { view: e }));
          },
      ...
      var Q = function (e) {
        ...
        xr = {
          ...
          loadProgressIndicator: { opacity: 0, align: vr },
          processProgressIndicator: { opacity: 0, align: yr },
        ...
        wr = {
          ...
          DID_START_ITEM_REMOVE: {
            processProgressIndicator: { opacity: 1, align: br },
            info: { translateX: Q },
            status: { opacity: 0 },
          },
          DID_THROW_ITEM_REMOVE_ERROR: {
            processProgressIndicator: { opacity: 0, align: br },
            buttonRemoveItem: { opacity: 1 },
            info: { translateX: Q },
            status: { opacity: 1, translateX: Q },
          },
          DID_LOAD_ITEM: Sr,
          DID_LOAD_LOCAL_ITEM: {
            buttonRemoveItem: { opacity: 1 },
          ...
          DID_START_ITEM_PROCESSING: Cr,
          DID_REQUEST_ITEM_PROCESSING: Cr,
          DID_UPDATE_ITEM_PROCESS_PROGRESS: Cr,
        ...
        Er = function (e) {
          var t = e.root,
            n = e.props,
            r = Object.keys(pr).reduce(function (e, t) {
              return (e[t] = Object.assign({}, pr[t])), e;
            }, {}),
            a = n.id,
            o = t.query(`GET_ALLOW_REVERT`),
            s = t.query(`GET_ALLOW_REMOVE`),
            c = t.query(`GET_ALLOW_PROCESS`),
          ...
          if (
            ...
            var m = wr.DID_COMPLETE_ITEM_PROCESSING;
            (m.info.translateX = _r),
              (m.info.translateY = gr),
              (m.status.translateY = gr),
              (m.processingCompleteIndicator = {
                opacity: 1,
                scaleX: 1,
                scaleY: 1,
              });
          ...
          if (
            (u &&
              ...
              ([
                ...
                wr[e].status.translateY = gr;
              }),
              (wr.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX = hr)),
            d && o)
          ) {
            r.RevertItemProcessing.align = `BUTTON_REMOVE_ITEM_POSITION`;
            var h = wr.DID_COMPLETE_ITEM_PROCESSING;
            (h.info.translateX = Q),
              (h.status.translateY = gr),
          ...
          s || (r.RemoveItem.disabled = !0),
            i(r, function (e, n) {
              var r = t.createChildView(Xn, {
                label: t.query(n.label),
                icon: t.query(n.icon),
                opacity: 0,
              });
              p.includes(e) && t.appendChildView(r),
                n.disabled &&
                  (r.element.setAttribute(`disabled`, `disabled`),
                  r.element.setAttribute(`hidden`, `hidden`)),
                (r.element.dataset.align = t.query(`GET_STYLE_` + n.align)),
                r.element.classList.add(n.className),
                r.on(`click`, function (e) {
                  e.stopPropagation(),
                    !n.disabled && t.dispatch(n.action, { query: a });
                }),
                (t.ref[`button` + e] = r);
            }),
            ...
            (t.ref.info = t.appendChildView(t.createChildView(nr, { id: a }))),
            (t.ref.status = t.appendChildView(
              t.createChildView(fr, { id: a })
            ));
          var g = t.appendChildView(
            t.createChildView(Yn, {
              opacity: 0,
              align: t.query(`GET_STYLE_LOAD_INDICATOR_POSITION`),
            })
          );
          g.element.classList.add(`filepond--load-indicator`),
            (t.ref.loadProgressIndicator = g);
        ...
        Dr = function (e) {
          ...
          if (a) {
            ...
            i(xr, function (e, n) {
              var r = t.ref[e];
              i(n, function (n, i) {
                var a = o[e] && o[e][n] !== void 0 ? o[e][n] : i;
                t.ref.activeStyles.push({ control: r, key: n, value: a });
              });
            });
          }
        ...
        jr = { type: `spring`, damping: 0.6, mass: 7 },
        Mr = function (e) {
          var t = e.root,
            n = e.props;
          [
        ...
        Pr = I({
          ...
          read: function (e) {
            var t = e.root,
              n = e.props;
            return (n.heightCurrent = t.ref.bottom.translateY);
          },
          write: function (e) {
            var t = e.root,
              n = e.props;
            if (
              ((t.ref.scalable === null || n.scalable !== t.ref.scalable) &&
                ((t.ref.scalable = z(n.scalable) ? n.scalable : !0),
                (t.element.dataset.scalable = t.ref.scalable)),
              n.height)
            ) {
              var r = t.ref.top.rect.element,
                i = t.ref.bottom.rect.element,
                a = Math.max(r.height + i.height, n.height);
              (t.ref.center.translateY = r.height),
                (t.ref.center.scaleY = (a - r.height - i.height) / 100),
        ...
        Ir = { type: `spring`, stiffness: 0.75, damping: 0.45, mass: 10 },
        Lr = `spring`,
        Rr = {
        ...
        zr = function (e) {
          ...
          (t.ref.handleClick = function (e) {
            ...
            (t.ref.container = t.appendChildView(
              t.createChildView(Ar, { id: n.id })
            )),
            (t.ref.panel = t.appendChildView(
              t.createChildView(Pr, { name: `item-panel` })
            )),
            ...
            t.query(`GET_ALLOW_REORDER`) &&
              ...
              t.element.addEventListener(`pointerdown`, function (e) {
                if (e.isPrimary) {
                  ...
                  var a = Fr(t.query(`GET_ACTIVE_ITEMS`));
                  t.dispatch(`DID_GRAB_ITEM`, { id: n.id, dragState: a });
                  var o = function (e) {
                      e.isPrimary &&
                        (e.stopPropagation(),
                        e.preventDefault(),
                    ...
                    l = function () {
                      document.removeEventListener(`pointercancel`, c),
                        ...
                        t.dispatch(`DID_DROP_ITEM`, { id: n.id, dragState: a }),
                        r &&
                          setTimeout(function () {
        ...
        Vr = I({
          ...
          write: L(
            ...
            function (e) {
              ...
              o
                ? i || (t.height = t.rect.element.width * o)
                : (Br({ root: t, actions: n, props: r }),
                  !t.height &&
        ...
        Ur = function (e, t, n) {
          if (n) {
            var r = e.rect.element.width,
              i = t.length,
              a = null;
            if (i === 0 || n.top < t[0].rect.element.top) return -1;
            ...
            if (l === 1) {
              for (var u = 0; u < i; u++) {
                var d = t[u],
                  f = d.rect.outer.top + d.rect.element.height * 0.5;
                if (n.top < f) return u;
              }
              return i;
            }
            for (
              var p = o.marginTop + o.marginBottom, m = o.height + p, h = 0;
              h < i;
              h++
            ) {
              var g = h % l,
                ...
                b = y - o.marginTop,
                x = v + c,
                S = y + m + o.marginBottom;
              if (n.top < S && n.top > b) {
                if (n.left < x) return h;
                a = h === i - 1 ? null : h;
              }
            }
            return a === null ? i : a;
        ...
        Gr = function (e) {
          var t = e.root;
          o(t.element, `role`, `list`), (t.ref.lastItemSpanwDate = Date.now());
        },
        Kr = function (e) {
          var t = e.root,
            n = e.action,
          ...
          if (a !== U.NONE) {
            ...
            var l = t.query(`GET_ITEM_INSERT_INTERVAL`),
              u = o - t.ref.lastItemSpanwDate;
            s = u < l ? o + (l - u) : o;
          }
          (t.ref.lastItemSpanwDate = s),
            t.appendChildView(
              t.createChildView(Vr, {
                spawnDate: s,
                id: r,
                opacity: c,
                interactionMethod: a,
          ...
          e.dragOffset
            ...
            : ((e.translateX = t),
              ...
              Date.now() > e.spawnDate &&
                (e.opacity === 0 && Jr(e, t, n, r, i),
                (e.scaleX = 1),
                (e.scaleY = 1),
                (e.opacity = 1)));
        },
        Jr = function (e, t, n, r, i) {
          e.interactionMethod === U.NONE
            ? ((e.translateX = null),
              (e.translateX = t),
              (e.translateY = null),
              (e.translateY = n))
            : e.interactionMethod === U.DROP
            ? ((e.translateX = null),
              (e.translateX = t - r * 20),
              (e.translateY = null),
              (e.translateY = n - i * 10),
              (e.scaleX = 0.8),
              (e.scaleY = 0.8))
            : e.interactionMethod === U.BROWSE
            ? ((e.translateY = null), (e.translateY = n - 30))
            : e.interactionMethod === U.API &&
              ((e.translateX = null),
              (e.translateX = t - 30),
              (e.translateY = null));
        },
          ...
          DID_DRAG_ITEM: function (e) {
            ...
            if (o) {
              var l = {
                ...
                u = Xr(o),
                d = Zr(o),
                f = Math.floor(t.rect.outer.width / d);
              f > s && (f = s),
                (Wr.setHeight = u * Math.floor(s / f + 1)),
                (Wr.setWidth = d * f);
              var p = {
                  y: Math.floor(l.y / u),
                  x: Math.floor(l.x / d),
                  getGridIndex: function () {
                    return l.y > Wr.getHeight ||
                      l.y < 0 ||
                      l.x > Wr.getWidth ||
                      l.x < 0
                      ? c
                ...
                m = f > 1 ? p.getGridIndex() : p.getColIndex();
              t.dispatch(`MOVE_ITEM`, { query: o, index: m });
              var h = i.getIndex();
              if (h === void 0 || h !== m) {
                if ((i.setIndex(m), h === void 0)) return;
        ...
        $r = I({
          ...
          write: function (e) {
            ...
            var a = n.dragCoordinates,
              o = t.rect.element.width,
              ...
              l = a ? Ur(t, c, a) : null,
              u = t.ref.addIndex || null;
            t.ref.addIndex = null;
            var d = 0,
              f = 0,
              p = 0;
            if (c.length !== 0) {
              var m = c[0].rect.element,
                h = m.marginTop + m.marginBottom,
                g = m.marginLeft + m.marginRight,
                _ = m.width + g,
                v = m.height + h,
                y = Hr(o, _);
              if (y === 1) {
                ...
                c.forEach(function (e, t) {
                  t === l && (d = 1),
                    t === u && (p += 1),
                    e.markedForRemoval && e.opacity < 0.5 && --f;
                  var n = t + p + d + f,
                    r = n % y,
                    a = Math.floor(n / y),
                    o = r * _,
          ...
          filterFrameActionsForChild: function (e, t) {
            return t.filter(function (t) {
              return t.data && t.data.id ? e.id === t.data.id : !0;
            });
          },
        ...
        ei = function (e) {
          var t = e.root,
            n = e.props;
          (t.ref.list = t.appendChildView(t.createChildView($r))),
        ...
        ii = function (e) {
          ...
          (t.element.id = `filepond--browser-` + n.id),
            o(t.element, `name`, t.query(`GET_NAME`)),
            o(t.element, `aria-controls`, `filepond--assistant-` + n.id),
            o(t.element, `aria-labelledby`, `filepond--drop-label-` + n.id),
            ai({
              root: t,
              action: { value: t.query(`GET_ACCEPTED_FILE_TYPES`) },
            }),
            oi({ root: t, action: { value: t.query(`GET_ALLOW_MULTIPLE`) } }),
            si({
              root: t,
              action: { value: t.query(`GET_ALLOW_DIRECTORIES_ONLY`) },
            }),
            ci({ root: t }),
            li({ root: t, action: { value: t.query(`GET_REQUIRED`) } }),
            ui({ root: t, action: { value: t.query(`GET_CAPTURE_METHOD`) } }),
        ...
        ai = function (e) {
          ...
          t.query(`GET_ALLOW_SYNC_ACCEPT_ATTRIBUTE`) &&
            $(t.element, `accept`, !!n.value, n.value ? n.value.join(`,`) : ``);
        },
        oi = function (e) {
          var t = e.root,
            n = e.action;
          $(t.element, `multiple`, n.value);
        },
        si = function (e) {
          var t = e.root,
            n = e.action;
          $(t.element, `webkitdirectory`, n.value);
        },
        ci = function (e) {
          var t = e.root,
            ...
            i = n || !r;
          $(t.element, `disabled`, i);
        },
        li = function (e) {
          var t = e.root;
          e.action.value
            ? t.query(`GET_TOTAL_ITEMS`) === 0 && $(t.element, `required`, !0)
            : $(t.element, `required`, !1);
        },
        ui = function (e) {
          var t = e.root,
            n = e.action;
          $(t.element, `capture`, !!n.value, n.value === !0 ? `` : n.value);
        },
        di = function (e) {
          var t = e.root,
            n = t.element;
          if (t.query(`GET_TOTAL_ITEMS`) > 0) {
            $(n, `required`, !1), $(n, `name`, !1);
            for (
              var r = t.query(`GET_ACTIVE_ITEMS`), i = !1, a = 0;
              a < r.length;
              a++
            )
              r[a].status === G.LOAD_ERROR && (i = !0);
            t.element.setCustomValidity(
              i ? t.query(`GET_LABEL_INVALID_FIELD`) : ``
            );
          } else
            $(n, `name`, !0, t.query(`GET_NAME`)),
              t.query(`GET_CHECK_VALIDITY`) && n.setCustomValidity(``),
              t.query(`GET_REQUIRED`) && $(n, `required`, !0);
        },
        fi = I({
          tag: `input`,
          name: `browser`,
          ...
          write: L({
            ...
            DID_SET_DISABLED: ci,
            DID_SET_ALLOW_BROWSE: ci,
            DID_SET_ALLOW_DIRECTORIES_ONLY: si,
            DID_SET_ALLOW_MULTIPLE: oi,
            DID_SET_ACCEPTED_FILE_TYPES: ai,
            DID_SET_CAPTURE_METHOD: ui,
            DID_SET_REQUIRED: li,
          }),
        }),
        pi = { ENTER: 13, SPACE: 32 },
        mi = function (e) {
          var t = e.root,
            n = e.props,
            r = Gn(`label`);
          o(r, `for`, `filepond--browser-` + n.id),
            o(r, `id`, `filepond--drop-label-` + n.id),
            (t.ref.handleKeyDown = function (e) {
              (e.keyCode === pi.ENTER || e.keyCode === pi.SPACE) &&
        ...
        vi = function (e) {
          var t = e.root,
            n = t.rect.element.width * 0.5,
            r = t.rect.element.height * 0.5;
          t.ref.blob = t.appendChildView(
            t.createChildView(_i, {
              opacity: 0,
              scaleX: 2.5,
              scaleY: 2.5,
              translateX: n,
        ...
        Ci = L({ DID_DRAG: yi, DID_DROP: xi, DID_END_DRAG: bi }),
        wi = I({
          ignoreRect: !0,
          ignoreRectUpdate: !0,
          name: `drip`,
          ...
          write: L({
            ...
            DID_ADD_ITEM: function (e) {
              var t = e.root,
                n = e.action,
                r =
                  t.query(`GET_ITEM`, n.id).origin !== K.LOCAL &&
            ...
            DID_LOAD_ITEM: function (e) {
              ...
              r &&
                ...
                t.query(`SHOULD_UPDATE_FILE_INPUT`) &&
                  Ti(r, [t.query(`GET_ITEM`, n.id).file]));
            },
        ...
        Mi = [`jpg`, `jpeg`, `png`, `gif`, `bmp`, `webp`, `svg`, `tiff`],
        Ni = [`css`, `csv`, `html`, `txt`],
        Pi = { zip: `zip|compressed`, epub: `application/epub+zip` },
        Fi = function () {
          var e =
        ...
        Ii = function (e) {
          return new Promise(function (t, n) {
            var r = Ki(e);
            if (r.length && !Li(e)) return t(r);
            Ri(e).then(t);
          });
        },
        Li = function (e) {
          return e.files ? e.files.length > 0 : !1;
        },
        Ri = function (e) {
          return new Promise(function (t, n) {
        ...
        $i = function (e) {
          var t = [],
            n = { dragenter: ia, dragover: aa, dragleave: sa, drop: oa },
            r = {};
          i(n, function (n, i) {
            ...
            Ii(n).then(function (r) {
              ...
              t.some(function (t) {
                ...
                if (ta(e, o)) {
                  ...
                  l(Xi(e));
                } else a && !i && ra(n, `none`), t.state && ((t.state = null), c(Xi(e)));
              });
            });
          };
        },
            ...
            Ii(n).then(function (n) {
              t.forEach(function (t) {
                var r = t.filterElement,
                  ...
                  o = t.onexit,
                  s = t.allowdrop;
                if (((t.state = null), !(r && !ta(e, i)))) {
                  if (!s(n)) return o(Xi(e));
                  a(Xi(e), n);
                }
              });
            });
        ...
        ca = function (e, t, n) {
          ...
          var r = n.catchesDropsOnPage,
            ...
            o =
              a === void 0
                ...
                : a,
            s = Zi(e, r ? document.documentElement : e, i),
            c = ``,
            l = ``;
          ...
          var u = {
            updateHopperState: function () {
              c !== l && ((e.dataset.hopperState = l), (c = l));
            },
            onload: function () {},
        ...
        da = function (e) {
          ...
          Ii(e.clipboardData).then(function (e) {
            e.length &&
        ...
        fa = function (e) {
          ua.includes(e) ||
            (ua.push(e),
            !la && ((la = !0), document.addEventListener(`paste`, da)));
        },
        pa = function (e) {
          ft(ua, ua.indexOf(e)),
            ua.length === 0 &&
              (document.removeEventListener(`paste`, da), (la = !1));
        },
        ma = function () {
          var e = function (e) {
              t.onload(e);
        ...
        ha = function (e) {
          ...
          (t.element.id = `filepond--assistant-` + n.id),
            o(t.element, `role`, `alert`),
            o(t.element, `aria-live`, `polite`),
            o(t.element, `aria-relevant`, `additions`);
        },
        ga = null,
        _a = null,
        va = [],
          ...
          if (Sa(t)) {
            ...
            va.push(r.filename),
              ...
              (ga = setTimeout(function () {
                xa(t, va.join(`, `), t.query(`GET_LABEL_FILE_ADDED`)),
                  (va.length = 0);
              }, 750));
          }
        },
        wa = function (e) {
          ...
          if (Sa(t)) {
            var r = n.item;
            xa(t, r.filename, t.query(`GET_LABEL_FILE_REMOVED`));
          }
        },
        Ta = function (e) {
          var t = e.root,
        ...
        Da = function (e) {
          var t = e.root,
            n = e.action,
            r = t.query(`GET_ITEM`, n.id).filename;
          ya(t, n.status.main + ` ` + r + ` ` + n.status.sub);
        },
        Oa = I({
          create: ha,
          ignoreRect: !0,
          ...
          write: L({
            DID_LOAD_ITEM: Ca,
            DID_REMOVE_ITEM: wa,
            DID_COMPLETE_ITEM_PROCESSING: Ta,
            DID_ABORT_ITEM_PROCESSING: Ea,
            DID_REVERT_ITEM_PROCESSING: Ea,
            DID_THROW_ITEM_REMOVE_ERROR: Da,
            DID_THROW_ITEM_LOAD_ERROR: Da,
            DID_THROW_ITEM_INVALID: Da,
            DID_THROW_ITEM_PROCESSING_ERROR: Da,
          }),
          tag: `span`,
          name: `assistant`,
        }),
        ka = function (e) {
          var t =
            arguments.length > 1 && arguments[1] !== void 0
              ? arguments[1]
              : `-`;
          return e.replace(RegExp(t + `.`, `g`), function (e) {
        ...
        Na = function (e) {
          ...
          i &&
            ...
            (t.ref.list = t.appendChildView(
              t.createChildView(ni, { translateY: null })
            )),
            (t.ref.panel = t.appendChildView(
              t.createChildView(Pr, { name: `panel-root` })
            )),
            (t.ref.assistant = t.appendChildView(
              t.createChildView(Oa, Object.assign({}, n))
            )),
            (t.ref.data = t.appendChildView(
              t.createChildView(Ai, Object.assign({}, n))
            )),
            (t.ref.measure = Gn(`div`)),
            ...
            (t.ref.widthUpdated = Aa(function () {
          ...
          t.query(`GET_ALLOW_REORDER`) &&
            o &&
            !a &&
            (t.element.addEventListener(`touchmove`, Ma, { passive: !1 }),
            t.element.addEventListener(`gesturestart`, Ma));
          var s = t.query(`GET_CREDITS`);
          if (s.length === 2) {
            var c = document.createElement(`a`);
            (c.className = `filepond--credits`),
              (c.href = s[0]),
              (c.tabIndex = -1),
              (c.target = `_blank`),
          ...
          if (
            ...
            r
              ...
              .map(function (e) {
                var n = e.type,
                  r = e.data,
                  i = ka(n.substring(8).toLowerCase(), `_`);
            ...
            var u = t.query(`GET_PANEL_ASPECT_RATIO`),
              d = t.query(`GET_ALLOW_MULTIPLE`),
              f = t.query(`GET_TOTAL_ITEMS`),
              p = f === (d ? t.query(`GET_MAX_FILES`) || ja : 1),
              m = r.find(function (e) {
                return e.type === `DID_ADD_ITEM`;
              });
            if (p && m) {
              var h = m.data.interactionMethod;
              (s.opacity = 0),
                d
                  ? (s.translateY = -40)
                  : h === U.API
            ...
            var g = Fa(t),
              ...
              y = !d || p ? 0 : v,
              b = p ? c.rect.element.marginTop : 0,
              x = f === 0 ? 0 : c.rect.element.marginBottom,
              S = y + b + _.visual + x,
              C = y + b + _.bounds + x;
            if (
              ((c.translateY =
                Math.max(0, y - c.rect.element.marginTop) - g.top),
              u)
            ) {
              var w = t.rect.element.width,
                T = w * u;
              u !== t.ref.previousAspectRatio &&
                ((t.ref.previousAspectRatio = u), (t.ref.updateHistory = []));
              var E = t.ref.updateHistory;
              E.push(w);
              var D = 2;
              if (E.length > D * 2) {
                for (var O = E.length, k = O - 10, A = 0, j = O; j >= k; j--)
                  if ((E[j] === E[j - 2] && A++, A >= D)) return;
              }
              (l.scalable = !1), (l.height = T);
              var M = T - y - (x - g.bottom) - (p ? b : 0);
              _.visual > M ? (c.overflow = M) : (c.overflow = null),
                (t.height = T);
            } else if (i.fixedHeight) {
              l.scalable = !1;
              var N = i.fixedHeight - y - (x - g.bottom) - (p ? b : 0);
              _.visual > N ? (c.overflow = N) : (c.overflow = null);
            } else if (i.cappedHeight) {
              var ee = S >= i.cappedHeight,
                P = Math.min(i.cappedHeight, S);
              (l.scalable = !0), (l.height = ee ? P : P - g.top - g.bottom);
              var te = P - y - (x - g.bottom) - (p ? b : 0);
              S > i.cappedHeight && _.visual > te
                ? (c.overflow = te)
                : (c.overflow = null),
                (t.height = Math.min(i.cappedHeight, C - g.top - g.bottom));
            } else {
              var ne = f > 0 ? g.top + g.bottom : 0;
              (l.scalable = !0),
                (l.height = Math.max(v, S - ne)),
                (t.height = Math.max(v, C - ne));
            }
            t.ref.credits &&
              l.heightCurrent &&
        ...
        Ia = function (e) {
          var t = 0,
            ...
            r = e.ref.list,
            i = r.childViews[0],
            a = i.childViews.filter(function (e) {
              return e.rect.element.height;
            }),
            o = e
              .query(`GET_ACTIVE_ITEMS`)
          ...
          var s = i.rect.element.width,
            c = Ur(i, o, r.dragCoordinates),
            l = o[0].rect.element,
            u = l.marginTop + l.marginBottom,
            d = l.marginLeft + l.marginRight,
            f = l.width + d,
            p = l.height + u,
            m = c !== void 0 && c >= 0 ? 1 : 0,
            h = o.find(function (e) {
          ...
          return (
            _ === 1
              ? o.forEach(function (e) {
                  var r = e.rect.element.height + u;
                  (n += r), (t += r * e.opacity);
                })
              : ((n = Math.ceil(g / _) * p), (t = n)),
            { visual: t, bounds: n }
          );
        },
        La = function (e) {
        ...
        Ba = function (e) {
          ...
          if (r && !e.ref.hopper) {
            var i = ca(
              ...
              function (t) {
                ...
                return e.query(`GET_DROP_VALIDATION`)
                  ? t.every(function (t) {
                      return (
                        Ct(`ALLOW_HOPPER_ITEM`, t, { query: e.query }).every(
                          function (e) {
                            return e === !0;
                          }
                        ) && n(t)
              ...
              },
              {
                filterItems: function (t) {
                  ...
                  return t.filter(function (e) {
                    return kn(e) ? !n.includes(e.name.toLowerCase()) : !0;
                  });
                },
            ...
            (i.onload = function (t, n) {
              ...
              St(`ADD_ITEMS`, t, { dispatch: e.dispatch }).then(function (t) {
                if (Ra(e, t)) return !1;
                e.dispatch(`ADD_ITEMS`, {
                  items: t,
                  index: za(e.ref.list, i, n),
                  interactionMethod: U.DROP,
                });
              }),
              ...
              (e.ref.hopper = i),
              (e.ref.drip = e.appendChildView(e.createChildView(wi)));
          } else
            !r &&
              e.ref.hopper &&
          ...
          i && !e.ref.browser
            ? (e.ref.browser = e.appendChildView(
                e.createChildView(
                  ...
                  Object.assign({}, t, {
                    onload: function (t) {
                      St(`ADD_ITEMS`, t, { dispatch: e.dispatch }).then(
                        function (t) {
                          if (Ra(e, t)) return !1;
                          e.dispatch(`ADD_ITEMS`, {
                            items: t,
                            index: -1,
                            interactionMethod: U.BROWSE,
                          });
                        }
                      );
                    },
        ...
        Wa = I({
          ...
          destroy: function (e) {
            ...
            t.ref.paster && t.ref.paster.destroy(),
              ...
              t.element.removeEventListener(`touchmove`, Ma),
              t.element.removeEventListener(`gesturestart`, Ma);
          },
        ...
        Ga = function () {
          ...
          var p = Wa(i, { id: Fe() }),
            ...
            g = {
              _read: function () {
                c &&
                  ((d = window.innerWidth),
                  (u ||= d),
                  !l && d !== u && (i.dispatch(`DID_START_RESIZE`), (l = !0))),
                  h && m && (m = p.element.offsetParent === null),
                  !m && (p._read(), (h = p.rect.element.hidden));
              },
              _write: function (e) {
                ...
                (m && !t.length) ||
                  (x(t),
                  (m = p._write(e, t, l)),
                  _t(i.query(`GET_ITEMS`)),
                  m && i.processDispatchQueue());
              },
            },
            _ = function (e) {
              return function (t) {
            ...
            y = function (e) {
              ...
              Object.keys(e)
                ...
                j.fire.apply(j, [e.type].concat(n));
            ...
            T = function (e) {
              var t =
                arguments.length > 1 && arguments[1] !== void 0
                  ...
                  : {};
              return new Promise(function (n, r) {
                O([{ source: e, options: t }], { index: t.index })
                  .then(function (e) {
                    return n(e && e[0]);
                  })
                  .catch(r);
            ...
            D = function (e, t) {
              return (
                typeof e == `object` && !E(e) && !t && ((t = e), (e = void 0)),
                i.dispatch(`REMOVE_ITEM`, Object.assign({}, t, { query: e })),
                i.query(`GET_ACTIVE_ITEM`, e) === null
              );
            },
            O = function () {
              var e = [...arguments];
              return new Promise(function (t, n) {
                var r = [],
                  a = {};
                if (oe(e[0]))
                  r.push.apply(r, e[0]), Object.assign(a, e[1] || {});
                else {
                  var o = e[e.length - 1];
                  typeof o == `object` &&
                    !(o instanceof Blob) &&
                    Object.assign(a, e.pop()),
                    r.push.apply(r, e);
                }
                i.dispatch(`ADD_ITEMS`, {
                  items: r,
                  index: a.index,
                  interactionMethod: U.API,
                  success: t,
                  failure: n,
                });
              });
            ...
            j = Object.assign({}, mt(), {}, g, {}, Me(i, r), {
              ...
              processFiles: function () {
                ...
                if (!t.length) {
                  var n = k().filter(function (e) {
                    return (
                      !(e.status === G.IDLE && e.origin === K.LOCAL) &&
                      e.status !== G.PROCESSING &&
                      e.status !== G.PROCESSING_COMPLETE &&
                      e.status !== G.PROCESSING_REVERT_ERROR
                    );
                  });
              ...
              removeFiles: function () {
                ...
                typeof t[t.length - 1] == `object`
                  ? (n = t.pop())
                  : Array.isArray(e[0]) && (n = e[1]);
                var r = k();
                return t.length
                  ? t
                      .map(function (e) {
                        return b(e) ? (r[e] ? r[e].id : null) : e;
                      })
                      .filter(function (e) {
                        return e;
                      })
              ...
              insertBefore: function (e) {
                return ie(p.element, e);
              },
              insertAfter: function (e) {
                return ae(p.element, e);
              },
              appendTo: function (e) {
                return e.appendChild(p.element);
              },
              replaceElement: function (e) {
                ie(p.element, e), e.parentNode.removeChild(e), (t = e);
              },
          ...
          return i.dispatch(`DID_INIT`), a(j);
        },
        Ka = function () {
          var e =
              arguments.length > 0 && arguments[0] !== void 0
        ...
        Ja = function (e) {
          return ka(e.replace(/^data-/, ``));
        },
        Ya = function e(t, n) {
          i(n, function (n, r) {
            i(t, function (e, i) {
              var a = new RegExp(n);
              if (a.test(e) && (delete t[e], r !== !1)) {
                if (B(r)) {
                  t[r] = i;
                  return;
                }
                var o = r.group;
                V(r) && !t[o] && (t[o] = {}), (t[o][qa(e.replace(a, ``))] = i);
              }
            }),
        ...
        Xa = function (e) {
          ...
          var r = n
            ...
            .reduce(function (t, n) {
              var r = o(e, n.name);
              return (t[Ja(n.name)] = r === n.name ? !0 : r), t;
            }, {});
          return Ya(r, t), r;
        },
        Za = function (e) {
          ...
          Ct(`SET_ATTRIBUTE_TO_OPTION_MAP`, n);
          ...
          Object.keys(i).forEach(function (e) {
            V(i[e])
              ? (V(r[e]) || (r[e] = {}), Object.assign(r[e], i[e]))
              : (r[e] = i[e]);
          }),
        ...
        Qa = function () {
          return t(arguments.length <= 0 ? void 0 : arguments[0])
            ? Za.apply(void 0, arguments)
            : Ka.apply(void 0, arguments);
        },
        $a = [`fire`, `_read`, `_write`],
        eo = function (e) {
          var t = {};
            ...
            Tt(
              e({
                ...
                utils: {
                  ...
                  applyFilterChain: St,
                  text: Z,
                  getNumericAspectRatioFromString: At,
                },
                views: { fileActionButton: Xn },
              }).options
            ));
        },
        co = function () {
      ...
      if (
        ...
        var So = function () {
          return i(Et(), function (t, n) {
            e.OptionTypes[t] = n[1];
          });
        };
        (e.Status = Object.assign({}, Mt)),
          (e.FileOrigin = Object.assign({}, K)),
          (e.FileStatus = Object.assign({}, G)),
          (e.OptionTypes = {}),
          So(),
          (e.create = function () {
            var t = Qa.apply(void 0, arguments);
            return t.on(`destroy`, e.destroy), vo.apps.push(t), eo(t);
          }),
          (e.destroy = function (e) {
            var t = vo.apps.findIndex(function (t) {
              return t.isAttachedTo(e);
            });
            return t >= 0 ? (vo.apps.splice(t, 1)[0].restoreElement(), !0) : !1;
          }),
          (e.parse = function (t) {
            return Array.from(t.querySelectorAll(`.` + yo))
              .filter(function (e) {
      ...
      (e.supported = _o), Object.defineProperty(e, `__esModule`, { value: !0 });
    });
  }),
  n = e((e, t) => {
    (function (n, r) {
      typeof e == `object` && t !== void 0
        ...
        : typeof define == `function` && define.amd
        ? define(r)
        : ((n ||= self), (n.FilePondPluginImagePreview = r()));
    })(e, function () {
      var e = function (e) {
      ...
      function r(e) {
        ...
        function i(e, n) {
          return new Promise(function (i, o) {
            var s = { key: e, arg: n, resolve: i, reject: o, next: null };
            r ? (r = r.next = s) : ((t = r = s), a(e, n));
          });
        }
        function a(t, r) {
          try {
            var i = e[t](r),
              s = i.value,
              c = s instanceof n;
            Promise.resolve(c ? s.wrapped : s).then(
              function (e) {
                if (c) {
                  a(`next`, e);
                  return;
        ...
        function o(e, n) {
          ...
          (t = t.next), t ? a(t.key, t.arg) : (r = null);
        }
        (this._invoke = i),
          typeof e.return != `function` && (this.return = void 0);
      }
            ...
            typeof Reflect < `u` && Reflect.set
              ...
              : function (e, t, n, r) {
                  var a = p(e, t),
                    o;
                  if (a) {
                    if (((o = Object.getOwnPropertyDescriptor(a, t)), o.set))
                      return o.set.call(r, n), !0;
                    if (!o.writable) return !1;
                  }
                  if (((o = Object.getOwnPropertyDescriptor(r, t)), o)) {
                    if (!o.writable) return !1;
          ...
          (a.prototype[Symbol.replace] = function (e, t) {
            if (typeof t == `string`) {
              ...
              return r[Symbol.replace].call(this, e, function () {
                ...
                return (
                  e.push.apply(e, arguments),
                  typeof e[e.length - 1] != `object` && e.push(s(e, a)),
                  t.apply(this, e)
                );
              });
            } else return r[Symbol.replace].call(this, e, t);
      ...
      var O = function (e, t) {
        ...
        A = function (e) {
          ...
          return t === 0 ? { x: 0, y: 0 } : M(e.x / t, e.y / t);
        },
        j = function (e, t, n) {
          var r = Math.cos(t),
            i = Math.sin(t),
            a = M(e.x - n.x, e.y - n.y);
          return M(n.x + r * a.x - i * a.y, n.y + i * a.x + r * a.y);
        },
        M = function () {
          return {
            x:
        ...
        ee = function (e, t, n) {
          var r = e.borderStyle || e.lineStyle || `solid`,
            ...
            o = N(e.borderWidth || e.lineWidth, t, n),
            s = e.lineCap || `round`,
            c = e.lineJoin || `round`,
            l =
              typeof r == `string`
        ...
        te = function (e, t) {
          var n =
              arguments.length > 2 && arguments[2] !== void 0
                ? arguments[2]
                : 1,
            r = N(e.x, t, n, `width`) || N(e.left, t, n, `width`),
            i = N(e.y, t, n, `height`) || N(e.top, t, n, `height`),
            a = N(e.width, t, n, `width`),
            o = N(e.height, t, n, `height`),
            s = N(e.right, t, n, `width`),
            c = N(e.bottom, t, n, `height`);
          return (
            P(i) || (i = P(o) && P(c) ? t.height - o - c : c),
            P(r) || (r = P(a) && P(s) ? t.width - a - s : s),
            P(a) || (a = P(r) && P(s) ? t.width - r - s : 0),
            P(o) || (o = P(i) && P(c) ? t.height - i - c : 0),
        ...
        ie = function (e) {
          var t = e.rect.x + e.rect.width * 0.5,
            n = e.rect.y + e.rect.height * 0.5,
            r = e.rect.width * 0.5,
            i = e.rect.height * 0.5;
          return F(e, Object.assign({ cx: t, cy: n, rx: r, ry: i }, e.styles));
        },
        ae = { contain: `xMidYMid meet`, cover: `xMidYMid slice` },
        oe = function (e, t) {
          F(
            e,
            Object.assign({}, e.rect, e.styles, {
              preserveAspectRatio: ae[t.fit] || `none`,
            })
          );
        },
        R = { left: `start`, center: `middle`, right: `end` },
        se = function (e, t, n, r) {
          var i = N(t.fontSize, n, r),
            a = t.fontFamily || `sans-serif`,
            o = t.fontWeight || `normal`,
            s = R[t.textAlign] || `start`;
          F(
            e,
            Object.assign({}, e.rect, e.styles, {
              "stroke-width": 0,
        ...
        ce = function (e, t, n, r) {
          ...
          var i = e.childNodes[0],
            ...
            o = e.childNodes[2],
            s = e.rect,
            c = { x: e.rect.x + e.rect.width, y: e.rect.y + e.rect.height };
          if (
            (F(i, { x1: s.x, y1: s.y, x2: c.x, y2: c.y }), t.lineDecoration)
          ) {
            (a.style.display = `none`), (o.style.display = `none`);
            var l = A({ x: c.x - s.x, y: c.y - s.y }),
              u = N(0.05, n, r);
            ...
            if (t.lineDecoration.indexOf(`arrow-end`) !== -1) {
              ...
              F(o, {
                style: `display:block;`,
                d: `M${h.x},${h.y} L${c.x},${c.y} L${g.x},${g.y}`,
              });
            }
          }
        },
        ...
        B = { rect: L, ellipse: ie, image: oe, text: se, path: le, line: ce },
        de = function (e, t) {
          return ue[e](t);
        },
        fe = function (e, t, n, r, i) {
          t !== `path` && (e.rect = te(n, r, i)),
            (e.styles = ee(n, r, i)),
            B[t](e, n, r, i);
        },
        pe = [`x`, `y`, `left`, `top`, `right`, `bottom`, `width`, `height`],
        me = function (e) {
                ...
                if (i) {
                  ...
                  if (!h || (h && m)) {
                    ...
                    if (p === `force`) (c = d), (l = f);
                      ...
                      p === `cover`
                        ? (y = Math.max(_, v))
                        : p === `contain` && (y = Math.min(_, v)),
                        (c *= y),
                        (l *= y);
                    }
                  }
                }
                var b = { width: o, height: s };
                t.element.setAttribute(`width`, b.width),
                  t.element.setAttribute(`height`, b.height);
                var x = Math.min(o / c, s / l);
                t.element.innerHTML = ``;
                var S = t.query(`GET_IMAGE_PREVIEW_MARKUP_FILTER`);
                a.filter(S)
                  .map(he)
                  .sort(ge)
                  .forEach(function (e) {
                    var n = g(e, 2),
                      ...
                      i = n[1],
                      a = de(r, i);
                    fe(a, r, i, b, x), t.element.appendChild(a);
                  });
              }
            },
          });
        ...
        xe = function (e, t) {
          return ye(be(e, t), be(e, t));
        },
        Se = function (e, t) {
          return Math.sqrt(xe(e, t));
        },
        V = function (e, t) {
          var n = e,
        ...
        Ce = function (e, t) {
          var n = e.width,
            ...
            i = V(n, t),
            a = V(r, t),
            o = ve(e.x + Math.abs(i.x), e.y - Math.abs(i.y)),
            s = ve(e.x + e.width + Math.abs(a.y), e.y + Math.abs(a.x)),
            c = ve(e.x - Math.abs(a.y), e.y + e.height - Math.abs(a.x));
          return { width: Se(o, s), height: Se(o, c) };
        },
        we = function (e, t) {
          var n =
              arguments.length > 2 && arguments[2] !== void 0
        ...
        Te = function (e, t, n, r) {
          var i = r.x > 0.5 ? 1 - r.x : r.x,
            ...
            s = a * 2 * e.height,
            c = Ce(t, n);
          return Math.max(c.width / o, c.height / s);
        },
        Ee = function (e, t) {
          var n = e.width,
            r = n * t;
        ...
        De = function (e) {
          ...
          a ||= e.height / e.width;
          var o = we(e, a, n),
            s = { x: o.width * 0.5, y: o.height * 0.5 },
            c = { x: 0, y: 0, width: o.width, height: o.height, center: s },
            l = t.scaleToFit === void 0 || t.scaleToFit,
            u = n * Te(e, Ee(c, a), r, l ? i : { x: 0.5, y: 0.5 });
          return {
        ...
        H = { type: `spring`, stiffness: 0.5, damping: 0.45, mass: 10 },
        Oe = function (e) {
          return e.utils.createView({
            name: `image-bitmap`,
            ignoreRect: !0,
            ...
            create: function (t) {
              ...
              (r.width = r.image.width),
                ...
                (n.ref.bitmap = n.appendChildView(
                  n.createChildView(Oe(e), { image: r.image })
                ));
            },
            write: function (e) {
              var t = e.root,
          ...
          return e.utils.createView({
            ...
            create: function (t) {
              ...
              (n.ref.image = n.appendChildView(
                n.createChildView(ke(e), Object.assign({}, r))
              )),
                (n.ref.createMarkup = function () {
                  n.ref.markup ||
                    (n.ref.markup = n.appendChildView(
                      n.createChildView(_e(e), Object.assign({}, r))
                    ));
                }),
                (n.ref.destroyMarkup = function () {
                  n.ref.markup &&
                    (n.removeChildView(n.ref.markup), (n.ref.markup = null));
                });
              var i = n.query(`GET_IMAGE_PREVIEW_TRANSPARENCY_INDICATOR`);
              i !== null &&
                (i === `grid`
                  ? (n.element.dataset.transparencyIndicator = i)
                  : (n.element.dataset.transparencyIndicator = `color`));
            },
            write: function (e) {
              var t = e.root,
                n = e.props,
              ...
              var u = {
                  ...
                  width: c,
                  height: l,
                  center: { x: c * 0.5, y: l * 0.5 },
                },
                d = { width: t.ref.image.width, height: t.ref.image.height },
                f = { x: i.center.x * d.width, y: i.center.y * d.height },
                p = {
                  x: u.center.x - d.width * i.center.x,
                  y: u.center.y - d.height * i.center.y,
                },
                m = Math.PI * 2 + (i.rotation % (Math.PI * 2)),
                h = i.aspectRatio || d.height / d.width,
                g = i.scaleToFit === void 0 || i.scaleToFit,
                _ = Te(d, Ee(u, h), m, g ? i.center : { x: 0.5, y: 0.5 }),
                v = i.zoom * _;
              a && a.length
                ? (t.ref.createMarkup(),
                  (t.ref.markup.width = c),
                  (t.ref.markup.height = l),
                  (t.ref.markup.resize = o),
                  (t.ref.markup.dirty = s),
                  (t.ref.markup.markup = a),
                  (t.ref.markup.crop = De(d, i)))
          ...
          return e.utils.createView({
            ...
            write: function (e) {
              ...
              if (
                ...
                var u = a.height / a.width,
                  d = o.aspectRatio || u,
                  f = t.rect.inner.width,
                  p = t.rect.inner.height,
                  m = t.query(`GET_IMAGE_PREVIEW_HEIGHT`),
                  h = t.query(`GET_IMAGE_PREVIEW_MIN_HEIGHT`),
                  g = t.query(`GET_IMAGE_PREVIEW_MAX_HEIGHT`),
                  _ = t.query(`GET_PANEL_ASPECT_RATIO`),
                  v = t.query(`GET_ALLOW_MULTIPLE`);
                _ && !v && ((m = f * _), (d = _));
                var y = m === null ? Math.max(h, Math.min(f * d, g)) : m,
                  b = y / d;
                b > f && ((b = f), (y = b * d)),
                  y > p && ((y = p), (b = p / d)),
                  (i.width = b),
        ...
        Me = `<svg width="500" height="200" viewBox="0 0 500 200" preserveAspectRatio="none">
    <defs>
    ...
    <rect x="0" width="500" height="200" fill="currentColor" mask="url(#mask-__UID__)"></rect>
          ...
          return e.utils.createView({
            ...
            create: function (e) {
              ...
              Ne++,
                ...
                (t.element.innerHTML = r.replace(/__UID__/g, Ne));
            },
            mixins: {
              styles: [`opacity`],
          ...
          self.onmessage = function (e) {
            for (
              ...
              (E = r[T] / 255),
                ...
                (r[T] = Math.max(
                  0,
                  Math.min((E * a + D * o + O * s + k * c + l) * 255, 255)
                )),
                (r[T + 1] = Math.max(
                  0,
                  Math.min((E * u + D * d + O * f + k * p + m) * 255, 255)
                )),
                (r[T + 2] = Math.max(
                  0,
                  Math.min((E * h + D * g + O * _ + k * v + y) * 255, 255)
                )),
                (r[T + 3] = Math.max(
                  0,
                  Math.min((E * b + D * x + O * S + k * C + w) * 255, 255)
                ));
        ...
        Re = function (e, t, n, r) {
          r !== -1 && e.transform.apply(e, Le[r](t, n));
        },
        ze = function (e, t, n, r) {
          ...
          return Re(a, t, n, r), a.drawImage(e, 0, 0, t, n), i;
        },
        Be = function (e) {
        ...
        He = 10,
        Ue = function (e) {
          var t = Math.min(Ve / e.width, He / e.height),
          ...
          var o = null;
          try {
            o = r.getImageData(0, 0, i, a).data;
          } catch {
            return null;
          }
          for (var s = o.length, c = 0, l = 0, u = 0, d = 0; d < s; d += 4)
            (c += o[d] * o[d]),
              (l += o[d + 1] * o[d + 1]),
              (u += o[d + 2] * o[d + 2]);
          return (
            (c = We(c, s)), (l = We(l, s)), (u = We(u, s)), { r: c, g: l, b: u }
          );
        },
        We = function (e, t) {
          ...
          var t = Pe(e),
            ...
            i = function (e, t, n) {
              return new Promise(function (i) {
                ...
                var a = Ke(e.ref.imageData);
                if (!t || t.length !== 20)
                  return n.getContext(`2d`).putImageData(a, 0, 0), i();
                var o = r(Fe);
                o.post(
                  { imageData: a, colorMatrix: t },
                  function (e) {
            ...
            s = function (e) {
              ...
              if (o) {
                ...
                t.query(`GET_IMAGE_PREVIEW_MARKUP_SHOW`) &&
                  ((l = o.getMetadata(`markup`) || []),
                  (u = o.getMetadata(`resize`)),
                  (d = !0));
                var f = t.appendChildView(
                  t.createChildView(n, {
                    id: a,
                    image: i,
                    crop: s,
                ...
                t.ref.images.push(f),
                  ...
                  (f.translateY = 0),
                  setTimeout(function () {
                    t.dispatch(`DID_IMAGE_PREVIEW_SHOW`, { id: a });
                  }, 250);
              }
            },
            c = function (e) {
            ...
            l = function (e) {
              ...
              if (
                ...
                var a = t.query(`GET_ITEM`, { id: n.id });
                if (a) {
                  ...
                  if (/crop|markup|resize/.test(r.change.key)) {
                    var u = a.getMetadata(`crop`),
                      d = t.ref.images[t.ref.images.length - 1];
                    u &&
                    u.aspectRatio &&
                    d.crop &&
                    d.crop.aspectRatio &&
                    Math.abs(u.aspectRatio - d.crop.aspectRatio) > 1e-5
                      ? s({
                          root: t,
                          props: n,
                          image: Ge(o({ root: t }).image),
                        })
                      : c({ root: t, props: n });
                  }
                }
            ...
            u = function (e) {
              var t = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./),
                n = t ? parseInt(t[1]) : null;
              return n !== null && n <= 58
                ? !1
                : `createImageBitmap` in window && Be(e);
            },
            d = function (e) {
              var t = e.root,
                n = e.props.id,
              ...
              r &&
                Ie(URL.createObjectURL(r.file), function (e, r) {
            ...
            f = function (e) {
              var t = e.root,
                n = e.props,
                a = n.id,
                o = t.query(`GET_ITEM`, a);
              if (o) {
                var c = URL.createObjectURL(o.file),
                  l = function () {
                    qe(c).then(d);
                  },
                  d = function (e) {
                    URL.revokeObjectURL(c);
                    var r = (o.getMetadata(`exif`) || {}).orientation || -1,
                      a = e.width,
                      l = e.height;
                    if (!(!a || !l)) {
                      if (r >= 5 && r <= 8) {
                      ...
                      var d = Math.max(1, window.devicePixelRatio * 0.75),
                        f = t.query(`GET_IMAGE_PREVIEW_ZOOM_FACTOR`) * d,
                        p = l / a,
                        m = t.rect.element.width,
                        h = t.rect.element.height,
                        g = m,
                        _ = g * p;
                      p > 1
                        ? ((g = Math.min(a, m * f)), (_ = g * p))
                        : ((_ = Math.min(l, h * f)), (g = _ / p));
                      var v = ze(e, g, _, r),
                        y = function () {
                          var r = t.query(
                            ...
                            ? Ue(data)
                            : null;
                          o.setMetadata(`color`, r, !0),
                            `close` in e && e.close(),
                            (t.ref.overlayShadow.opacity = 1),
                            s({ root: t, props: n, image: v });
                        },
                        b = o.getMetadata(`filter`);
                      b ? i(t, b, v).then(y) : y();
                    }
                  };
                if (u(o.file)) {
                  var f = r(U);
                  f.post({ file: o.file }, function (e) {
                    if ((f.terminate(), !e)) {
                      l();
                      return;
                    }
          ...
          return e.utils.createView({
            ...
            create: function (e) {
              ...
              (n.ref.images = []),
                ...
                (n.ref.imageViewBin = []),
                (n.ref.overlayShadow = n.appendChildView(
                  n.createChildView(t, { opacity: 0, status: `idle` })
                )),
                (n.ref.overlaySuccess = n.appendChildView(
                  n.createChildView(t, { opacity: 0, status: `success` })
                )),
                (n.ref.overlayError = n.appendChildView(
                  n.createChildView(t, { opacity: 0, status: `failure` })
                ));
            },
            styles: [`height`],
            apis: [`height`],
              ...
              if (!(!n(`file`) || !i(`GET_ALLOW_IMAGE_PREVIEW`))) {
                var c = function (t) {
                    var n = t.root,
                      a = t.props.id,
                      c = i(`GET_ITEM`, a);
                    if (!(!c || !o(c.file) || c.archived)) {
                      var l = c.file;
                      if (e(l) && i(`GET_IMAGE_PREVIEW_FILTER_ITEM`)(c)) {
                        var u = `createImageBitmap` in (window || {}),
                          d = i(`GET_IMAGE_PREVIEW_MAX_FILE_SIZE`);
                        if (!(!u && d && l.size > d)) {
                          n.ref.imagePreview = r.appendChildView(
                            r.createChildView(s, { id: a })
                          );
                    ...
                    if (e.ref.imagePreview) {
                      ...
                      if (r) {
                        var i = e.query(`GET_PANEL_ASPECT_RATIO`),
                          a = e.query(`GET_ITEM_PANEL_ASPECT_RATIO`),
                        ...
                        if (!(i || a || o)) {
                          ...
                          if (!(!c || !l)) {
                            var u = e.query(`GET_IMAGE_PREVIEW_MIN_HEIGHT`),
                              d = e.query(`GET_IMAGE_PREVIEW_MAX_HEIGHT`),
                              f =
                                (r.getMetadata(`exif`) || {}).orientation || -1;
                            if (f >= 5 && f <= 8) {
                              var p = [l, c];
                              (c = p[0]), (l = p[1]);
                            }
                            ...
                            var h = l / c,
                              g =
                                (r.getMetadata(`crop`) || {}).aspectRatio || h,
                              _ = Math.max(u, Math.min(l, d)),
                              v = e.rect.element.width,
                              y = Math.min(v * g, _);
      ...
      return (
        typeof window < `u` &&
          ...
          document.dispatchEvent(
            new CustomEvent(`FilePond:pluginloaded`, { detail: Ye })
          ),
        Ye
      );
    });
  ...
  r = e((e, t) => {
    (function (n, r) {
      typeof e == `object` && t !== void 0
        ...
        : typeof define == `function` && define.amd
        ? define(r)
        : ((n ||= self), (n.FilePondPluginImageExifOrientation = r()));
    })(e, function () {
      var e = function (e) {
        ...
        i = function (e) {
          return new Promise(function (i, a) {
            ...
            (o.onload = function (e) {
              ...
              for (var o = a.byteLength, s = 2; s < o; ) {
                var c = n(a, s);
                if (((s += 2), c === t.APP1)) {
                  if (r(a, (s += 2)) !== t.EXIF) break;
                  var l = n(a, (s += 6)) === t.TIFF;
                  s += r(a, s + 4, l);
                  var u = n(a, s, l);
                  s += 2;
                  for (var d = 0; d < u; d++)
                    if (n(a, s + d * 12, l) === t.Orientation) {
                      i(n(a, s + d * 12 + 8, l));
                      return;
                    }
                } else if ((c & t.Unknown) !== t.Unknown) break;
                else s += n(a, s);
              }
              i(-1);
            }),
              o.readAsArrayBuffer(e.slice(0, 64 * 1024));
          });
        },
        a = (function () {
          return typeof window < `u` && window.document !== void 0;
        ...
        s = `data:image/jpg;base64,`,
        c = void 0,
        l = o() ? new Image() : {};
      (l.onload = function () {
        return (c = l.naturalWidth > l.naturalHeight);
      }),
        (l.src = s);
      var u = function () {
          return c;
        ...
        d = function (t) {
          ...
          return (
            ...
            { options: { allowImageExifOrientation: [!0, a.BOOLEAN] } }
          );
        };
      return (
        typeof window < `u` &&
          window.document !== void 0 &&
          document.dispatchEvent(
            new CustomEvent(`FilePond:pluginloaded`, { detail: d })
          ),
        d
      );
    });
  ...
  i = e((e, t) => {
    (function (n, r) {
      typeof e == `object` && t !== void 0
        ...
        : typeof define == `function` && define.amd
        ? define(r)
        : ((n ||= self), (n.FilePondPluginFileValidateSize = r()));
    })(e, function () {
      var e = function (e) {
        var t = e.addFilter,
          n = e.utils,
                  ...
                  status: {
                    ...
                    sub: i(n(`GET_LABEL_MAX_FILE_SIZE`), {
                      filesize: a(
                        s,
                        `.`,
                        n(`GET_FILE_SIZE_BASE`),
                        n(`GET_FILE_SIZE_LABELS`, n)
                      ),
                    }),
                  },
                });
  ...
  a = e((e, t) => {
    (function (n, r) {
      typeof e == `object` && t !== void 0
        ...
        : typeof define == `function` && define.amd
        ? define(r)
        : ((n ||= self), (n.FilePondPluginImageEdit = r()));
    })(e, function () {
      var e = function (e) {
          return /^image/.test(e.type);
        },
          ...
          var n = t.addFilter,
            ...
            c =
              s === void 0
                ...
                : s,
            l = i.fileActionButton;
          n(`SHOULD_REMOVE_ON_REVERT`, function (t, n) {
            var r = n.item,
              i = n.query;
            return new Promise(function (t) {
              ...
              t(
                !(
                  i(`GET_ALLOW_IMAGE_EDIT`) &&
                  i(`GET_IMAGE_EDIT_ALLOW_EDIT`) &&
                  e(n)
                )
              );
            });
                ...
                var s = function (e, t, n) {
                  ...
                  c = function () {
                    if (u.length) {
                      ...
                      i(`EDIT_ITEM`, {
                        id: t.id,
                        handleEditorResponse: s(t, n, r),
                      });
                    }
                  };
                d({ item: t, resolve: n, reject: a }), u.length === 1 && c();
              });
            }),
          ...
          return (
            n(`CREATE_VIEW`, function (t) {
              var n = t.is,
                r = t.view,
                i = t.query;
              if (i(`GET_ALLOW_IMAGE_EDIT`)) {
                var a = i(`GET_ALLOW_IMAGE_PREVIEW`);
                if ((n(`file-info`) && !a) || (n(`file`) && a)) {
                  var s = i(`GET_IMAGE_EDIT_EDITOR`);
                  if (s) {
                    s.filepondCallbackBridge ||=
                      ((s.outputData = !0),
                      (s.outputFile = !1),
                      {
                        onconfirm: s.onconfirm || function () {},
                        oncancel: s.oncancel || function () {},
                      });
                    var u = function (e) {
                        var t = e.root,
                          n = e.props,
                          r = e.action,
                          i = n.id,
                          a = r.handleEditorResponse;
                        (s.cropAspectRatio =
                          t.query(`GET_IMAGE_CROP_ASPECT_RATIO`) ||
                          s.cropAspectRatio),
                          (s.outputCanvasBackgroundColor =
                            t.query(
                              `GET_IMAGE_TRANSFORM_CANVAS_BACKGROUND_COLOR`
                            ) || s.outputCanvasBackgroundColor);
                        var o = t.query(`GET_ITEM`, i);
                        if (o) {
                          var l = o.file,
                            u = o.getMetadata(`crop`),
                            d = {
                              center: { x: 0.5, y: 0.5 },
                              flip: { horizontal: !1, vertical: !1 },
                              zoom: 1,
                            ...
                            f = o.getMetadata(`resize`),
                            p = o.getMetadata(`filter`) || null,
                            m = o.getMetadata(`filters`) || null,
                            h = o.getMetadata(`colors`) || null,
                            g = o.getMetadata(`markup`) || null,
                            _ = {
                              crop: u || d,
                              size: f
                                ? {
                          ...
                          (s.onconfirm = function (e) {
                            var t = e.data,
                              ...
                              f = {};
                            if ((n && (f.crop = n), r)) {
                              var p = (o.getMetadata(`resize`) || {}).size,
                            ...
                            d && (f.markup = d),
                              ...
                              (f.filter = u),
                              o.setMetadata(f),
                              s.filepondCallbackBridge.onconfirm(t, c(o)),
                              a &&
                                (s.onclose = function () {
                                  a(!0), (s.onclose = null);
                                });
                            ...
                            (s.oncancel = function () {
                              s.filepondCallbackBridge.oncancel(c(o)),
                                a &&
                                  (s.onclose = function () {
                                    a(!1), (s.onclose = null);
                                  });
                      ...
                      d = function (t) {
                        var n = t.root,
                          o = t.props;
                        if (i(`GET_IMAGE_EDIT_ALLOW_EDIT`)) {
                          var s = o.id,
                            c = i(`GET_ITEM`, s);
                          if (c) {
                            var u = c.file;
                            if (e(u))
                              if (
                                ((n.ref.handleEdit = function (e) {
                                  e.stopPropagation(),
                                    n.dispatch(`EDIT_ITEM`, { id: s });
                                }),
                                a)
                              ) {
                                var d = r.createChildView(l, {
                                  label: `edit`,
                                  icon: i(`GET_IMAGE_EDIT_ICON_EDIT`),
                                  opacity: 0,
                                });
                                d.element.classList.add(
                                  `filepond--action-edit-item`
                                ),
                                  (d.element.dataset.align = i(
                                    `GET_STYLE_IMAGE_EDIT_BUTTON_EDIT_ITEM_POSITION`
                                  )),
                                  d.on(`click`, n.ref.handleEdit),
                                  (n.ref.buttonEditItem = r.appendChildView(d));
                              } else {
                                var f = r.element.querySelector(
                                    `.filepond--file-info-main`
                                  ),
                                  p = document.createElement(`button`);
                                (p.className = `filepond--action-edit-item-alt`),
                                  (p.innerHTML =
                                    i(`GET_IMAGE_EDIT_ICON_EDIT`) +
                                    `<span>edit</span>`),
                                  p.addEventListener(`click`, n.ref.handleEdit),
                                  f.appendChild(p),
                                  (n.ref.editButton = p);
                              }
                          }
                    ...
                    r.registerDestroyer(function (e) {
                      var t = e.root;
                    ...
                    var f = { EDIT_ITEM: u, DID_LOAD_ITEM: d };
                    a &&
                      (f.DID_IMAGE_PREVIEW_SHOW = function (e) {
                        var t = e.root;
                        t.ref.buttonEditItem &&
                          (t.ref.buttonEditItem.opacity = 1);
                      }),
                      r.registerWriter(o(f));
                  }
                }
              }
            }),
            {
              options: {
                allowImageEdit: [!0, a.BOOLEAN],
                styleImageEditButtonEditItemPosition: [
                  `bottom center`,
                  a.STRING,
                ],
                imageEditInstantEdit: [!1, a.BOOLEAN],
                imageEditAllowEdit: [!0, a.BOOLEAN],
                imageEditIconEdit: [
