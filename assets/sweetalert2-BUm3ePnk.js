    ...
    let a = {},
      ...
      c =
        `container.shown.height-auto.iosfix.popup.modal.no-backdrop.no-transition.toast.toast-shown.show.hide.close.title.html-container.actions.confirm.deny.cancel.footer.icon.icon-content.image.input.file.range.select.radio.checkbox.label.textarea.inputerror.input-label.validation-message.progress-steps.active-progress-step.progress-step.progress-step-line.loader.loading.styled.top.top-start.top-end.top-left.top-right.center.center-start.center-end.center-left.center-right.bottom.bottom-start.bottom-end.bottom-left.bottom-right.grow-row.grow-column.grow-fullscreen.rtl.timer-progress-bar.timer-progress-bar-container.scrollbar-measure.icon-success.icon-warning.icon-info.icon-question.icon-error.draggable.dragging`
          .split(`.`)
          .reduce((e, t) => ((e[t] = ee + t), e), {}),
      l = [`success`, `warning`, `info`, `question`, `error`].reduce(
        (e, t) => ((e[t] = ee + t), e),
        {}
      ),
      te = `SweetAlert2:`,
      ne = (e) => e.charAt(0).toUpperCase() + e.slice(1),
      u = (e) => {
        console.warn(`${te} ${typeof e == `object` ? e.join(` `) : e}`);
      },
      d = (e) => {
        console.error(`${te} ${e}`);
      },
      ...
      oe = (e) => (typeof e == `function` ? e() : e),
      se = (e) => e && typeof e.toPromise == `function`,
      f = (e) => (se(e) ? e.toPromise() : Promise.resolve(e)),
      ce = (e) => e && Promise.resolve(e) === e,
      p = () => document.body.querySelector(`.${c.container}`),
      m = (e) => {
        let t = p();
      ...
      le = () => h(c[`icon-content`]),
      ue = () => h(c.title),
      de = () => h(c[`html-container`]),
      fe = () => h(c.image),
      pe = () => h(c[`progress-steps`]),
      v = () => h(c[`validation-message`]),
      y = () => m(`.${c.actions} .${c.confirm}`),
      b = () => m(`.${c.actions} .${c.cancel}`),
      x = () => m(`.${c.actions} .${c.deny}`),
      me = () => h(c[`input-label`]),
      S = () => m(`.${c.loader}`),
      C = () => h(c.actions),
      he = () => h(c.footer),
      w = () => h(c[`timer-progress-bar`]),
      ge = () => h(c.close),
      _e = () => {
        let e = g();
        if (!e) return [];
...
`),
      ...
      De = () => !F(y()) && !F(x()) && !F(b()),
      Oe = (e) => e.scrollHeight > e.clientHeight,
      ke = (e, t) => {
        let n = e;
        for (; n && n !== t; ) {
          if (Oe(n)) return !0;
      ...
      Pe = `
 <div aria-labelledby="${c.title}" aria-describedby="${
        c[`html-container`]
      }" class="${c.popup}" tabindex="-1">
   ...
   <div class="${c[`validation-message`]}" id="${
...
`.replace(/(^|\n)\s*/g, ``),
      ...
      Le = (e) => (typeof e == `string` ? document.querySelector(e) : e),
      Re = (e) => {
        let t = g();
      ...
      He = (e, t) => {
        e.jquery ? Ue(t, e) : T(t, e.toString());
      },
      Ue = (e, t) => {
    ...
    function Je(e, t, n) {
      P(e, n[`show${ne(t)}Button`], `inline-block`),
        T(e, n[`${t}ButtonText`] || ``),
    ...
    var L = { innerParams: new WeakMap(), domCache: new WeakMap() };
    let et = [
        `input`,
        `file`,
        `range`,
      ...
      tt = (e, t) => {
        ...
        et.forEach((e) => {
          let r = A(n, c[e]);
          r && (it(e, t.inputAttributes), (r.className = c[e]), i && N(r));
        }),
          t.input && (i && nt(t), at(t));
      },
      nt = (e) => {
        ...
        if (!B[e.input]) {
          d(
            `Unexpected type of input! Expected ${Object.keys(B).join(
              ` | `
            )}, got "${e.input}"`
          );
          return;
    ...
    (B.text =
      ...
      B.month =
        (e, t) => (
          z(e, t.inputValue), R(e, e, t), ot(e, t), (e.type = t.input), e
        )),
      (B.file = (e, t) => (R(e, e, t), ot(e, t), e)),
      (B.range = (e, t) => {
      ...
      (B.radio = (e) => ((e.textContent = ``), e)),
      (B.checkbox = (e, t) => {
        let n = Se(g(), `checkbox`);
        return (
          (n.value = `1`),
          (n.checked = !!t.inputValue),
          T(e.querySelector(`span`), t.inputPlaceholder || t.inputLabel),
          n
        );
      }),
      (B.textarea = (e, t) => {
        z(e, t.inputValue), ot(e, t), R(e, e, t);
        let n = (e) =>
        ...
        return (
          setTimeout(() => {
            if (`MutationObserver` in window) {
              let r = parseInt(window.getComputedStyle(g()).width);
              new MutationObserver(() => {
                if (!document.body.contains(e)) return;
                let i = e.offsetWidth + n(e);
                i > r ? (g().style.width = `${i}px`) : j(g(), `width`, t.width);
    ...
    let ct = (e, t) => {
      ...
      dt = (e, t) => {
        ...
        O(e, t.icon && l[t.icon]), ht(e, t), ft(), D(e, t, `icon`);
      },
      ft = () => {
        let e = g();
        if (!e) return;
...
`)
          : t.icon &&
            (r = gt({ question: `?`, warning: `!`, info: `i` }[t.icon])),
          n.trim() !== r.trim() && T(e, r);
      },
      ht = (e, t) => {
        if (t.iconColor) {
          ...
          for (let n of [
            ...
            Ee(e, n, `background-color`, t.iconColor);
          Ee(e, `.swal2-success-ring`, `border-color`, t.iconColor);
        }
      },
      gt = (e) => `<div class="${c[`icon-content`]}">${e}</div>`,
      _t = (e, t) => {
        let n = fe();
        if (n) {
          if (!t.imageUrl) {
      ...
      wt = (e) => {
        e.removeEventListener(`mousedown`, V),
          ...
          e.removeEventListener(`mouseup`, Tt),
          e.removeEventListener(`touchstart`, V),
          document.body.removeEventListener(`touchmove`, H),
          e.removeEventListener(`touchend`, Tt);
      },
      V = (e) => {
        let t = g();
        if (e.target === t || _().contains(e.target)) {
          vt = !0;
          let n = Et(e);
          (yt = n.clientX),
            (bt = n.clientY),
      ...
      Dt = (e, t) => {
        ...
        if (!(!n || !r)) {
          ...
          j(r, `padding`, t.padding),
            ...
            Ot(r, t),
            t.draggable && !t.toast
              ? (O(r, c.draggable), Ct(r))
              : (k(r, c.draggable), wt(r));
        }
      },
      Ot = (e, t) => {
        let n = t.showClass || {};
      ...
      Nt = (e, t) => {
        ...
        typeof t.didRender == `function` && n && t.didRender(n),
          a.eventEmitter.emit(`didRender`, n);
      },
      Pt = () => F(g()),
      Ft = () => y()?.click(),
      It = () => x()?.click(),
        ...
        e &&
          (t.isComposing ||
            ...
            t.key === `Enter`
              ...
              : t.key === `Tab`
              ? Gt(t)
              : [...Vt, ...Ht].includes(t.key)
              ? Kt(t.key)
              : t.key === `Escape` && qt(t, e, n)));
      },
      Wt = (e, t) => {
        if (!oe(t.allowEnterKey)) return;
        let n = Se(g(), t.input);
        if (
          e.target &&
          n &&
      ...
      qt = (e, t, n) => {
        e.preventDefault(), oe(t.allowEscapeKey) && n(U.esc);
      };
    var W = {
    ...
    let Jt = () => {
      ...
      Xt = typeof window < `u` && !!window.GestureEvent,
      Zt = () => {
        if (Xt && !E(document.body, c.iosfix)) {
      ...
      tn = (e) => e.touches && e.touches.length > 1,
      nn = () => {
      ...
      an = (e) => {
        G === null &&
          ...
          (document.body.style.paddingRight = `${G + rn()}px`));
      },
      on = () => {
        G !== null &&
          ((document.body.style.paddingRight = `${G}px`), (G = null));
      };
    function sn(e, t, n, r) {
      ye() ? mn(e, r) : (s(n).then(() => mn(e, r)), Rt(a)),
        Xt
    ...
    let ln = (e) => {
      ...
      let r = p();
      return (
        k(r, n.showClass.backdrop), O(r, n.hideClass.backdrop), fn(e, t, n), !0
      );
    };
    function un(e) {
    ...
    let q = (e) => {
      ...
      fn = (e, t, n) => {
        ...
        typeof n.willClose == `function` && n.willClose(t),
          ...
          o
            ? pn(e, t, i, n.returnFocus, n.didClose)
            : sn(e, i, n.returnFocus, n.didClose);
      },
      pn = (e, t, n, r, i) => {
        a.swalCloseEventFinishedCallback = sn.bind(null, e, n, r, i);
        let o = function (e) {
          if (e.target === t) {
            var n;
    ...
    let Tn = (e) => {
        ...
        return (
          e instanceof Map
            ? e.forEach((e, n) => {
                let r = e;
                typeof r == `object` && (r = Tn(r)), t.push([n, r]);
              })
      ...
      Dn = (e) => {
        ...
        e.disableButtons(), t.input ? An(e, `confirm`) : Fn(e, !0);
      },
      On = (e) => {
        let t = L.innerParams.get(e);
        e.disableButtons(),
          t.returnInputValueOnDeny ? An(e, `deny`) : Mn(e, !1);
      },
      kn = (e, t) => {
      ...
      An = (e, t) => {
        ...
        if (!n.input) {
          d(
            `The "input" parameter is needed to be set when using returnInputValueOn${ne(
              t
            )}`
          );
          return;
      ...
      Mn = (e, t) => {
        let n = L.innerParams.get(e || void 0);
    ...
    let Ln = (e) => {
      ...
      t.length ? M(t[0], `inline-block`) : De() && N(e.actions);
    };
    function Rn() {
      let e = L.innerParams.get(this),
    ...
    let Y = {
      ...
      Xn = (e) => Object.prototype.hasOwnProperty.call(Y, e),
      Zn = (e) => qn.indexOf(e) !== -1,
      Qn = (e) => Jn[e],
      $n = (e) => {
        Xn(e) || u(`Unknown parameter "${e}"`);
      },
      er = (e) => {
        Yn.includes(e) && u(`The parameter "${e}" is incompatible with toasts`);
      },
      tr = (e) => {
        let t = Qn(e);
        t && ae(e, t);
      ...
      nr = (e) => {
        ...
        for (let t in e) $n(t), e.toast && er(t), tr(t);
      };
    function rr(e) {
      let t = p(),
        n = g(),
    ...
    let ir = (e) => {
      ...
      return (
        Object.keys(e).forEach((n) => {
          Zn(n) ? (t[n] = e[n]) : u(`Invalid parameter to update: ${n}`);
        }),
        t
      );
    };
    ...
    let ur = (e, t, n) => {
      ...
      dr = (e, t, n) => {
        t.popup.onclick = () => {
          (e && (fr(e) || e.timer || e.input)) || n(U.close);
        };
      },
      fr = (e) =>
        !!(
      ...
      gr = (e, t, n) => {
        t.container.onclick = (r) => {
          ...
          r.target === t.container && oe(e.allowOutsideClick) && n(U.backdrop);
        };
      },
      _r = (e) => typeof e == `object` && e.jquery,
      vr = (e) => e instanceof Element || _r(e),
      yr = (e) => {
        let t = {};
        return (
          typeof e[0] == `object` && !vr(e[0])
            ? Object.assign(t, e[0])
            : [`title`, `html`, `icon`].forEach((n, r) => {
                let i = e[r];
                typeof i == `string` || vr(i)
                  ? (t[n] = i)
                  : i !== void 0 &&
                    d(
    ...
    let Sr = () => a.timeout && a.timeout.getTimerLeft(),
      Cr = () => {
        if (a.timeout) return Me(), a.timeout.stop();
      },
      wr = () => {
        if (a.timeout) {
      ...
      Dr = () => !!(a.timeout && a.timeout.isRunning()),
      Or = !1,
      kr = {};
    function Ar(e = `data-swal-template`) {
      (kr[e] = this),
        (Or ||= (document.body.addEventListener(`click`, jr), !0));
    }
    let jr = (e) => {
    ...
    let Fr = [`swal-title`, `swal-html`, `swal-footer`],
      Ir = (e) => {
        let t =
        ...
        return (
          Wr(n),
          Object.assign(Lr(n), Rr(n), zr(n), Br(n), Vr(n), Hr(n), Ur(n, Fr))
        );
      },
      Lr = (e) => {
        let t = {};
      ...
      Hr = (e) => {
        ...
        n &&
          (X(n, [`type`, `label`, `placeholder`, `value`]),
      ...
      Ur = (e, t) => {
        ...
        for (let r in t) {
          let i = t[r],
            a = e.querySelector(i);
          a && (X(a, []), (n[i.replace(/^swal-/, ``)] = a.innerHTML.trim()));
        }
        return n;
      },
      Wr = (e) => {
      ...
      Gr = (e) => {
        ...
        typeof e.willOpen == `function` && e.willOpen(n),
          a.eventEmitter.emit(`willOpen`, n);
        let r = window.getComputedStyle(document.body).overflowY;
        Yr(t, n, e),
          setTimeout(() => {
            qr(t, n);
          }, 10),
          ve() && (Jr(t, e.scrollbarPadding, r), Jt()),
          !ye() &&
      ...
      Kr = (e) => {
        ...
        let n = p();
        t.removeEventListener(`animationend`, Kr),
          t.removeEventListener(`transitionend`, Kr),
      ...
      qr = (e, t) => {
        Ae(t)
          ? ((e.style.overflowY = `hidden`),
            t.addEventListener(`animationend`, Kr),
            t.addEventListener(`transitionend`, Kr))
      ...
      Yr = (e, t, n) => {
        O(e, n.showClass.backdrop),
          n.animation
            ? (t.style.setProperty(`opacity`, `0`, `important`),
              M(t, `grid`),
              setTimeout(() => {
                O(t, n.showClass.popup), t.style.removeProperty(`opacity`);
              }, 10))
            : M(t, `grid`),
    ...
    function Zr(e) {
      e.inputValidator ||
        (e.input === `email` && (e.inputValidator = Xr.email),
        e.input === `url` && (e.inputValidator = Xr.url));
    }
    function Qr(e) {
      (!e.target ||
...
`
    ...
    class Q {
      constructor(...e) {
        r(this, ei, void 0),
          !(typeof window > `u`) &&
            ((Z = this),
            (this.params = Object.freeze(this.constructor.argsToParams(e))),
            (this.isAwaitingPromise = !1),
            i(ei, this, this._main(Z.params)));
      }
      _main(e, t = {}) {
        if ((nr(Object.assign({}, t, e)), a.currentInstance)) {
          let e = W.swalPromiseResolve.get(a.currentInstance),
        ...
        let r = ri(Z);
        return Nt(Z, n), L.innerParams.set(Z, n), ti(Z, r, n);
      }
      then(e) {
    ...
    let ti = (e, t, n) =>
      ...
      ni = (e, t) => {
        let n = Ir(e),
          r = Object.assign({}, Y, t, n, e);
        return (
          (r.showClass = Object.assign({}, Y.showClass, r.showClass)),
          (r.hideClass = Object.assign({}, Y.hideClass, r.hideClass)),
          r.animation === !1 &&
      ...
      oi = (e) => {
        ...
        for (let e of t)
          if (e instanceof HTMLElement && F(e)) return e.focus(), !0;
        return !1;
      },
      si = (e, t) =>
    ...
    (Q.prototype.disableButtons = Hn),
      (Q.prototype.enableButtons = Vn),
      (Q.prototype.getInput = Rn),
      (Q.prototype.disableInput = Wn),
      (Q.prototype.enableInput = Un),
      (Q.prototype.hideLoading = In),
      (Q.prototype.disableLoading = In),
      (Q.prototype.showValidationMessage = Gn),
      (Q.prototype.resetValidationMessage = Kn),
      (Q.prototype.close = K),
      (Q.prototype.closePopup = K),
      (Q.prototype.closeModal = K),
      (Q.prototype.closeToast = K),
      (Q.prototype.rejectPromise = un),
      (Q.prototype.update = rr),
      (Q.prototype._destroy = ar),
      Object.assign(Q, Nr),
      Object.keys(lr).forEach((e) => {
        Q[e] = function (...t) {
          return Z && Z[e] ? Z[e](...t) : null;
        };
      }),
      (Q.DismissReason = U),
      (Q.version = `11.26.4`);
