 ...
 */ !(function () {
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            (o.style.position = "absolute"),
              ...
              (o.style.fontSize = window.getComputedStyle(e).fontSize),
              (o.style.fontFamily = window.getComputedStyle(e).fontFamily),
              (o.textContent = t),
      ...
      (function (e, t) {
        ...
        if (null != o) {
          ...
          try {
            ...
            try {
              if (!l && null != o.return && ((r = o.return()), Object(r) !== r))
                return;
            } finally {
              if (u) throw s;
            }
    ...
    return (
      ...
      (i = [
        ...
        },
        {
          ...
          value: function (t, o, i) {
            t &&
              n.removeArrayEmpty(o.split(" ")).forEach(function (o) {
                e.getElements(t).forEach(function (e) {
            ...
            if (t) {
              ...
              setTimeout(function () {
                s.forEach(function (e) {
                  e.dispatchEvent(new CustomEvent(o, { bubbles: i }));
                });
              }, 0);
            }
          },
        ...
        (o = [
              ...
              if (this.$ele) {
                ...
                this.additionalClasses &&
                  ...
                  this.additionalToggleButtonClasses &&
                    (o += " ".concat(this.additionalToggleButtonClasses)),
                  this.multiple &&
                    ((t += " multiple"),
                ...
                (this.$ele.innerHTML = u),
                  ...
                  this.hasDropboxWrapper
                    ? ((this.$allWrappers = [
                      ...
                      d.addClass(this.$dropboxContainer, "pop-comp-wrapper"))
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this.additionalDropboxContainerClasses &&
                (s += " ".concat(this.additionalDropboxContainerClasses));
              var n = '<div id="vscomp-dropbox-container-'
                .concat(this.uniqueId, '" role="listbox" class="')
                .concat(
                  s,
              ...
              if (o) {
                ...
                return (
                  ...
                  (r.innerHTML = n),
                  o.appendChild(r),
                  d.addClass(r, "vscomp-dropbox-wrapper ".concat(t)),
                  this.keepAlwaysOpen ||
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                this.multiple && (r = '<span class="checkbox-icon"></span>'),
                this.allowNewOption)
              ) {
                var y = this.getTooltipAttrText("New Option");
                a = '<span class="vscomp-new-option-icon" '.concat(
                  y,
                  "></span>"
                );
              }
              s.forEach(function (o) {
                ...
                if (
                  ...
                  o.isDisabled &&
                    ((y += " disabled"), (C = 'aria-disabled="true"')),
                  o.isGroupTitle &&
                    ((f = o.label), (y += " group-title"), c && (m = "")),
                  k && (y += " selected"),
                  o.isGroupOption)
                ) {
                  var E = "";
            ...
            value: function () {
              if (this.hasSearchContainer) {
                ...
                if (
                  ...
                  var o = this.ariaLabelSearchClearButtonText
                    ? 'aria-label="'.concat(
          ...
          },
          {
            ...
            value: function (e, t, o) {
              var i = this;
              e &&
                n.removeArrayEmpty(t.split(" ")).forEach(function (t) {
            ...
            value: function (t) {
              ...
              if (o) {
                ...
                i &&
                  ...
                  this.isOpened() &&
                  !this.keepAlwaysOpen &&
                  ((this.shouldFocusWrapperOnClose = !1), this.closeDropbox());
              } else
                e.openInstances.forEach(function (e) {
                  var t = e;
            ...
            value: function (e) {
              ...
              if (
                (document.activeElement !== this.$searchInput ||
                  ...
                  9 !== t ||
                  this.multiple ||
                  (e.preventDefault(), this.focusFirstVisibleOption()),
                document.activeElement !== this.$toggleAllButton || 13 !== t)
              ) {
                if (27 === t || "Escape" === e.key) {
                  var i = this.showAsPopup
                    ? this.$wrapper
                    : this.$dropboxWrapper;
                  if (
                    i &&
          ...
          },
          {
            ...
            value: function (e) {
              if (
                "keydown" !== e.type ||
                (e.preventDefault(), "Enter" === e.code || "Space" === e.code)
              ) {
                var t = e.target;
                if (t.closest(".vscomp-value-tag-clear-button"))
                  return (
                    e.stopPropagation(),
                    void this.removeValue(t.closest(".vscomp-value-tag"))
                  );
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t &&
                this.isOpened() &&
                (d.hasClass(t, "disabled") || d.hasClass(t, "group-title")
            ...
            value: function () {
              ...
              if (this.hasDropboxWrapper) {
                ...
                (this.mutationObserver = new MutationObserver(function (o) {
                  ...
                  o.forEach(function (e) {
                    i ||
                      (i = g(e.addedNodes).some(function (e) {
                        return !(e !== t && !e.contains(t));
                      })),
                      s ||
                        (s = g(e.removedNodes).some(function (e) {
                          return !(e !== t && !e.contains(t));
                        }));
                  }),
                    s && !i && e.destroy();
            ...
            value: function () {
              ...
              if (
                ((!this.allowNewOption ||
                  ...
                  (d.toggleClass(this.$allWrappers, "has-no-search-results", i),
                  i
                    ? (d.setAttr(this.$noSearchResults, "tabindex", "0"),
                      d.setAttr(this.$noSearchResults, "aria-hidden", "false"))
                    : (d.setAttr(this.$noSearchResults, "tabindex", "-1"),
                      d.setAttr(this.$noSearchResults, "aria-hidden", "true"))),
                d.toggleClass(this.$allWrappers, "has-no-options", o),
                o
                  ? (d.setAttr(this.$noOptions, "tabindex", "0"),
                    d.setAttr(this.$noOptions, "aria-hidden", "false"))
                  : (d.setAttr(this.$noOptions, "tabindex", "-1"),
                    d.setAttr(this.$noOptions, "aria-hidden", "true")),
                this.setOptionAttr(),
                this.setOptionsPosition(),
                this.setOptionsTooltip(),
                document.activeElement !== this.$searchInput && !1 === e)
              ) {
                var s = d.getElementsBySelector(
                  ".focused",
                  this.$dropboxContainer
                )[0];
                void 0 !== s && s.focus();
          ...
          },
          {
            ...
            value: function (e) {
              ...
              (this.$ele = t.ele),
                ...
                (this.multiple = o(t.multiple)),
                (this.hasSearch = o(t.search)),
                (this.searchByStartsWith = o(t.searchByStartsWith)),
                (this.searchGroup = o(t.searchGroup)),
                (this.hideClearButton = o(t.hideClearButton)),
                (this.autoSelectFirstOption = o(t.autoSelectFirstOption)),
                (this.hasOptionDescription = o(t.hasOptionDescription)),
                (this.silentInitialValueSet = o(t.silentInitialValueSet)),
                (this.allowNewOption = o(t.allowNewOption)),
                (this.markSearchResults = o(t.markSearchResults)),
                (this.showSelectedOptionsFirst = o(t.showSelectedOptionsFirst)),
                (this.disableSelectAll = o(t.disableSelectAll)),
                (this.keepAlwaysOpen = o(t.keepAlwaysOpen)),
                (this.showDropboxAsPopup = o(t.showDropboxAsPopup)),
                (this.hideValueTooltipOnSelectAll = o(
                  t.hideValueTooltipOnSelectAll
                )),
                (this.showOptionsOnlyOnSearch = o(t.showOptionsOnlyOnSearch)),
                (this.selectAllOnlyVisible = o(t.selectAllOnlyVisible)),
                (this.alwaysShowSelectedOptionsCount = o(
                  t.alwaysShowSelectedOptionsCount
                )),
                (this.alwaysShowSelectedOptionsLabel = o(
                  t.alwaysShowSelectedOptionsLabel
                )),
                (this.disableAllOptionsSelectedText = o(
                  t.disableAllOptionsSelectedText
                )),
                (this.showValueAsTags = o(t.showValueAsTags)),
                (this.disableOptionGroupCheckbox = o(
                  t.disableOptionGroupCheckbox
                )),
                (this.enableSecureText = o(t.enableSecureText)),
                (this.setValueAsArray = o(t.setValueAsArray)),
                (this.disableValidation = o(t.disableValidation)),
                (this.initialDisabled = o(t.disabled)),
                (this.required = o(t.required)),
                (this.autofocus = o(t.autofocus)),
                (this.useGroupValue = o(t.useGroupValue)),
                (this.focusSelectedOptionOnOpen = o(
                ...
                (this.additionalDropboxClasses = t.additionalDropboxClasses),
                (this.additionalDropboxContainerClasses =
                ...
                (this.selectedLabelRenderer = t.selectedLabelRenderer),
                (this.initialSelectedValue =
                ...
                (this.shouldFocusWrapperOnClose = !0);
            },
          },
          {
            key: "setDefaultProps",
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (a) {
                ...
                this.useGroupValue && (a = this.setGroupOptionsValue(a)),
              ...
              if (
                (this.options.forEach(function (e) {
                  ...
                  !0 !== o[t] || e.isDisabled || e.isGroupTitle
                    ? (e.isSelected = !1)
          ...
          },
          {
            ...
            value: function () {
              ...
              var O = function (t) {
                ...
                if (
                  (g || "" !== S || (g = !0),
                  i && (C.isDisabled = !0 === m[S]),
                  t.isGroupOption &&
                    ((C.isGroupOption = !0), (C.groupIndex = t.groupIndex)),
                  u && (C.description = h(c(t[a]))),
                  t.customData && (C.customData = t.customData),
                  o.push(C),
                  (v += 1),
                  k)
                ) {
            ...
            value: function () {
              ...
              this.allowNewOption &&
                ...
                s
                  ...
                  : this.updatePosition(),
                this.setVisibleOptionsCount(),
                d.removeClass(this.$allWrappers, "server-searching");
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              var e =
                ...
                n = i + o - 1,
                r = 0;
              s && ((s.visibleIndex = r), (r += 1)),
                (t = t.filter(function (e) {
                  var t = !1;
                  return (
                    e.isVisible &&
                      !e.isCurrentNew &&
                      ((t = r >= i && r <= n), (e.visibleIndex = r), (r += 1)),
                    t
                  );
                })),
                s && (t = [s].concat(g(t))),
          ...
          },
          {
            ...
            value: function (e) {
              var t =
                ...
                r = void 0 !== s && s,
                a = n.normalizeValues(e);
              (this.hasEmptyValueOption && "" === a) || a
                ? Array.isArray(a)
                  ? (this.selectedValues = g(a))
              ...
              d.toggleClass(this.$allWrappers, "has-value", u),
                d.toggleClass(
                  this.$allWrappers,
                  "max-value-selected",
                  this.isMaxValuesSelected
                ),
                d.setAttr(this.$clearButton, "tabindex", u ? "0" : "-1"),
                d.setAria(this.$clearButton, "hidden", !1 === u),
                r || this.validate(),
                i || d.dispatchEvent(this.$ele, "change", !0);
            },
          },
          {
            key: "setValueText",
            value: function () {
              ...
              if (h && this.hideValueTooltipOnSelectAll)
                ...
                this.getSelectedOptions({
                  ...
                  var o = t.label;
                  if (
                    ("function" == typeof a && (o = a(t)),
                    l.push(o),
                    (p += 1),
                    s)
                  ) {
                    var c = n.willTextOverflow(r.parentElement, o)
                        ? e.getTooltipAttrText(o, !1, !0)
                        : "",
                      h = "";
                    if (e.ariaLabelTagClearButtonText) {
                      ...
                      h = 'aria-label="'
                        .concat(d, ", ")
                        .concat(e.ariaLabelTagClearButtonText, '"');
                    }
                    var v = '<span class="vscomp-value-tag" data-index="'
                      .concat(t.index, '" ')
                      .concat(
                        c,
                ...
                if ("" === f) r.innerHTML = this.placeholder;
                  ...
                  if (
                    ...
                    var b = '<span class="vscomp-selected-value-count">'.concat(
                      c,
                      "</span>"
                    );
                    if (
                      (y &&
                        (b += ' / <span class="vscomp-max-value-count">'.concat(
                          y,
                          "</span>"
                        )),
                      h)
              ...
              var g = "";
              0 === c ? (g = this.placeholder) : s || (g = u.join(", ")),
                s || d.setData(r, "tooltip", g),
                t &&
                  (s
                    ? this.updatePosition()
                    : d.setData(r, "tooltipEllipsisOnly", 0 === c));
            },
          },
          {
            key: "setSearchValue",
            value: function (e) {
              ...
              if (e !== this.searchValueOriginal || o) {
                ...
                (this.searchValue = i),
                  ...
                  d.toggleClass(this.$allWrappers, "has-search-value", e),
                  d.setAttr(
                    this.$searchClear,
                    "tabindex",
                    "" !== e ? "0" : "-1"
                  ),
                  d.setAria(this.$searchClear, "hidden", "" === e),
              ...
              e
                ...
                : ((t = this.optionsHeight),
                  this.keepAlwaysOpen &&
                    ...
                    d.setStyle(this.$noSearchResults, "height", t))),
                d.setStyle(this.$optionsContainer, "max-height", t),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (t) {
                ...
                if (o) {
                  var i = o.index;
                  this.setOptionProp(i, "value", this.secureText(t)),
                    this.setOptionProp(i, "label", this.secureText(t));
                } else {
          ...
          },
          {
            ...
            value: function () {
              ...
              e && (this.showAsPopup ? (t["max-width"] = e) : (o.width = e)),
                d.setStyles(this.$dropboxContainer, o),
              ...
              return (
                this.options.forEach(function (o) {
                  if (o.isSelected) {
                    var i = o.value;
                    o.isGroupTitle
                      ? i && ((t[o.index] = !0), e.push(i))
                      : !0 !== t[o.groupIndex] && e.push(i);
                  }
                }),
                e
              );
                ...
                (this.options.forEach(function (e) {
                  if (e.isSelected && !e.isGroupTitle)
                    if (o) l.push(e);
                      ...
                      e.isNew && (t.isNew = !0),
                        e.customData && (t.customData = e.customData),
                        l.push(t);
                    }
                }),
                s)
              ...
              return (
                (t = this.structureOptionGroup(t)).forEach(function (t) {
                  o[t.index] = t.options.some(function (t) {
                    return i({ data: t, searchValue: e }).isVisible;
                  });
                }),
                o
              );
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (this.showAsPopup) {
                ...
                this.hasSearchContainer && (o -= 40),
                  (t = Math.floor(o / this.optionHeight));
              } else t = parseInt(e);
              return t;
            },
          },
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              do {
                ...
                d.hasClass(i, "disabled") ||
                d.hasClass(i, "group-title")
              );
              return i;
            },
          },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var i = "";
              t ||
                ((i = this.$dropboxContainer.style.transition),
                ...
                e.openInstances.add(this),
                d.setAttr(this.$dropboxWrapper, "tabindex", "0"),
                d.setAria(this.$dropboxWrapper, "hidden", !1),
                d.setAttr(this.$dropboxContainerTop, "tabindex", "0"),
                d.setAria(this.$dropboxContainerTop, "hidden", !1),
                d.setAttr(this.$dropboxContainerBottom, "tabindex", "0"),
                d.setAria(this.$dropboxContainerBottom, "hidden", !1),
                t
                  ? d.setStyle(this.$dropboxContainer, "display", "inline-flex")
                ...
                t ||
                  (this.$dropboxContainer.offsetHeight,
                  (this.$dropboxContainer.style.transition = i)),
                this.dropboxPopover && !t
            ...
            value: function () {
              ...
              (this.isSilentOpen = !1),
                e ||
                  ...
                  this.showAsPopup
                    ? (d.addClass(this.$body, "vscomp-popup-active"),
          ...
          },
          {
            key: "closeDropbox",
            value: function (t) {
              (this.isSilentClose = t),
                e.openInstances.delete(this),
                !1 !== this.isOpened() &&
                  (this.keepAlwaysOpen
                    ? this.removeOptionFocus()
                    : (t
                        ? d.setStyle(this.$dropboxContainer, "display", "")
                        : (d.dispatchEvent(this.$ele, "beforeClose"),
                          d.setAria(this.$wrapper, "expanded", !1),
                          d.setAria(this.$wrapper, "activedescendant", "")),
                      this.dropboxPopover && !t
                        ? (this.dropboxPopover.hide(),
                          d.setAttr(this.$dropboxWrapper, "tabindex", "-1"),
                          ...
                          d.setAria(this.$dropboxContainerTop, "hidden", !0),
                          d.setAttr(
                            this.$dropboxContainerBottom,
                            "tabindex",
                            "-1"
                          ),
                          d.setAria(this.$dropboxContainerBottom, "hidden", !0))
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.isSilentClose = !1),
                ...
                !t &&
                  this.isPopupActive &&
                  (d.removeClass(this.$body, "vscomp-popup-active"),
                  (this.isPopupActive = !1)),
                d.addClass(this.$allWrappers, "closed"),
                t || d.dispatchEvent(this.$ele, "afterClose");
              var o = document.activeElement,
                i =
                  (o && this.$wrapper.contains(o)) ||
                  (this.hasDropboxWrapper &&
                    o &&
                    this.$dropboxWrapper.contains(o));
              this.shouldFocusWrapperOnClose &&
                e.lastInteractedInstance === this &&
                !t &&
                (null === o || o === document.body || i) &&
                this.$wrapper.focus(),
                (this.shouldFocusWrapperOnClose = !0),
                d.setAttr(this.$dropboxWrapper, "tabindex", "-1"),
                d.setAria(this.$dropboxWrapper, "hidden", !0),
                d.setAttr(this.$dropboxContainerTop, "tabindex", "-1"),
                d.setAria(this.$dropboxContainerTop, "hidden", !0),
                d.setAttr(this.$dropboxContainerBottom, "tabindex", "-1"),
                d.setAria(this.$dropboxContainerBottom, "hidden", !0);
            },
          },
          {
            ...
            value: function () {
              ...
              if (i) e = i;
                ...
                (e = this.$dropboxContainer.querySelector(
                  ...
                  (d.hasClass(e, "disabled") || d.hasClass(e, "group-title")) &&
                    (e = this.getSibling(e, "next"));
              ...
              e &&
                ...
                this.toggleFocusedProp(d.getData(e, "index"), !0),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (t) {
                ...
                n > l ? (o = p + h) : r < u && (o = p - a + c + h),
                  void 0 !== o && (this.$optionsContainer.scrollTop = o);
              }
            },
          },
          {
              ...
              if (e) {
                ...
                if (
                  ...
                  if (this.multiple)
                    ...
                    i.length &&
                      this.toggleSelectedProp(this.getOptionIndex(i[0]), !1),
                      (i = [s]);
              ...
              if (this.multiple && !this.disableSelectAll) {
                var t =
                    "boolean" == typeof isSelected
                      ? e
                      : !d.hasClass(this.$toggleAllCheckbox, "checked"),
                  o = [],
            ...
            value: function (e) {
              if (this.multiple) {
                ...
                "boolean" == typeof e || (e = this.isAllOptionsSelected()),
                  ...
                  d.toggleClass(this.$toggleAllCheckbox, "checked", e || t),
          ...
          },
          {
            ...
            value: function (e, t) {
              if (
                ...
                var i = this.$options.querySelector(
                ...
                s.forEach(function (e) {
                  ...
                  this.options.forEach(function (e) {
                    if (!e.isDisabled && e.groupIndex === i) {
                      var o = e.value;
                      !t || (r && !e.isVisible)
                        ? ((e.isSelected = !1), a[o] && l(s, o))
                        : ((e.isSelected = !0), a[o] || s.push(o));
                    }
                  }),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.options.forEach(function (e) {
                ...
                this.afterValueSet(),
                e && d.removeClass(this.$allWrappers, "has-error"),
          ...
          },
          {
            ...
            value: function (e, t) {
              if (e) {
                ...
                var o = this.getOptionObj(
                  f(f({}, e), {}, { index: this.lastOptionIndex })
                );
                this.options.push(o),
          ...
          },
          {
            ...
            value: function (e) {
              var t = e.data,
                ...
                l =
                  this.searchNormalize && null != t.labelNormalized
                    ? t.labelNormalized
              ...
              return (
                ...
                r || !c || p || (p = c.includes(o)),
                r || !u || p || (p = u.toLowerCase().includes(o)),
                (t.isVisible = p),
                i || (i = l === o || a === o),
                { isVisible: p, hasExactOption: i }
              );
            },
          },
          {
          ...
          },
          {
            key: "serverSearch",
            value: function () {
              d.removeClass(this.$allWrappers, "has-no-search-results"),
                d.addClass(this.$allWrappers, "server-searching"),
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                this.required &&
                  (n.isEmpty(t) || (this.multiple && o && t.length < o)) &&
                  (e = !0),
                d.toggleClass(this.$allWrappers, "has-error", e),
                !e
              );
            },
          },
          {
            ...
            value: function () {
              var t = this.$ele;
              (t.virtualSelect = void 0),
                (t.value = void 0),
                (t.innerHTML = ""),
                e.openInstances.delete(this),
                this === e.lastInteractedInstance &&
                  (e.lastInteractedInstance = null),
                this.removeEvents(),
                this.hasDropboxWrapper && this.$dropboxWrapper.remove(),
                this.dropboxPopover && this.dropboxPopover.destroy(),
                d.removeClass(t, "vscomp-ele");
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e, t) {
              var o = t;
              void 0 === o && (o = !d.hasClass(e, "selected")),
                d.toggleClass(e, "selected", o),
                d.setAria(e, "selected", o);
            },
          },
          {
            ...
            value: function (e, t) {
              e &&
                ...
                t && d.setAria(this.$wrapper, "activedescendant", e.id));
            },
          },
        ]),
        (i = [
          {
            ...
            value: function (t) {
              ...
              if (o) {
                ...
                (void 0 !== o.length && void 0 !== o.forEach) ||
                  ((o = [o]), (i = !0));
                var n = [];
                return (
                  o.forEach(function (o) {
                    o.virtualSelect
                      ? n.push(o.virtualSelect)
                      : ((t.ele = o),
                        "SELECT" === o.tagName && e.setPropsFromSelect(t),
                        n.push(new e(t)));
                  }),
                  i ? n[0] : n
                );
  ...
  document.addEventListener("reset", T.onFormReset),
    ...
    (T.openInstances = new Set()),
    (T.lastInteractedInstance = null),
          ...
          (t = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  (o.setStyle(this.$popperEle, "transform", N),
                ...
                clearTimeout(this.exitDelayTimeout),
                  ...
                  (this.enterDelayTimeout = setTimeout(function () {
                    var t = o.getData(e.$popperEle, "left"),
                      ...
                      n = "translate3d("
                        .concat(parseInt(t), "px, ")
                        .concat(parseInt(i), "px, 0)"),
                      r = e.showDuration;
                    o.show(e.$popperEle, "inline-flex"),
                      o.getCoords(e.$popperEle),
                      o.setStyle(e.$popperEle, "transitionDuration", r + "ms"),
    ...
    function t(e, t) {
      for (var i = 0; i < t.length; i++) {
        ...
        (s.enumerable = s.enumerable || !1),
          ...
          Object.defineProperty(e, o(s.key), s);
      }
    }
    function o(t) {
      var o = (function (t) {
        ...
        (o = [
          ...
          },
          {
            ...
            value: function (t, o, s, n) {
              t &&
                (o = i.removeArrayEmpty(o.split(" "))).forEach(function (o) {
            ...
            },
            {
              ...
              value: function (e) {
                var t = this,
                  ...
                  a = e.throttle;
                s &&
                  (n = i.removeArrayEmpty(n.split(" "))).forEach(function (e) {
